...
extern unsigned int data_ov074_020b9b48[];
extern unsigned int data_ov074_020b9b5c[];
extern void func_ov074_020b91a8(int group, int param);

void func_ov074_020b8f58(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x60);
    ...
    func_ov022_02091254((struct Group *)*(void **)(self + 0x2000 + 0x644),
                        (struct Peer *)self, data_ov074_020b9b48, (char *)&cfg);
    *(void **)((char *)*(void **)(self + 0x2000 + 0x644) + 0x20) =
        (void *)&func_ov074_020b91a8;
    ...
    func_ov022_02091254((struct Group *)((char *)*(void **)(self + 0x2000 + 0x644) + 0x30),
                        (struct Peer *)self, data_ov074_020b9b5c, (char *)&cfg);
