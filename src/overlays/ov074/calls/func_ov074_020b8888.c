...
extern struct Ov047Descriptor data_ov074_020b9b10;
extern struct Ov047Descriptor data_ov074_020b9b20;

u8 func_ov074_020b8888(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov074_020b9b10.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov074_020b9b20.bytes, self->slot09, 1,
