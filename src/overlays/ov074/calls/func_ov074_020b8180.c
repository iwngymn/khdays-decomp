...
extern void func_ov074_020b843c(void);
extern void func_ov074_020b85c0(void);
extern void func_ov074_020b86cc(void);
extern void func_ov074_020b83b0(void);
extern void func_ov074_020b841c(void);
extern void func_ov074_020b8704(void);
struct Runtime;
typedef u8 (*SetupHandler)(struct Runtime *);
typedef int (*StateHandler)(int *);
extern u8 func_ov074_020b8888(struct Runtime *);
extern int func_ov074_020b934c(int *);
...
void func_ov074_020b8180(struct InitConfig *cfg) {
    struct OpenParams p;
    ...
    *(long long *)obj = 0;
    ...
    func_0202b914(*(signed char *)(obj + 0x4bc), data_ov074_020b9afc,
                  1, cfg->type + 7);

    *(void **)(obj + 0x664) = (void *)&func_ov074_020b843c;
    *(void **)(obj + 0x668) = (void *)&func_ov074_020b85c0;
    *(void **)(obj + 0x66c) = (void *)&func_ov074_020b86cc;
    *(void **)(obj + 0x670) = 0;
    *(void **)(obj + 0x674) = 0;
    *(void **)(obj + 0x678) = (void *)&func_ov074_020b83b0;
    *(void **)(obj + 0x67c) = (void *)&func_ov074_020b841c;
    *(void **)(obj + 0x684) = (void *)&func_ov074_020b8704;

    mode = func_02020a9c();
    if (mode != 0x2a) {
        *(SetupHandler *)(obj + 0x68c) = func_ov074_020b8888;
    } else {
        *(SetupHandler *)(obj + 0x68c) = 0;
    }
    *(StateHandler *)(obj + 0x688) = func_ov074_020b934c;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b ? func_02016f10((void *)b, data_ov074_020b9a9c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b ? func_02016f10((void *)b, data_ov074_020b9aac) : -1;
    b = bone(obj);
    *(int *)(obj + 0x514) = b ? func_02016f10((void *)b, data_ov074_020b9a8c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b ? func_02016f10((void *)b, data_ov074_020b9a6c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b ? func_02016f10((void *)b, data_ov074_020b9a7c) : -1;
