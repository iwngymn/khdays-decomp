...
extern void func_ov074_020b93b4(void);
extern void func_ov074_020b970c(void);

void *func_ov074_020b8704(char *self, int msg) {
    char *blk = data_ov074_020b9b80 + 0x2ca4;
    void *next = 0;
    Vec3 delta;
