...
extern void func_ov152_020d5400(void);
extern void func_ov152_020d5588(void);

void func_ov152_020d532c(int *node) {
    ...
    func_0203c634(node, 0, func_ov152_020d5400);
    func_0203c634(node, 2, func_ov152_020d5588);
}
