...
struct ov251_LowByteFlags { unsigned bits : 8; };

void func_ov251_020d5368(int *node) {
    ...
    ((struct ov251_LowByteFlags *)(*(int *)(*state + 0x388) + 8))->bits &= ~1;
    func_ov107_020c5af8(*state, 0x159, 6, state[2]);
