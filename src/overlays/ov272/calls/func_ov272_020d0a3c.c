/*
 * func_ov272_020d0a3c -- x3. AI-state entry: initialise the sub-state and register three handlers.
...
extern void func_ov272_020d0b00(void);
extern void func_ov272_020d0cfc(void);

void func_ov272_020d0a3c(int *self) {
    ...
    *hw = h & ~0xff00 | (((((unsigned int)h << 0x10) >> 0x18 | 6) << 0x18) >> 0x10);
    ...
    func_0203c634((int)self, 1, (int)&func_ov272_020d0d50);
    func_0203c634((int)self, 0, (int)&func_ov272_020d0b00);
    func_0203c634((int)self, 2, (int)&func_ov272_020d0cfc);
}
