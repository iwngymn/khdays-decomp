...
extern const struct Msg data_ov133_020d49fe;
extern void func_ov133_020d3d14(void);

void func_ov133_020d3b48(struct Node *node)
{
    struct State *st;
    struct Msg msg;
    FxVec raw;
    ...
    *(u8 *)(st->pActor + 0x1c5) &= ~0xf;
    ...
    func_0203c634(node, node->bSlot, (void *)func_ov133_020d3d14);
}
