...
extern void func_ov133_020d26f0(void);
extern void func_ov133_020d28b0(void);

struct flagword { unsigned f8 : 8; };

void func_ov133_020d25f4(int param_1) {
    ...
    func_0203c634(param_1, 1, func_ov133_020d298c);
    func_0203c634(param_1, 0, func_ov133_020d26f0);
    func_0203c634(param_1, 2, func_ov133_020d28b0);
}
