...
extern const struct Msg data_ov133_020d49e2;
extern void func_ov133_020d3898(void);

void func_ov133_020d3404(struct Node *node)
{
    struct State *st;
    FxVec vFwd;
    FxVec vToTarget;
    ...
    func_0203c634(node, node->bSlot, (void *)func_ov133_020d3898);
}
