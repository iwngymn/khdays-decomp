/* func_ov187_020d3e6c -- tick this enemy's stagger timer on a hit, stash the hit info, and flip
...
int func_ov187_020d3e6c(int this, int a1, int a2)
{
    ...
    *(Blk3 *)((char *)p4 + 0x50) = *(Blk3 *)(a2 + 4);
    ...
    if ((int)*(short *)(this + 0x21a) == 0) {
        ((struct AiState *)(*(int *)p4))->pendingAction = 6;
    } else {
