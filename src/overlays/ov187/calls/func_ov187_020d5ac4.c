...
extern void func_ov187_020d5bb0(void);
extern void func_ov187_020d5dc0(void);
void func_ov187_020d5ac4(int self) {
    int *obj = *(int **)(self + 4);
    ...
    *(struct vec4 *)(obj + 6) = *(struct vec4 *)(obj + 2);
    func_0203c634(self, 1, &func_ov187_020d5ec4);
    func_0203c634(self, 0, &func_ov187_020d5bb0);
    func_0203c634(self, 2, &func_ov187_020d5dc0);
}
