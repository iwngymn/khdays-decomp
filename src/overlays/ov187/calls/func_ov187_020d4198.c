...
extern void func_ov187_020d4284(void);
extern void func_ov187_020d4494(void);
void func_ov187_020d4198(int self) {
    int *obj = *(int **)(self + 4);
    ...
    *(struct vec4 *)(obj + 6) = *(struct vec4 *)(obj + 2);
    func_0203c634(self, 1, &func_ov187_020d4770);
    func_0203c634(self, 0, &func_ov187_020d4284);
    func_0203c634(self, 2, &func_ov187_020d4494);
}
