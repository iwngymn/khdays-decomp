...
void func_ov187_020d695c(int *node) {
    ...
    *(VecFx32 *)(state + 0xb) = *(VecFx32 *)(state + 0x19);
    if (func_ov107_020c8eb8(state[0], (void *)(state[0] + 0x74), out) != 0) {
        Ev *pe = &ev;
        pe->b = data_ov187_020d7100[2].b;
        pe->a = data_ov187_020d7100[2].a;
    ...
    func_0203c634(node, *(signed char *)((int)node + 0x20), func_ov187_020d6a5c);
}
