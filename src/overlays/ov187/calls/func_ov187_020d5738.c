/* func_ov187_020d5738 -- head of a 5-member family (228 B). Re-arm the object's two sub-item
...
extern void func_ov187_020d5690(int self);
extern void func_0203c7ac(int a, int b);

void func_ov187_020d5738(int self, int mode, int arg) {
    if (mode == 3) {
