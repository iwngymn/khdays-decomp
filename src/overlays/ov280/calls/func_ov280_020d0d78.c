/* func_ov280_020d0d78 -- enter the state: reset the move slots, cache three sub-object pointers,
...
extern void func_ov280_020d0f14(void);
extern void func_ov280_020d1170(void);

void func_ov280_020d0d78(int self) {
    int *ctx;
    int lo;
    int spread;
    unsigned short v;
    ...
    *(unsigned char *)(ctx[0] + 0x1c6) = 0;
    ...
    func_0203c634(self, 0, func_ov280_020d0f14);
    func_0203c634(self, 2, func_ov280_020d1170);
}
