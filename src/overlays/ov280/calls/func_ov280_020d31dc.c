/* func_ov280_020d31dc -- acquire a target and arm the state, or give up if there is none.
 *
 ...
 * updated and effect 5 fires before handing off to func_ov280_020d32d0.
 *
...
extern void func_ov280_020d32d0(void);

void func_ov280_020d31dc(int self) {
    int *ctx;
    VecFx32 d;
    int target;
    unsigned short v;
    ...
    *(unsigned char *)((char *)ctx + 0x26) = 0;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov280_020d32d0);
}
