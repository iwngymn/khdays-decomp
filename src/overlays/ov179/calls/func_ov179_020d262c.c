...
extern void func_ov179_020d2718(void);
extern void func_ov179_020d2918(void);
extern void func_ov179_020d29b8(void);
void func_ov179_020d262c(int *node) {
    ...
    *(struct blk16 *)(state + 0x1d) = *(struct blk16 *)(state + 0x19);
    func_0203c634(node, 0, func_ov179_020d2718);
    func_0203c634(node, 1, func_ov179_020d29b8);
    func_0203c634(node, 2, func_ov179_020d2918);
}
