...
extern void func_ov281_020cce20(void);
extern void func_ov281_020ccff0(void);

void func_ov281_020ccd68(int self) {
    int *obj = *(int **)(self + 4);
    unsigned short w;
    ...
    func_0203c634(self, 1, &func_ov281_020cd08c);
    func_0203c634(self, 0, &func_ov281_020cce20);
    func_0203c634(self, 2, &func_ov281_020ccff0);
}
