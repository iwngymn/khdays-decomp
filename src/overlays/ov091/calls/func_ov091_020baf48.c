...
extern struct Ov047Descriptor data_ov091_020bc1d0;
extern struct Ov047Descriptor data_ov091_020bc1e0;

u8 func_ov091_020baf48(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov091_020bc1d0.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov091_020bc1e0.bytes, self->slot09, 1,
        &self->attach2644->model0c->field28);
    func_ov022_020b1cec((char *)self + 0xda0, 0xd3);
