...
extern void func_ov238_020d2adc(void);
extern void func_ov238_020d2c44(void);
extern void func_ov238_020d2b84(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov238_020d2a34(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov238_020d2adc);
    func_0203c634(param_1, 1, (void *)&func_ov238_020d2c44);
    func_0203c634(param_1, 2, (void *)&func_ov238_020d2b84);
}
