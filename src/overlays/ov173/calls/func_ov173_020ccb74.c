...
extern void func_ov173_020ccc60(void);
extern void func_ov173_020cce9c(void);
extern void func_ov173_020ccf3c(void);
void func_ov173_020ccb74(int *node) {
    ...
    *(struct blk16 *)(state + 0x1d) = *(struct blk16 *)(state + 0x19);
    func_0203c634(node, 0, func_ov173_020ccc60);
    func_0203c634(node, 1, func_ov173_020ccf3c);
    func_0203c634(node, 2, func_ov173_020cce9c);
}
