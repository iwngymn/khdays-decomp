...
extern void func_ov134_020cc8ec(void);
extern void func_ov134_020cca94(void);

void func_ov134_020cc828(int *node) {
    ...
    func_0203c634(node, 0, func_ov134_020cc8ec);
    func_0203c634(node, 2, func_ov134_020cca94);
}
