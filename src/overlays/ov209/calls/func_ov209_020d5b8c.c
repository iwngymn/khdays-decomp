...
extern void func_ov209_020d5c34(void);
extern void func_ov209_020d5cdc(void);
extern void func_ov209_020d5cac(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov209_020d5b8c(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov209_020d5c34);
    func_0203c634(param_1, 1, (void *)&func_ov209_020d5cdc);
    func_0203c634(param_1, 2, (void *)&func_ov209_020d5cac);
}
