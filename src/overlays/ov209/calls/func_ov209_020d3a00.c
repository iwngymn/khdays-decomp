/* func_ov209_020d3a00 -- ov209's move CHOOSER.
 *
...
extern int func_ov209_020d2cc4(int obj, int kind);
...
void func_ov209_020d3a00(int self) {
    int *ctx;
    int toTarget[3];
    int forward[3];
    int target;
    ...
    target = func_ov209_020d2cc4(ctx[0], 0);
    ctx[4] = target;
    if (target == 0) {
