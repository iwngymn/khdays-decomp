/* Constructor for the ov085 panel object: takes the root heap block as the object,
...
extern void func_ov085_020b83ac(void);
extern void func_ov085_020b8510(void);
extern void func_ov085_020b8684(void);
extern void func_ov085_020b8354(void);
extern void func_ov085_020b838c(void);
extern void func_ov085_020b85a8(void);
extern void func_ov085_020b86bc(void);
extern void func_ov085_020b8d14(void);
...
void func_ov085_020b815c(struct PanelInitConfig *config)
{
    ...
    *(long long *)object = 0;
    ...
    func_0202b914(*(signed char *)(object + 0x4bc), (void *)data_ov085_020b91e8, 1,
                  config->objectType + 7);

    *(void **)(object + 0x664 + 0x00) = (void *)&func_ov085_020b83ac;
    *(void **)(object + 0x664 + 0x04) = (void *)&func_ov085_020b8510;
    *(void **)(object + 0x664 + 0x08) = (void *)&func_ov085_020b8684;
    *(void **)(object + 0x664 + 0x0c) = 0;
    *(void **)(object + 0x664 + 0x10) = 0;
    *(void **)(object + 0x664 + 0x14) = (void *)&func_ov085_020b8354;
    *(void **)(object + 0x664 + 0x18) = (void *)&func_ov085_020b838c;
    *(void **)(object + 0x664 + 0x20) = (void *)&func_ov085_020b85a8;
    *(void **)(object + 0x664 + 0x28) = (void *)&func_ov085_020b86bc;
    *(void **)(object + 0x664 + 0x24) = (void *)&func_ov085_020b8d14;
...
test:
    ...
    *(int *)(object + 0x520) = bone != 0
        ? func_02016f10((void *)bone, &data_ov085_020b911c) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x518) = bone != 0
        ? func_02016f10((void *)bone, &data_ov085_020b910c) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x51c) = bone != 0
        ? func_02016f10((void *)bone, &data_ov085_020b90fc) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x524) = bone != 0
        ? func_02016f10((void *)bone, &data_ov085_020b90ec) : -1;
