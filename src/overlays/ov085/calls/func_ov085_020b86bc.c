/* Build step for the ov085 actor: clears the ready flags, requests animation set 2,
...
extern struct Ov047Descriptor data_ov085_020b91fc;
extern struct Ov047Descriptor data_ov085_020b920c;

u8 func_ov085_020b86bc(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov085_020b91fc.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov085_020b920c.bytes, self->slot09, 1,
