/* State-change request for the ov085 panel. Three states are handled specially: 0x2e
...
extern void func_ov085_020b8a20(char *self);
extern void func_ov085_020b87d0(char *blk);
...
void func_ov085_020b83ac(char *self, int nState)
{
    ...
    case 0x2e:
        if (*(int *)(self + 0x6bc) != nState) {
            *(int *)(blk + 0xc) = nArg;
            func_ov085_020b8a20(self);
        }
        break;

    case 0x31:
        if (*(int *)(self + 0x6bc) != nState) {
            func_ov085_020b87d0(blk);
        }
        break;
