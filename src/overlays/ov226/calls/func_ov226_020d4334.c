...
extern void func_ov226_020d43dc(void);
extern void func_ov226_020d446c(void);
extern void func_ov226_020d4454(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov226_020d4334(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov226_020d43dc);
    func_0203c634(param_1, 1, (void *)&func_ov226_020d446c);
    func_0203c634(param_1, 2, (void *)&func_ov226_020d4454);
}
