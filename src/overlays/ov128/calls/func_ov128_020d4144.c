...
extern void func_ov128_020d4208(void);
extern void func_ov128_020d4390(void);

void func_ov128_020d4144(int *node) {
    ...
    func_0203c634(node, 0, func_ov128_020d4208);
    func_0203c634(node, 2, func_ov128_020d4390);
}
