...
extern void func_ov148_020d10e4(void);

void func_ov148_020d100c(int *self) {
    int *obj = (int *)self[1];
    int lo, range;
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), &func_ov148_020d10e4);
}
