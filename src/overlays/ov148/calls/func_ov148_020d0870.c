...
extern void func_ov148_020d0928(void);
extern void func_ov148_020d0ab0(void);

void func_ov148_020d0870(int self) {
    int *obj = *(int **)(self + 4);
    unsigned short w;
    ...
    func_0203c634(self, 1, &func_ov148_020d0b94);
    func_0203c634(self, 0, &func_ov148_020d0928);
    func_0203c634(self, 2, &func_ov148_020d0ab0);
}
