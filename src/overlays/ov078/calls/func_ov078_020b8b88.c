...
extern struct Ov047Descriptor data_ov078_020ba484;
extern struct Ov047Descriptor data_ov078_020ba494;

u8 func_ov078_020b8b88(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov078_020ba484.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov078_020ba494.bytes, self->slot09, 1,
