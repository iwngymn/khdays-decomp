/* func_ov158_020cd6f4 -- face the target and arm the timed follow-up.
 ...
 * from the caller's per-tick amount, and the action is dispatched with func_ov158_020cd7cc.
 *
...
extern void func_ov158_020cd7cc(void);

void func_ov158_020cd6f4(int self) {
    int *ctx;
    Vec3 v;
    int target;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov158_020cd7cc);
}
