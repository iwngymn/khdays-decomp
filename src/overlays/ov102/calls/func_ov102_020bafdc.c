/* Creates the ov102 panel's sub-object: allocates it from the default expanding heap,
...
extern void func_ov102_020bb138(void);
extern int data_ov102_020bb8f4;

void func_ov102_020bafdc(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x30);
    ...
    func_ov022_02091298(*(void **)(self + 0x2000 + 0x644), self,
                        &data_ov102_020bb8f4, cfg, 2, 0xa);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x20) =
        (void *)&func_ov102_020bb138;
}
