/* Per-frame update for the ov102 panel. Raises the two visibility flag pairs while the
...
extern void func_ov102_020bb1f4(char *self);
...
int func_ov102_020bb470(char *self)
{
    ...
    struct VecFx32 vTmp;
    int nRet = 0;
    char *blk = data_ov102_020bb920 + 0xc50 + 0x2000;
    int nEnergy;
    int nLimit;
    int *pLink;
    int nZero;
