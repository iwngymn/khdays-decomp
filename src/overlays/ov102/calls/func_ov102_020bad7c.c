/* Build step for the ov102 actor: clears the ready flags, requests animation set 2,
...
u8 func_ov102_020bad7c(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov102_020bb8bc.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov102_020bb8cc.bytes, self->slot09, 1,
