/* State-change request for the ov102 panel. Three states are handled specially: 0x2e
...
extern void func_ov102_020bb0e0(char *self);
extern void func_ov102_020bae90(char *blk);
...
void func_ov102_020baa6c(char *self, int nState)
{
    ...
    case 0x2e:
        if (*(int *)(self + 0x6bc) != nState) {
            *(int *)(blk + 0xc) = nArg;
            func_ov102_020bb0e0(self);
        }
        break;

    case 0x31:
        if (*(int *)(self + 0x6bc) != nState) {
            func_ov102_020bae90(blk);
        }
        break;
