/* func_ov008_0206215c -- Ov008_ScrollMenuRowsTo: keep nRow inside the visible
...
extern void func_ov008_0205f294(Ov008LayoutCtx2 *pCtx, int nOrigin);   /* Ov008_LayoutMenuRows2 */

int func_ov008_0206215c(Ov008LayoutCtx2 *pCtx, int nRow, int nFirst, int nTotal, int nTrackEnd, int nVisible)
{
    ...
    func_ov008_0205f294(pCtx, nOrigin);
    return nFirst;
}
