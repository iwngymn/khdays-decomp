/* func_ov008_02066194 -- Ov008_MenuKeyLeft: the menu's "left" key handler.
 ...
 * cursor one column left (func_ov008_0206245c) and, if that took, clears the
...
void func_ov008_02066194(Ov008MenuContext *pCtx)
{
    u16 touch[3];
