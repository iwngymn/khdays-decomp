/* func_ov008_02076780 -- Ov008_DrawMissionDetail: redraw the mission menu's
...
extern const u16 data_ov008_02090980[];                                  /* "rank" format */
extern const u16 data_ov008_02090990[];                                  /* empty reward text */
extern const u16 data_ov008_02090994[];                                  /* "set / total" format */
...
extern Ov008MissionNameNode *func_ov008_020760a0(Ov008MissionMenu *pMenu, u32 nWord); /* find the name node */
extern void  func_ov008_02074b4c(Ov008MissionMenu *pMenu, Ov008MissionListEntry *pEntry, Ov008MissionNameNode *pNode);
extern void  func_ov008_02074c40(Ov008MissionMenu *pMenu, Ov008MissionListEntry *pEntry, Ov008MissionNameNode *pNode);
extern void  func_ov008_02075f70(Ov008MissionMenu *pMenu, Ov008MissionListEntry *pEntry, Ov008MissionNameNode *pNode); /* Ov008_DrawMissionInfoText */
...
extern void  func_ov008_02074118(void *pSurface);
...
extern void  func_ov008_020741a8(void *pSurface, int nValue, int nWidth); /* Ov008_Set_41a8 */
extern void *func_ov008_0205b6a8(Ov008MissionListEntry *pEntry);
extern void  func_ov008_02074134(void *pSurface);
extern void  func_ov008_020741e4(void *pSurface, void *pText, int nWidth);
extern void  func_ov008_020743e4(Ov008MissionMenu *pMenu, u32 nWord, int *pnSet, u32 *pnCount); /* Ov008_CountGroupFlagsSet2 */
extern void  func_020300f8(void *pSurface);                              /* EnqueueObjGfxCommand */
extern void  func_ov008_02050b3c(int nSlot);                             /* Ov008_MarkSlotUsed */

void func_ov008_02076780(Ov008MissionMenu *pMenu, int nTab)
{
    u16 aDesc[0x80];
    u16 aRank[4];
    u16 aCount[4];
    ...
    pNode = 0;
    {
        ...
        if (func_ov008_02051028() != 0) {
            pNode = func_ov008_020760a0(pMenu, pEntry->nWord);
        }
        func_ov008_02074b4c(pMenu, pEntry, pNode);
        func_ov008_02074c40(pMenu, pEntry, pNode);
        func_ov008_02075f70(pMenu, pEntry, pNode);
        ...
        func_020262a0(aRank, 4, data_ov008_02090980, pEntry->nRank, nGlyph);
        func_ov008_02074118(pMenu->rankSurface);
        func_02030158(pMenu->rankSurface);
        func_02030278(pMenu->rankSurface, 0, 6, nColour, aRank, 1);
        if (func_ov008_02051028() == 0 || pMenu->bTransfer != 0) {
            nSlot = pEntry->nTextSlot;
            if (bUnlocked != 0) {
                func_ov008_020741a8(pMenu->rankSurface, func_ov008_0205b6c8(nSlot), 0x68);
            }
            if (bUnlocked != 0) {
                func_02030278(pMenu->rankSurface, 0x14, 6, COLOUR_NORMAL, func_ov008_0205b6a8(pEntry), 1);
            }
            if (bUnlocked == 0) {
                func_02030278(pMenu->rankSurface, 0x14, 6, COLOUR_NORMAL, func_ov008_02055c84(pMenu->records, TEXT_LOCKED), 1);
            }
        } else {
            pText = (void *)data_ov008_02090990;
            switch (pEntry->nRewardKind) {
            case 0:
                pText = func_ov008_02055c84(pMenu->records, TEXT_REWARD_FIRST);
                break;
            case 1:
                pText = func_ov008_02055c84(pMenu->records, TEXT_REWARD_FIRST + 1);
                break;
            case 2:
                pText = func_ov008_02055c84(pMenu->records, TEXT_REWARD_FIRST + 2);
                break;
            case 3:
                pText = func_ov008_02055c84(pMenu->records, TEXT_REWARD_FIRST + 3);
                break;
            case 4:
                pText = func_ov008_02055c84(pMenu->records, TEXT_REWARD_FIRST + 4);
                break;
            case 5:
                pText = func_ov008_02055c84(pMenu->records, TEXT_REWARD_FIRST + 6);
                break;
            case 6:
                pText = func_ov008_02055c84(pMenu->records, TEXT_REWARD_FIRST + 7);
                break;
            case 7:
                pText = func_ov008_02055c84(pMenu->records, TEXT_REWARD_FIRST + 8);
                break;
            case 8:
                pText = func_ov008_02055c84(pMenu->records, TEXT_REWARD_FIRST + 9);
                break;
            }
            func_020262a0(aDesc, 0x100, pEntry->pDescFormat, pText);
            func_ov008_020741a8(pMenu->rankSurface, (int)aDesc, 0x78);
            func_02030278(pMenu->rankSurface, 0x14, 6, nColour, aDesc, 1);
        }
        func_ov008_02074134(pMenu->nameSurface);
        pName = pEntry->pName;
        if (*pName == 0 && pNode != 0) {
            func_02030158(pMenu->nameSurface);
            func_ov008_020741e4(pMenu->nameSurface, pNode->pName, 0x80);
            func_02030278(pMenu->nameSurface, 0, 1, nColour, pNode->pName, 1);
        } else {
            func_ov008_020741e4(pMenu->nameSurface, pName, 0x80);
            func_02030158(pMenu->nameSurface);
        ...
        if (func_ov008_02051028() == 0) {
            nSet = 0;
            nTotal = 0;
            func_ov008_020743e4(pMenu, pEntry->nWord, &nSet, &nTotal);
            func_020262a0(aCount, 4, data_ov008_02090994, nSet, nTotal);
            func_02030158(pMenu->countSurface);
            func_02030278(pMenu->countSurface, 2, 7, COLOUR_NORMAL, aCount, 1);
        } else if (pMenu->bTransfer != 0) {
            pText = func_ov008_02055c84(pMenu->records2, pEntry->nCount + TEXT_COUNT_BASE);
            func_02030158(pMenu->countSurface);
            if (pEntry->nCount != 0) {
        ...
        func_02030278(pMenu->hintSurface, 4, 2, COLOUR_NORMAL, func_ov008_02055c84(pMenu->records, TEXT_HINT), 0);
        ...
        func_ov008_02050b3c(SLOT_A);
        func_ov008_02050b3c(SLOT_B);
    }
}
