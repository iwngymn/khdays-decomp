/* func_ov008_0206ff24 -- Ov008_DrawMissionRow: draw row nIndex (mod 6) of
...
extern const Ov008SlotTags data_ov008_0208f9b0;                          /* slot tags */
extern const Ov008SlotTags data_ov008_0208f9e0;                          /* slot tags of a started mission */
extern const u16 data_ov008_02090878[];                                  /* "rank" format */
extern const u16 data_ov008_02090888[];                                  /* empty reward text */
extern const u16 data_ov008_0209088c[];                                  /* "set / total" format */
...
extern void  func_ov008_0206fee0(int nOwner, u32 nTag, short nX, short nY); /* Ov008_SetTagValueAndNotify2 */
extern u32   func_ov008_0206fda0(Ov008MissionList *pList, u32 nWord);    /* Ov008_BuildRankMask */
extern Ov008MissionNameNode *func_ov008_0206fd50(Ov008MissionList *pList, u32 nWord); /* find the name node */
extern void  func_ov008_0206f8dc(Ov008RowSurface *pSurface);
...
extern int   func_ov008_0205b6c8(u32 nTextSlot);
extern void  func_ov008_0206f96c(Ov008RowSurface *pSurface, int nValue, int nWidth); /* Ov008_Set_f96c */
extern void *func_ov008_02055c84(void *pRecords, int nIndex);            /* GetVarRecordByIndex */
extern void  func_ov008_0206f8f8(Ov008RowSurface *pSurface);
extern void  func_ov008_0206f9a8(Ov008RowSurface *pSurface, void *pText, int nWidth);
extern void  func_ov008_0206fc24(Ov008MissionList *pList, u32 nWord, int *pnSet, u32 *pnTotal); /* Ov008_CountGroupFlagsSet */
...
void func_ov008_0206ff24(Ov008MissionList *pList, int nIndex, Ov008MissionListEntry *pEntry)
{
    u16 aDesc[0x80];
    Ov008SlotTags tags;
    ...
    if (bObject == 0) {
        ...
        if (pList->bEntryGate != 0) {
            bDim = func_ov008_0206fb34(pList, pEntry) == 0;
        } else {
            bDim = func_ov008_0206fb2c(pList, pEntry) == 0;
        }
    }
    ...
    tags = data_ov008_0208f9b0;
    tagsStarted = data_ov008_0208f9e0;
    if (bUnlocked == 0) {
        func_ov008_0206fe50(nOwner, TAG_LOCKED, 3, (short)(nRow * 4 + 1));
    } else if (bObject == 0 && Ov008_IsMissionStarted(pEntry)) {
        func_ov008_0206fe50(nOwner, tagsStarted.aTag[pEntry->nTextSlot], 3, (short)(nRow * 4 + 1));
    } else {
        func_ov008_0206fe50(nOwner, tags.aTag[pEntry->nTextSlot], 3, (short)(nRow * 4 + 1));
    }
    nY = nRow * 4;
    if (bTransition != 0) {
        if (pList->bEntryGate != 0) {
            ...
            switch (nStage) {
            case 1:
                func_ov008_0206fe50(nOwner, TAG_TRANSFER_1, 0x18, (short)nY2);
                break;
            case 2:
                func_ov008_0206fe50(nOwner, TAG_TRANSFER_2, 0x18, (short)nY2);
                break;
            case 3:
                func_ov008_0206fe50(nOwner, TAG_TRANSFER_3, 0x18, (short)nY2);
                break;
            case 4:
                func_ov008_0206fe50(nOwner, TAG_TRANSFER_0, 0x18, (short)nY2);
                break;
            case 0:
            default:
                func_ov008_0206fee0(nOwner, TAG_TRANSFER_0, 0x18, (short)nY2);
                break;
            }
        } else {
            ...
            nY2 = nY + 2;
            nX = 0x19 - (nStage - 1);
            func_ov008_0206fee0(nOwner, TAG_STAGE, 0x16, (short)nY2);
            func_ov008_0206fee0(nOwner, TAG_STAGE, 0x17, (short)nY2);
            switch (nStage) {
            case 1:
                func_ov008_0206fe50(nOwner, TAG_STAGE_1, (short)nX, (short)nY2);
                break;
            case 2:
                func_ov008_0206fe50(nOwner, TAG_STAGE_2, (short)nX, (short)nY2);
                break;
            case 3:
                func_ov008_0206fe50(nOwner, TAG_STAGE, (short)nX, (short)nY2);
                break;
            default:
                func_ov008_0206fee0(nOwner, TAG_STAGE, 0x17, (short)nY2);
                break;
        ...
        nMask = func_ov008_0206fda0(pList, pEntry->nWord);
        nRanks = 0;
        if (nMask & 1) {
            nRanks++;
        }
        ...
        for (i = 0; (int)i < RANK_TILES; i++) {
            ...
            if (nTag != -1) {
                func_ov008_0206fe50(nOwner, nTag, (short)(i + TILE_X_FIRST), (short)(nY + 1));
            } else {
                func_ov008_0206fee0(nOwner, TAG_RANK_DONE, (short)(i + TILE_X_FIRST), (short)(nY + 1));
            }
        }
        nY2 = nY + 2;
        func_ov008_0206fee0(nOwner, TAG_BADGE, 0x17, (short)nY2);
        if (pEntry->bSpecial != 0 || (pEntry->nFlags & 2)) {
            bCleared = func_020235d0(pEntry->missionId * 3 + FIELD_MISSION_STATUS, 3) == 3;
            if (bCleared) {
                func_ov008_0206fe50(nOwner, TAG_BADGE, 0x17, (short)nY2);
            } else {
                bStarted = func_020235d0(pEntry->missionId * 3 + FIELD_MISSION_STATUS, 3) >= 2;
                if (bStarted) {
                    func_ov008_0206fe50(nOwner, TAG_STARTED, 0x17, (short)nY2);
                } else {
                    func_ov008_0206fe50(nOwner, TAG_STARTED_ALT, 0x18, (short)nY2);
                }
            }
        } else {
            bCleared = func_020235d0(pEntry->missionId * 3 + FIELD_MISSION_STATUS, 3) == 3;
            if (bCleared) {
                func_ov008_0206fe50(nOwner, TAG_CLEARED_PLAIN, 0x17, (short)nY2);
            } else {
                bStarted = func_020235d0(pEntry->missionId * 3 + FIELD_MISSION_STATUS, 3) >= 2;
                if (bStarted) {
                    func_ov008_0206fe50(nOwner, TAG_STARTED_PLAIN, 0x17, (short)nY2);
                }
            }
        }
        func_ov008_0206fe50(nOwner, TAG_ROW, 0x18, (short)nY);
    }
    if (bDim != 0) {
        nColour = COLOUR_DIM;
    } else {
    ...
    if (func_ov008_02051028() != 0) {
        pNode = func_ov008_0206fd50(pList, pEntry->nWord);
    }
    nGlyph = GLYPH_SPACE;
    if (func_ov008_02051028() != 0) {
        if (pList->bEntryGate == 0) {
    ...
    func_ov008_0206f8dc(&pList->aRowInfoSurface[nRow]);
    pInfo = pList->aRowInfoSurface;
    func_02030158(&pInfo[nRow]);
    func_020262a0(aRank, 4, data_ov008_02090878, pEntry->nRank, nGlyph);
    func_02030278(&pList->aRowInfoSurface[nRow], 0, 5, nColour, aRank, 1);
    if (func_ov008_02051028() == 0 || pList->bEntryGate != 0) {
        nSlot = pEntry->nTextSlot;
        if (bUnlocked != 0) {
            func_ov008_0206f96c(&pList->aRowInfoSurface[nRow], func_ov008_0205b6c8(nSlot), 0x60);
        }
        if (bUnlocked != 0) {
            func_02030278(&pList->aRowInfoSurface[nRow], 0x14, 5, nColour, (void *)func_ov008_0205b6c8(nSlot), 1);
        }
        if (bUnlocked == 0) {
            func_02030278(&pList->aRowInfoSurface[nRow], 0x14, 5, nColour, func_ov008_02055c84(pList->textCacheA, TEXT_LOCKED), 1);
        }
    } else {
        pText = (void *)data_ov008_02090888;
        switch (pEntry->nRewardKind) {
        case 0:
            pText = func_ov008_02055c84(pList->textCacheA, TEXT_REWARD_FIRST);
            break;
        case 1:
            pText = func_ov008_02055c84(pList->textCacheA, TEXT_REWARD_FIRST + 1);
            break;
        case 2:
            pText = func_ov008_02055c84(pList->textCacheA, TEXT_REWARD_FIRST + 2);
            break;
        case 3:
            pText = func_ov008_02055c84(pList->textCacheA, TEXT_REWARD_FIRST + 3);
            break;
        case 4:
            pText = func_ov008_02055c84(pList->textCacheA, TEXT_REWARD_FIRST + 4);
            break;
        case 5:
            pText = func_ov008_02055c84(pList->textCacheA, TEXT_REWARD_FIRST + 6);
            break;
        case 6:
            pText = func_ov008_02055c84(pList->textCacheA, TEXT_REWARD_FIRST + 7);
            break;
        case 7:
            pText = func_ov008_02055c84(pList->textCacheA, TEXT_REWARD_FIRST + 8);
            break;
        case 8:
            pText = func_ov008_02055c84(pList->textCacheA, TEXT_REWARD_FIRST + 9);
            break;
        }
        func_020262a0(aDesc, 0x100, pEntry->pDescFormat, pText);
        func_ov008_0206f96c(&pInfo[nRow], (int)aDesc, 0x78);
        func_02030278(&pInfo[nRow], 0x14, 5, nColour, aDesc, 1);
    }
    func_ov008_0206f8f8(&pList->aRowNameSurface[nRow]);
    if (*pEntry->pName == 0 && pNode != 0) {
        func_ov008_0206f9a8(&pList->aRowNameSurface[nRow], pNode->pName, 0x80);
        func_02030158(&pList->aRowNameSurface[nRow]);
        func_02030278(&pList->aRowNameSurface[nRow], 0, 1, nColour, pNode->pName, 1);
    } else {
        func_ov008_0206f9a8(&pList->aRowNameSurface[nRow], pEntry->pName, 0x80);
        func_02030158(&pList->aRowNameSurface[nRow]);
        func_02030278(&pList->aRowNameSurface[nRow], 0, 1, nColour, pEntry->pName, 1);
    }
    func_ov008_0206f8dc(&pList->aRowDotSurface[nRow]);
    if (bTransition == 0) {
        nSet = 0;
        nTotal = 0;
        func_ov008_0206fc24(pList, pEntry->nWord, &nSet, &nTotal);
        func_02030158(&pList->aRowDotSurface[nRow]);
        func_020262a0(aCount, 4, data_ov008_0209088c, nSet, nTotal);
        func_02030278(&pList->aRowDotSurface[nRow], 2, 7, nColour, aCount, 1);
    } else if (pList->bEntryGate != 0) {
        pText = func_ov008_02055c84(pList->textCacheB, pEntry->nCount + TEXT_COUNT_BASE);
        func_02030158(&pList->aRowDotSurface[nRow]);
        if (pEntry->nCount != 0) {
