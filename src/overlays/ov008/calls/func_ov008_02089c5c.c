/* func_ov008_02089c5c -- Ov008_ShopConfirmPurchase: the shop's "confirm" state.
...
extern void func_ov008_02089760(int nGrantId);                         /* grant hook */
extern void func_ov008_020878c4(void);                                 /* Ov008_RefreshPanelDisplay */
extern void *func_ov008_02089d44(void);                                /* Ov008_CommitSelection */

void *func_ov008_02089c5c(void)
{
    ...
    if ((data_0204c190 & KEY_CONFIRM_MASK) != 0 || *(int *)(ctx + 0xc118) != 0) {
        ...
        pNext = (void *)func_ov008_02089d44;
        if (pRecord->pItemDef != 0) {
            nItemId = pRecord->pItemDef->nItemId;
            pState = data_0204be18;
            if (pState->aItemCount[nItemId] < func_ov008_02082234(pRecord)) {
            ...
            func_ov008_02089760(pDetail->pRecord->nGrantId);
        }
    }
    func_ov008_020878c4();
    return pNext;
