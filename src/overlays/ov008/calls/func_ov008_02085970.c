/* func_ov008_02085970 -- Ov008_CanConfirmShopRow: whether the shop's selected
...
extern int func_ov008_0208b0d0(Ov008ParamRecord *pRecord);              /* Ov008_CountSpareItemsOfChild (u8) */
extern int func_ov008_020830c8(Ov008ParamRecord *pRecord);              /* Ov008_AreRequirementsMet */

int func_ov008_02085970(void)
{
    ...
    case TAB_BUY:
        ...
        break;
    case TAB_SELL:
        if (pRecord->pItemDef->nSellable == 1 && func_ov008_0208b0d0(pRecord) > 0) {
            return 1;
        }
        break;
    case TAB_REDEEM:
        if (data_0204be18->nPoints >= pRecord->nPrice) {
            ...
            if (pRecord->nCount + data_0204be18->aItemCount[nItem] <= (u32)nCap) {
                return func_ov008_020830c8(pRecord);
            }
        }
        break;
    }
