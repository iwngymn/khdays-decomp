/* func_ov008_02064dac -- Ov008_LayoutSecondaryList: place the secondary list's
...
extern int func_ov008_02054788(int nCtx, int nId);                  /* FindEntryById */
extern UiLayoutPos *func_ov008_02054820(int nCtx, int nEntry);      /* Ov008_GetEntryPos */
extern void func_ov008_02054858(int nCtx, int nEntry, UiLayoutPos *pPos); /* Ov008_SetEntryPos */
extern void *NNS_FndGetNextListObject(void *pList, void *pObject);

void func_ov008_02064dac(Ov008MenuContext *pCtx)
{
    int nCtx;
    UiLayoutPos *pPos;
    UiLayoutPos pos;
    ...
    pPos = func_ov008_02054820(nCtx, func_ov008_02054788(nCtx, WIDGET_LIST_FRAME));
    ...
    if (pCtx->pListNode->nPlacedSlot >= 0) {
        ...
        func_ov008_02054858(nCtx, func_ov008_02054788(nCtx, WIDGET_LIST_CURSOR), &pos);
    }
