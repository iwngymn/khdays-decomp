/* func_ov008_02084ebc -- Ov008_ShowShopRows: lay the shop list region out
...
extern void func_ov008_020848e8(int nRow, void *pRecord);                /* draw the row text */
extern void func_ov008_02084b10(int nRow, void *pRecord);                /* draw the row icon */

void func_ov008_02084ebc(void **apRows, u32 nCount, int nFirst)
{
    ...
    for (i = 0; i < ROW_COUNT; i++) {
        ...
        func_ov008_020848e8(i, apRows[nIndex]);
        func_ov008_02084b10(i, apRows[nIndex]);
    }
}
