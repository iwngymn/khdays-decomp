/* func_ov008_02078cf0 -- Ov008_PlaceTutorialSurfaces: clear the tutorial layer
...
void func_ov008_02078cf0(void)
{
    Ov008PageB *pPage = func_ov008_02050cec();
    int hLayer;

    func_ov008_02050bb0(SLOT_TUTORIAL, 0, 0, 0x20, 0x20);
    hLayer = func_ov008_02050c7c(SLOT_TUTORIAL);
