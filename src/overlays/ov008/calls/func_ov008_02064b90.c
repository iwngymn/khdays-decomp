/* func_ov008_02064b90 -- Ov008_GridMenuCancel: the grid menu's cancel
...
extern int  func_ov008_02062288(Ov008MenuContext *pCtx, int nRow);        /* Ov008_SelectListRow */
extern void func_ov008_0205f084(Ov008MenuContext *pCtx, int nRow);        /* Ov008_HighlightListRow */

void func_ov008_02064b90(Ov008MenuContext *pCtx)
{
    ...
    case STATE_GRID:
        if (pCtx->bHolding != 0) {
            ...
            if (func_ov008_02061f40(pCtx, pCtx->nVisiblePage, pCtx->nColumn, pCtx->nRowSel, 0) != 0) {
                pCtx->bMoveArmed = 1;
            ...
            if (pCtx->bSecondaryPanel != 0) {
                func_ov008_020631cc(pCtx, STATE_DRAG);
