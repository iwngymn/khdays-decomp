/* func_ov008_0206ba8c -- Ov008_DrawStatusPanelLabels: lay out and draw the
...
extern void *func_ov008_02050ea4(void);                                   /* wide glyph set */
...
void func_ov008_0206ba8c(Ov008StatusPanel *pPanel)
{
    ...
    nMode = func_02024e5c();
    pNarrow = func_ov008_02050e74();
    pWide = func_ov008_02050ea4();
    if (pPanel->bWide == 0) {
        nShift = SHIFT_NARROW;
    } else {
        nShift = 0;
    ...
    for (i = 0; i < PAIR_COUNT; i++) {
        ...
        pos.nX += nShift << 12;
        func_ov008_020548a4(nCtx, func_ov008_02054788(nCtx, pairs.aPair[i].nFirst), &pos);
        func_ov008_020548a4(nCtx, func_ov008_02054788(nCtx, pairs.aPair[i].nSecond), &pos);
    }
    func_02030158(pPanel->labelSurface);
    func_02030278(pPanel->labelSurface, nShift + 8, 4, LABEL_COLOUR, func_ov008_02055c84(pPanel->textLoader, 0), 1);
    func_02030278(pPanel->labelSurface, nShift + 8, 0x14, LABEL_COLOUR, func_ov008_02055c84(pPanel->textLoader, 1), 1);
    pPanel->pLabelPixels = pWide;
    func_02030278(pPanel->labelSurface, nShift + 8, 0x24, LABEL_COLOUR, func_ov008_02055c84(pPanel->textLoader, 2), 1);
    pPanel->pLabelPixels = pNarrow;
    if (nMode == 5 || nMode == 3) {
        pPanel->pLabelPixels = pWide;
    }
    func_02030278(pPanel->labelSurface, nShift + 8, 0x34, LABEL_COLOUR, func_ov008_02055c84(pPanel->textLoader, 3), 1);
    if (nMode == 5 || nMode == 3) {
        pPanel->pLabelPixels = pNarrow;
    }
    func_ov008_0206ec2c(2, pPanel->aValue[0], pPanel->aExtra[0]);
    func_ov008_0206ec2c(3, pPanel->aValue[1], pPanel->aExtra[1]);
    func_ov008_0206ec2c(5, pPanel->aValue[2], pPanel->aExtra[2]);
    func_ov008_0206ec2c(6, pPanel->aValue[3], pPanel->aExtra[3]);
    func_ov008_0206f35c();
}
