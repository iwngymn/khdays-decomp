/* func_ov008_020615dc -- Ov008_ResetGridDrag: end a grid drag.  The drag
...
extern int  func_ov008_02060d38(Ov008MenuContext *pCtx, Ov008Message15Record *pRecord, u32 nPage, u32 nCol, u16 nRow); /* place a record back */
...
void func_ov008_020615dc(Ov008MenuContext *pCtx, int bRestore)
{
    int i;
    ...
    if (pCtx->pListNode != 0) {
        if (bRestore != 0) {
            func_ov008_02060d38(pCtx, pCtx->pListNode, pCtx->nDragNode, pCtx->nHomeCol, pCtx->nHomeRow);
            ...
            for (pCell = NNS_FndGetNextListObject(pCtx->liftedList, 0); pCell != 0;
                ...
                func_ov008_02060d38(pCtx, pCell->pRecord, pCtx->nDragNode,
        ...
        func_ov008_02054b18(nCtx, func_ov008_02054788(nCtx, WIDGET_DRAG), 0);
        ...
        func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, WIDGET_HINT), 0);
    }
    pCtx->bTween = 0;
    pCtx->bScroll = 0;
    pCtx->bLifted = 0;
