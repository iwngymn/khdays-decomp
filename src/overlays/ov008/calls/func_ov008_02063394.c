/* func_ov008_02063394 -- Ov008_SetupPresetPanel: display setup for the three
...
extern void  func_ov008_02054ba4(void *pMenu, void *pEntry, int bVisible);             /* SetEntrySlotsVisible */
extern void  func_ov008_02054b18(void *pMenu, void *pEntry, int nValue);               /* Ov008_PushSubitemSet */

void func_ov008_02063394(Ov008MenuContext *pCtx, void *pMenu, int hLayer, int bAll)
{
    int i;
    int bUnlocked;
    void *pRecord;
    ...
    for (i = 0; i < PRESET_COUNT; i++) {
        ...
        pRecord = func_ov008_02055c84(pCtx->varRecords, i + 0x10);
        if (bUnlocked != 0) {
    ...
    if (bAll != 0) {
        ...
        func_ov008_0205da10(pMenu, 0x57, 1);
        nTarget = 2;
        func_ov008_02054cc4(pMenu, func_ov008_02054788(pMenu, 0x59));
        func_ov008_0205cbb0(func_ov008_02054788(pMenu, 0x59));
    } else {
        for (i = 0x5d; i <= 0x5f; i++) {
            pEntry = func_ov008_02054788(pMenu, i);
            func_ov008_02054ba4(pMenu, pEntry, 1);
            func_ov008_02054b18(pMenu, pEntry, func_02023588(FLAG_ENTRY_BASE + i) == 0);
        }
        func_ov008_0205da10(pMenu, 0x58, 1);
        nTarget = 0;
        func_ov008_02054cc4(pMenu, func_ov008_02054788(pMenu, pCtx->nPreset + 0x5d));
        func_ov008_0205cbb0(func_ov008_02054788(pMenu, pCtx->nPreset + 0x5d));
    }
