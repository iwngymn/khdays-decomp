/* func_ov008_02061ce4 -- Ov008_PickUpGridNode: lift the node under the cursor
...
extern void func_ov008_02056988(int *pTexture, int *pParams);                /* Ov008_GetTextureParams */
...
extern Ov008GridHit *func_ov008_0205fdac(Ov008MenuContext *pCtx, u32 nPage, u32 nCol, u32 nRow); /* Ov008_FindGridHit */
extern void func_ov008_02061b18(Ov008MenuContext *pCtx, Ov008GridHit *pHit); /* unlink the hit */
...
int func_ov008_02061ce4(Ov008MenuContext *pCtx)
{
    ...
    if (pNode != 0) {
        ...
        func_ov008_02056988(pCtx->drag.aTexture, func_ov008_0205da50(pCtx, pCtx->pListNode->nTag)->pParams);
        nCtx = func_ov008_02050c54();
        func_ov008_02054b18(nCtx, func_ov008_02054788(nCtx, WIDGET_DRAG), 1);
        pIcon = func_ov008_02054788(nCtx, WIDGET_ICON);
        if (pNode->nIconFrame >= 0) {
            func_ov008_02061b18(pCtx, func_ov008_0205fdac(pCtx, pCtx->nDragNode, pCtx->nHomeCol, pCtx->nHomeRow));
            pHit = func_ov008_0205fdac(pCtx, pCtx->nDragNode, pCtx->nHomeCol, pCtx->nHomeRow);
            if (pHit != 0) {
                func_ov008_02054b18(nCtx, pIcon, pHit->nSubitem);
            }
            func_ov008_02054c80(nCtx, pIcon, (u16)pNode->nIconFrame);
