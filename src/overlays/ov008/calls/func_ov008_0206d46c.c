/* func_ov008_0206d46c -- Ov008_DrawStatusField: redraw one field of the
...
extern u16   func_ov008_0206b6ac(void);                                /* title text id */
extern void *func_ov008_02055c84(void *pRecords, int nIndex);          /* GetVarRecordByIndex */
extern void  func_ov008_0206d064(void *pSurface, int nX, int nY, int nColour, int nFlag, void *pText); /* Ov008_DrawStringOptShadow */
extern void  func_0203011c(void *pSurface, int nX, int nY, int nW, int nH); /* Obj_InvokeInnerVtable8 */
extern void  func_ov008_0206d14c(void *pSurface, int nX, int nY, int nColour, int nFlag, u32 nValue); /* Ov008_BuildTableAndDelegate */
extern void  func_ov008_0206d21c(void *pSurface, int nX, int nY, int nColour, int nFlag, u32 nValue); /* Ov008_BuildTable11AndDelegate */
extern void  func_02030278(void *pSurface, int nX, int nY, int nColour, void *pText, int nFlag); /* Text_DrawWithShadow */
extern void  func_ov008_0206d0d8(void *pSurface, int nX, int nY, int nColour, int bShadow, const void *pText); /* Ov008_DrawElementWithShadow */
extern void  func_ov008_0206d1b0(void *pSurface, int nX, int nY, int nColour, int nFlag, u32 nA, u32 nB); /* Ov008_BuildTable20AndDelegate */
extern void  func_ov008_0206d280(Ov008StatusPanel *pPanel, int nTab);  /* Ov008_SelectStatusTab */

void func_ov008_0206d46c(Ov008StatusPanel *pPanel, int nField, u32 nDelta, int nStyle, u32 *pValues, int bAnimate)
{
    int nCtx;
    int nColour;
    int nShift;
    ...
    case 0:
        ...
        func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, 0x80), 0);
        func_ov008_02054ba4(nCtx, pPanel->pPageWidget, 0);
        return;
    case 1:
        pText = func_ov008_02055c84(pPanel->textLoader, func_ov008_0206b6ac());
        func_02030158(pPanel->titleSurface);
        func_ov008_0206d064(pPanel->titleSurface, 0x20, 0, COLOUR_TEXT, 0, pText);
        return;
    case 2:
        pPanel->aExtra[0] = pValues[0];
        pPanel->aValue[0] = nDelta;
        func_0203011c(pPanel->levelSurface, nShift + 0x23, 4, 0x1f, 0xc);
        func_ov008_0206d14c(pPanel->levelSurface, nShift + 0x34, 4, COLOUR_VALUE, 1, pPanel->aExtra[0]);
        if (nDelta == 0) {
            return;
        }
        func_ov008_0206d21c(pPanel->levelSurface, nShift + 0x34, 4, nColour, 1, nDelta);
        return;
    case 3:
        pPanel->aExtra[1] = pValues[0];
        pPanel->aValue[1] = nDelta;
        func_0203011c(pPanel->levelSurface, nShift + 0x21, 0x14, 0x29, 0xc);
        func_ov008_0206d14c(pPanel->levelSurface, nShift + 0x34, 0x14, COLOUR_VALUE, 1, pPanel->aExtra[1]);
        if (nDelta == 0) {
            return;
        }
        func_ov008_0206d21c(pPanel->levelSurface, nShift + 0x34, 0x14, nColour, 1, nDelta);
        return;
    case 5:
        pPanel->aExtra[2] = pValues[0];
        pPanel->aValue[2] = nDelta;
        func_0203011c(pPanel->levelSurface, nShift + 0x27, 0x24, 0x1d, 0xc);
        func_ov008_0206d14c(pPanel->levelSurface, nShift + 0x34, 0x24, COLOUR_VALUE, 1, pPanel->aExtra[2]);
        if (nDelta == 0) {
            return;
        }
        func_ov008_0206d21c(pPanel->levelSurface, nShift + 0x34, 0x24, nColour, 1, nDelta);
        return;
    case 6:
        pPanel->aExtra[3] = pValues[0];
        pPanel->aValue[3] = nDelta;
        func_0203011c(pPanel->levelSurface, nShift + 0x27, 0x34, 0x1d, 0xc);
        func_ov008_0206d14c(pPanel->levelSurface, nShift + 0x34, 0x34, COLOUR_VALUE, 1, pPanel->aExtra[3]);
        if (nDelta == 0) {
            return;
        }
        func_ov008_0206d21c(pPanel->levelSurface, nShift + 0x34, 0x34, nColour, 1, nDelta);
        return;
    case 7:
        ...
        func_ov008_0206d14c(pPanel->statSurface, 0x3f, 7, COLOUR_VALUE, 1, nValue);
        if (nDelta == 0) {
            return;
        }
        func_ov008_0206d21c(pPanel->statSurface, 0x3f, 7, nColour, 1, nDelta);
        return;
    case 0xc:
        ...
        func_ov008_0206d14c(pPanel->statSurface, 0x9c, 7, COLOUR_VALUE, 1, (int)nValue >> 12);
        if (nDelta == 0) {
            return;
        }
        func_ov008_0206d21c(pPanel->statSurface, 0x9c, 7, nColour, 1, (int)nDelta >> 12);
        return;
    case 9:
        ...
        func_ov008_0206d14c(pPanel->statSurface, 0x3f, 0x17, COLOUR_VALUE, 1, nValue);
        if (nDelta == 0) {
            return;
        }
        func_ov008_0206d21c(pPanel->statSurface, 0x3f, 0x17, nColour, 1, nDelta);
        return;
    case 0xd:
        ...
        func_ov008_0206d14c(pPanel->statSurface, 0x9c, 0x17, COLOUR_VALUE, 1, nValue);
        if (nDelta == 0) {
            return;
        }
        func_ov008_0206d21c(pPanel->statSurface, 0x9c, 0x17, nColour, 1, nDelta);
        return;
    case 0xb:
        ...
        func_ov008_0206d14c(pPanel->statSurface, 0x3f, 0x27, COLOUR_VALUE, 1, nValue);
        if (nDelta == 0) {
            return;
        }
        func_ov008_0206d21c(pPanel->statSurface, 0x3f, 0x27, nColour, 1, nDelta);
        return;
    case 0x12:
        pText = func_ov008_02055c84(pPanel->textLoader, TEXT_CAPTION_12);
        nFirst = pValues[0];
        nSecond = pValues[1];
        func_0203011c(pPanel->statSurface, 5, 0x67, 0x98, 0xc);
        func_02030278(pPanel->statSurface, 5, 0x67, COLOUR_TEXT, pText, 1);
        func_ov008_0206d14c(pPanel->statSurface, 0x74, 0x67, nColour, 1, nFirst);
        func_ov008_0206d14c(pPanel->statSurface, 0x9f, 0x67, nColour, 1, nSecond);
        return;
    case 0x13:
        nValue = pValues[0];
        func_0203011c(pPanel->statSurface, 5, 0x77, 0x97, 0xc);
        pText = func_ov008_02055c84(pPanel->textLoader, TEXT_CAPTION_13);
        func_02030278(pPanel->statSurface, 5, 0x77, COLOUR_TEXT, pText, 1);
        func_ov008_0206d0d8(pPanel->statSurface, 0x9c, 0x77, nColour, 1, func_ov008_02055c84(pPanel->textLoader, nValue));
        return;
    case 0xe:
        pText = func_ov008_02055c84(pPanel->textLoader, TEXT_CAPTION_E);
        func_0203011c(pPanel->statSurface, 5, 0x37, 0x98, 0xc);
        func_02030278(pPanel->statSurface, 5, 0x37, COLOUR_TEXT, pText, 1);
        func_ov008_0206d14c(pPanel->statSurface, 0x9f, 0x37, nColour, 1, pValues[0]);
        return;
    case 0xf:
        nValue = pValues[0];
        pText = func_ov008_02055c84(pPanel->textLoader, TEXT_CAPTION_F);
        func_0203011c(pPanel->statSurface, 5, 0x47, 0x98, 0xc);
        func_02030278(pPanel->statSurface, 5, 0x47, COLOUR_TEXT, pText, 1);
        if ((int)nValue < 0) {
            func_ov008_0206d0d8(pPanel->statSurface, 0x9f, 0x47, nColour, 1, data_ov008_02090814);
        } else {
            func_ov008_0206d14c(pPanel->statSurface, 0x9f, 0x47, nColour, 1, nValue);
        }
        return;
    case 0x11:
        nValue = pValues[0];
        ...
        if (data_0204be18->aItemCount[1] + 0xf > 0x78) {
            func_ov008_0206d1b0(pPanel->statSurface, 0x9f, 0x57, nColour, 1, nValue, 0x78);
        } else {
            func_ov008_0206d1b0(pPanel->statSurface, 0x9f, 0x57, nColour, 1, nValue, nSecond);
        }
        return;
    case 0x14:
        func_ov008_0206d280(pPanel, pValues[0]);
        return;
    }
}
