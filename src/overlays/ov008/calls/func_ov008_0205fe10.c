/* func_ov008_0205fe10 -- Ov008_CanPlaceShape: can shape pEntry be placed with
...
int func_ov008_0205fe10(Ov008MenuContext *pCtx, Ov008ShapeEntry *pEntry, int nPage, int nLeft, int nTop)
{
    int bFits;
    int nRow;
    int nCol;
