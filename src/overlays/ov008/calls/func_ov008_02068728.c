/* func_ov008_02068728 -- Ov008_SaveMenuConfirm: the save menu's "confirm"
...
extern void func_ov008_020693c4(Ov008SaveMenu *pMenu, int nPhase);       /* lay the menu out */
extern void func_02020904(void);                                         /* IncGlobalShort_0204bda0 */
extern int  func_ov008_020677b0(Ov008SaveMenu *pMenu, u32 nSlot);        /* Ov008_BeginSaveToSlot */
...
void func_ov008_02068728(Ov008SaveMenu *pMenu)
{
    int bYes;
    int i;
    ...
    switch (pMenu->nPhase) {
    case PHASE_PICK:
        func_ov008_02068d58(0, 1);
        func_ov008_020693c4(pMenu, PHASE_CONFIRM);
        pMenu->bConfirmYes = 0;
    ...
    case PHASE_CONFIRM:
        ...
        if (bYes != 0) {
            func_02020904();
            if (func_ov008_020677b0(pMenu, pMenu->nSlot) == 0) {
                pMenu->nState = 1;
                pMenu->nSubState = 1;
            }
            ...
            func_ov008_020693c4(pMenu, PHASE_SAVING);
            ...
            func_ov008_020693c4(pMenu, PHASE_PICK);
