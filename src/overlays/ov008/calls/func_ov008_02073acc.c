/* func_ov008_02073acc -- Ov008_MissionListKeyDown: move the mission list's
...
void func_ov008_02073acc(Ov008MissionList *pList)
{
    int nNext;
    int nCurrent;
    int nCount;
    ...
    if (nCurrent != nNext) {
        func_ov008_02071618(pList, nNext, 0);
    }
}
