/* func_ov008_020659c0 -- Ov008_GridMenuInitStep: one step of the grid
...
extern void  func_ov008_0205c580(int *pSlot, void *pArg);                /* open the resource slot */
extern int   func_ov008_02051094(int nDb);                               /* Ov008_AcquireMsgDb */
extern void  func_ov008_0205c780(Ov008MenuContext *pCtx);                /* Ov008_InitMessageRecordCaches */
extern void  func_ov008_020533e4(void *pSummary, void *pHooks);          /* init a summary */
extern void  func_ov008_0205d324(void);                                  /* Ov008_InitializeSavePageGraphics */
extern void  func_ov008_0205d56c(Ov008MenuContext *pCtx);                /* Ov008_InitializeSavePageLayout */
extern void  func_ov008_0205dbcc(Ov008MenuContext *pCtx);
extern void  func_ov008_0205f6f8(Ov008MenuContext *pCtx);                /* Ov008_InitGridMenuSurfaces */
extern void  func_ov008_0205f98c(Ov008MenuContext *pCtx);                /* Ov008_InitGridMenuTextures */
extern void  func_ov008_0205fbc4(Ov008MenuContext *pCtx);                /* Ov008_InitPageGrid */
extern void  func_02035f84(void *pTween);                                /* Tween_Clear */
extern void *func_ov008_02050d04(void *pFn);                             /* Ov008_AllocCodeNode */
extern int   func_ov008_0205c670(void);                                  /* Ov008_TickInfoWindowTransition */
extern void  func_ov008_02064fb8(Ov008MenuContext *pCtx);                /* Ov008_LoadGridFromSave */
extern void  func_ov008_0205e8d0(Ov008MenuContext *pCtx);                /* Ov008_BuildInventoryLists */
extern void  func_ov008_02064eb4(Ov008MenuContext *pCtx);                /* Ov008_DrawGridMenu */
...
extern void  func_ov008_02062d00(Ov008MenuContext *pCtx, int nPage, int bSound); /* Ov008_ShowGridPage */
...
extern void  func_ov008_02065584(Ov008MenuContext *pCtx);                /* Ov008_MarkAnyActiveSlot */
...
extern void  func_ov008_0208e60c(void *pLoader, Ov008HandlerPair *pHandlers); /* Ov008_InitWithDefaultHandlers */
extern void  func_ov008_0205c9b0(void);                                  /* summary hook / default handler */
extern int   func_ov008_0205ca8c(int *pArg);                             /* summary hook / default handler */

int func_ov008_020659c0(Ov008MenuContext *pCtx)
{
    int bDone;
    int nCtx;
    int i;
    ...
    case 0:
        ...
        pCtx->nDragX = 0xffff;
        pCtx->nDragY = 0xffff;
        pCtx->summaryHooks.pFirst = func_ov008_0205c9b0;
        pCtx->summaryHooks.pSecond = func_ov008_0205ca8c;
        func_ov008_0205c580(&pCtx->nResourceSlot, 0);
        func_ov008_02051094(0x15);
        func_ov008_02051094(0x1b);
        func_ov008_02051094(0x14);
        func_ov008_02051094(0x16);
        func_ov008_02051094(0x13);
        func_ov008_02051094(pCtx->nResourceSlot);
        func_ov008_0205c780(pCtx);
        func_ov008_020533e4(pCtx->summary, &pCtx->summaryHooks);
        func_ov008_0205d324();
        func_ov008_0205d56c(pCtx);
        func_ov008_0205dbcc(pCtx);
        func_ov008_0205f6f8(pCtx);
        func_ov008_0205f98c(pCtx);
        func_ov008_0205fbc4(pCtx);
        func_02035f84(pCtx->slideTween);
        func_ov008_02050d04(func_ov008_0205c670);
        break;
    case 1:
        func_ov008_02064fb8(pCtx);
        break;
    case 2:
        func_ov008_0205e8d0(pCtx);
        break;
    case 3:
        func_ov008_02064eb4(pCtx);
        break;
    case 4:
        func_ov008_0205da8c(pCtx, 0);
        nTracker = func_ov008_02050c28();
        func_ov008_0205589c(nTracker, func_ov008_02055808(nTracker, 1));
        func_ov008_0205589c(nTracker, func_ov008_02055808(nTracker, 2));
        pCtx->menuMode = 0;
        pCtx->nVisiblePage = 2;
        func_ov008_02062d00(pCtx, 0, 0);
        pCtx->nPage = 2;
        func_ov008_02063018(pCtx, 0);
        func_ov008_02064eb4(pCtx);
        break;
    case 5:
        if (func_ov008_0206eb64(CURSOR_MODE_DRAG, 0, 0) == 0) {
            pCtx->bTransition = 3;
        }
        func_ov008_0206f384();
        func_ov008_02064eb4(pCtx);
        func_ov008_02065584(pCtx);
        func_ov008_020631cc(pCtx, pCtx->bSecondaryPanel != 0 ? 2 : 0);
        if (pCtx->bSecondaryPanel == 0) {
            for (i = 0x37; i <= 0x38; i++) {
                func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, i), 0);
            }
        }
        handlers.pFirst = func_ov008_0205c9b0;
        handlers.pSecond = func_ov008_0205ca8c;
        func_ov008_0208e60c(pCtx->textLoader, &handlers);
        bDone = 1;
        break;
    }
    pCtx->nInitStep++;
