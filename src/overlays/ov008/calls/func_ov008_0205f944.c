/* func_ov008_0205f944 -- Ov008_InitGridCell: reset one 40-byte grid cell to its
...
void func_ov008_0205f944(Ov008GridCell *pCell, short nX, short nY, short nTile, short nPalette)
{
    pCell->nState = 0;
