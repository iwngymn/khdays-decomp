/* func_ov008_0205fc6c -- Ov008_PickUpListItem: start dragging one copy of an
...
extern void func_ov008_020615dc(Ov008MenuContext *pCtx, int nArg);          /* drop the held node */
...
int func_ov008_0205fc6c(Ov008MenuContext *pCtx, Ov008InventoryItem *pItem, u16 nSlot)
{
    int nCtx;
    ...
    if (pCtx->pListNode != 0) {
        func_ov008_020615dc(pCtx, pCtx->nPending);
    }
    ...
    pDrag = &pCtx->drag;
    func_ov008_02056988(pDrag->aTexture, func_ov008_0205da50(pCtx, pItem->pEntry->nTag)->pParams);
    pDrag->nSlot = nSlot;
    if (pItem->pEntry->nIconFrame >= 0) {
        func_ov008_02054b18(nCtx, func_ov008_02054788(nCtx, WIDGET_ICON), 0);
        func_ov008_02054c80(nCtx, func_ov008_02054788(nCtx, WIDGET_ICON), (u16)pItem->pEntry->nIconFrame);
        func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, WIDGET_ICON), 1);
    }
