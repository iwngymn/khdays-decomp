/* func_ov008_020743e4 -- Ov008_CountGroupFlagsSet: find the flag group with the
...
void func_ov008_020743e4(Ov008FlagOwner *pOwner, u32 nId, int *pnSet, u32 *pnCount)
{
    u8 nGroups;
    int i;
    int k;
