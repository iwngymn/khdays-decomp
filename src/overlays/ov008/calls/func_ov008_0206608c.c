/* func_ov008_0206608c -- Ov008_MenuKeyDown: the menu's "down" key handler.
 ...
 * cursor one row down (func_ov008_0206245c) and, if that took, arms the move,
...
void func_ov008_0206608c(Ov008MenuContext *pCtx)
{
    u16 touch[3];
    ...
    case 2:
        ...
        if (func_ov008_02062288(pCtx, (int)(func_02020400(pCtx->nPage + 1, pCtx->nPageCount) >> 32)) == 0) {
            return;
        }
