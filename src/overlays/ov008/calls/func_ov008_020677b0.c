/* func_ov008_020677b0 -- Ov008_BeginSaveToSlot: prepare and start a save into
...
extern int func_ov008_0208bd9c(int nSlot);                             /* Ov008_CommitSaveToSlot */

int func_ov008_020677b0(Ov008SaveMenu *pMenu, u32 nSlot)
{
    u32 nTier;
    u32 nCount;
    int nRange;
    ...
    nResult = func_ov008_0208bd9c(nSlot);
