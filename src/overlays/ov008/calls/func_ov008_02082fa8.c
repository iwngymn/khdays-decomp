/* func_ov008_02082fa8 -- Ov008_DrawDescriptionText: draw a description string on
...
extern void func_ov008_02054c80(void *pGroup, void *pWidget, int nFrame);   /* Ov008_ReleaseTwoSlotsEx */

void func_ov008_02082fa8(u16 *pText, u32 nIcon)
{
    ...
    pWidget = func_ov008_02054788(pGroup + 1, WIDGET_ICON);
    func_ov008_02054ba4(pGroup + 1, pWidget, nIcon < ICON_NONE);
    if (nIcon < ICON_NONE) {
        func_ov008_02054c80(pGroup + 1, pWidget, (u16)nIcon);
    }
}
