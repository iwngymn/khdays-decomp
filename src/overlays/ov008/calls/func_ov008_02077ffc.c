/* func_ov008_02077ffc -- Ov008_MissionMenuConfirm: the mission menu's "confirm"
...
extern void func_ov008_02076c48(Ov008MissionMenu *pMenu, int bExpand);   /* info panel slide */
extern void func_02033b78(int nKind, int nSound);                        /* PlaySound */
extern void func_ov008_020745c4(void);                                   /* start the mission */

void func_ov008_02077ffc(Ov008MissionMenu *pMenu)
{
