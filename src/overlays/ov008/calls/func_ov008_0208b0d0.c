/* func_ov008_0208b0d0 -- Ov008_CountSpareItemsOfChild: how many copies of the child
...
extern int func_ov008_0208b0bc(int nChild);   /* GetChildField14OrNeg1 */

u8 func_ov008_0208b0d0(int nChild)
{
    int nItem;
    u8 nSpare;
    int nMember;
    ...
    nItem = func_ov008_0208b0bc(nChild);
    if (nItem < 0) {
        return 0;
    }
