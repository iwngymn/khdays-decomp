/* func_ov008_02072d9c -- Ov008_BuildMissionListRows: build the mission list's
...
extern void func_ov008_02071618(Ov008MissionList *pList, int nRow, int nSound); /* Ov008_MissionListSelectRow */
extern void func_ov008_0207126c(Ov008MissionList *pList);                 /* Ov008_RefillListRows */

void func_ov008_02072d9c(Ov008MissionList *pList)
{
    int hLayer;
    int i;

    func_ov008_02050bb0(GRID_SLOT, 0, 0, 0x20, 0x20);
    hLayer = func_ov008_02050c7c(GRID_SLOT);
    ...
    for (i = func_ov008_0205b708(); i < ROW_COUNT; i++) {
