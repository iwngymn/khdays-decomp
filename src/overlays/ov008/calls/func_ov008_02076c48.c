/* func_ov008_02076c48 -- Ov008_ShowMissionInfoPanel: expand (bExpand) or
...
void func_ov008_02076c48(Ov008MissionMenu *pMenu, int bExpand)
{
    int nCtx;
    u16 nId;
    ...
    if (bExpand != 0) {
        func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, 0x34), 1);
