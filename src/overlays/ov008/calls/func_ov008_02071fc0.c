/* func_ov008_02071fc0 -- Ov008_FlushMissionListGraphics: publish the mission
...
extern void *func_ov008_02050c7c(int nSlot);                            /* Ov008_ResetEntry: slot data */
...
int func_ov008_02071fc0(void)
{
    ...
    if (pList->bMapDirty != 0) {
        GXS_LoadBG3Scr(func_ov008_02050c7c(0x1b), 0, 0x800);
        pList->bMapDirty = 0;
    }
    if (pList->nMode == LIST_MODE_ROWS && pList->bDirty != 0) {
        GXS_LoadBG2Scr(func_ov008_02050c7c(0x1a), 0, 0x800);
