/* func_ov008_0207378c -- Ov008_MissionListDestroy: tear the mission list
...
extern void func_ov008_0206fcbc(Ov008MissionList *pList);                 /* Ov008_Set_fcbc */
...
void func_ov008_0207378c(Ov008MissionList *pList)
{
    Ov008TagTable tags;
    int i;
    int nOwner;
    ...
    pList->nMode = 1;
    func_ov008_02050d50(pList->pListNode);
    if (pList->bEntryGate != 0) {
        func_02030d10(0);
    }
    func_ov008_0205658c(pList->missionList);
    func_ov008_02055c74(pList->textCacheA);
    func_ov008_02055c74(pList->textCacheB);
    func_ov008_0206fcbc(pList);
    ...
    func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, 4), 0);
    func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, 5), 0);
    nCtx = func_ov008_02050c64();
    func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, 0x3d), 0);
    func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, 0x3e), 0);
    func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, 0x3f), 0);
    func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, 1), 0);
    func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, 0x47), 0);
    func_ov008_02054ba4(nCtx, func_ov008_02054788(nCtx, 0x48), 0);
    pScroll[0] = 0;
    pScroll[2] = 0;
}
