/* func_ov008_0208a1b4 -- Ov008_FillRewardRecord: build a kind-3 param record from
...
void func_ov008_0208a1b4(Ov008RewardRecord *pOut, Ov008RawRewardRecord *pRaw, u16 nIndex)
{
    ...
    if (pRaw->nOwnText == 0) {
        pOut->pItemDef = data_ov008_02090fb0->pRecords[pRaw->nShopIndex - 1].pItemDef;
