/* func_ov008_02064440 -- Ov008_FillCursorCellFromSpares: fill the empty grid
...
extern Ov008Message15Record *func_ov008_02063cac(Ov008MenuContext *pCtx, Ov008TrackedNode *pNode); /* Ov008_FindSpareSingleForNode */
extern Ov008Message15Record *func_ov008_02063e58(Ov008MenuContext *pCtx, Ov008TrackedNode *pNode, Ov008Message15Record *pAnchor);
extern Ov008Message15Record *func_ov008_020641cc(Ov008MenuContext *pCtx, Ov008Message15Record *pAnchor); /* Ov008_FindBestSpareItemForNode */
...
extern void func_ov008_0205e790(Ov008MenuContext *pCtx, int nItemId, int nDelta); /* Ov008_BumpRowCounter */
...
int func_ov008_02064440(Ov008MenuContext *pCtx)
{
    int bFilled;
...
found:
    ...
    case CATEGORY_SINGLE:
        pRecord = func_ov008_02063cac(pCtx, pNode);
        break;
    case CATEGORY_KIND:
        pRecord = func_ov008_02063e58(pCtx, pNode, pAnchor);
        break;
    default:
        pRecord = func_ov008_020641cc(pCtx, pAnchor);
        break;
    }
    if (pRecord != 0) {
        if (func_ov008_02060d38(pCtx, pRecord, pCtx->nVisiblePage, (u16)nCol, (u16)nRow) != 0) {
            func_ov008_0205e790(pCtx, pRecord->nItemId, 1);
