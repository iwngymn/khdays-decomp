/* func_ov008_02068904 -- Ov008_SaveMenuInitStep: one step of the save menu's
 ...
 * (+0x158) at data_ov008_020904e4, backs the whole game state up (+0x248),
...
extern void  func_ov008_02067c04(void);                                   /* load the menu graphics */
...
extern void  func_ov008_02067db0(void);                                   /* Ov008_LoadMenuBgWithVariantChars */
extern void  func_ov008_02067edc(Ov008SaveMenu *pMenu);
extern void  func_ov008_0206821c(Ov008SaveMenu *pMenu);
extern void  func_ov008_02067970(Ov008SaveMenu *pMenu, int nOld, int nNew); /* Ov008_PlaceElementByVariant */
extern void  func_ov008_02069224(Ov008SaveMenu *pMenu);                   /* Ov008_RefreshSaveRowDigits */
extern void  func_02035f84(void *pTween);                                 /* Tween_Clear */
extern void  func_ov008_020679f8(int nPoints);
...
int func_ov008_02068904(Ov008SaveMenu *pMenu)
{
    int bDone;
    u32 nStamp;
    ...
    case 0:
        ...
        func_ov008_02055c4c(pMenu->varRecords, data_ov008_020904e4);
        ...
        break;
    case 1:
        if (func_ov008_020684d0(pMenu, pMenu->nCursor) == 2) {
    ...
    case 2:
        *data_0204be18 = pMenu->backup;
        func_ov008_02067db0();
        func_ov008_02067edc(pMenu);
        func_ov008_0206821c(pMenu);
        pMenu->nSlot = func_020235d0(FIELD_LAST_SLOT, 2);
        func_ov008_02067970(pMenu, 0, pMenu->nSlot);
        func_ov008_02069224(pMenu);
        func_02035f84(pMenu->tween);
        func_ov008_020679f8(data_0204be18->nPoints);
        pMenu->nInitStep++;
        break;
    case STEP_DONE:
        if (pMenu->nState != 0) {
            func_ov008_020693c4(pMenu, 4);
