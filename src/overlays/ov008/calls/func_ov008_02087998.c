/* func_ov008_02087998 -- Ov008_ShopCreate: build the shop scene context on
 * the current root heap (0xc608 bytes, zeroed, kept in data_ov008_02090fac).
...
extern void  func_ov008_02081f30(void);                                   /* Ov008_SetupShopDisplay */
extern void  func_ov008_0208247c(void);
extern void  func_ov008_02082714(void);
extern void  func_ov008_020829d4(void);                                   /* Ov008_InitShopSurfaces */
extern void  func_ov008_02084284(void);                                   /* Ov008_CreateListCells */
extern void  func_ov008_0208212c(void);                                   /* Ov008_ResetPreviewModel */
extern void  func_ov008_02083118(void);                                   /* Ov008_InitColumnCells */
...
extern void  func_ov008_0208a37c(void);                                   /* Ov008_CreateParamTable */
extern void  func_02024d68(void);
extern void  func_ov008_02082bcc(void);
...
extern void  func_ov008_02054c08(void *pManager, void *pEntry);           /* Ov008_ReleaseTwoSlots */
extern int   func_02036298(void *pHeader, Ov008HeaderLimits *pLimits);    /* Header_InitWithLimits */
extern void  func_ov008_0208e60c(void *pRecord, Ov008HandlerPair *pHandlers); /* Ov008_InitWithDefaultHandlers */
extern void  func_ov008_0208b838(void);
extern void  func_ov008_0208b870(void);
extern void  func_ov008_02087cac(void);                                   /* shop tick */

void *func_ov008_02087998(void)
{
    ...
    if (func_02030640() != 0 && func_02030670() != 0) {
        ctx->bSession = 1;
        func_ov008_02054ba4(pEntries, func_ov008_02054788(pEntries, WIDGET_SESSION), 1);
        func_ov008_02054c08(pEntries, func_ov008_02054788(pEntries, WIDGET_SESSION));
    }
    func_ov008_02054c08(pEntries, func_ov008_02054788(pEntries, WIDGET_CURSOR));
    ctx->limits.nColumns = 10;
    ctx->limits.nRows = 3;
    func_02036298(ctx->inputHeader, &ctx->limits);
    ctx->nFirst = 0;
    handlers.pFirst = func_ov008_0208b838;
    handlers.pSecond = func_ov008_0208b870;
    func_ov008_0208e60c(ctx->record, &handlers);
    return func_ov008_02087cac;
}
