/* func_ov008_02089428 -- Ov008_ShopDetailConfirmTick: one frame of the shop
...
extern void  func_ov008_0208b2c8(Ov008ParamRecord *pRecord);      /* Ov008_CommitSynthesisOrder */
...
extern int   func_ov008_02082cec(u8 *pBox);                       /* Ov008_CursorInBox */
extern void  func_ov008_02087160(void);                           /* Ov008_DrawShopDetailPanel */
extern void  func_ov008_020878c4(void);                           /* Ov008_RefreshPanelDisplay */
extern void *func_ov008_020896b4(void);                           /* next handler */

void *func_ov008_02089428(void)
{
    ...
    if (pPanel->bConfirmed != 0) {
        ...
        func_ov008_02054ba4(pWidgets, func_ov008_02054788(pWidgets, 8), 1);
        func_ov008_02054ba4(pWidgets, func_ov008_02054788(pWidgets, 1), 0);
        data_0204be18->nPoints -= pPanel->pRecord->nPrice;
        ctx->nHold31c = 0;
        ctx->nHold314 = 0;
        func_ov008_0208b2c8(pPanel->pRecord);
        func_ov008_020869a4();
        func_ov008_02083360();
        func_ov008_02054ba4(pWidgetsB, func_ov008_02054788(pWidgetsB, 6), 0);
        func_ov008_02083c44(pPanel->pRecord, -1);
        ...
        if (nChoice < 0 && ctx->bTouch != 0) {
            if (func_ov008_02082cec(data_ov008_0208fe74) != 0) {
                nChoice = 0;
                pPanel->nChoice = 0;
            } else if (func_ov008_02082cec(data_ov008_0208fe78) != 0) {
                nChoice = 1;
                pPanel->nChoice = 1;
            }
        }
