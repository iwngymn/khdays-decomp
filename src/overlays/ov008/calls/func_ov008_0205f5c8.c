/* func_ov008_0205f5c8 -- Ov008_DrawTextRow: draw the text entries of row nRow
...
void func_ov008_0205f5c8(Ov008TextRows *pCtx, void *pRecords, int nRow)
{
    ...
    pText = func_ov008_02055c84(pRecords, table.aIndex[nRow][0]);
    ...
    for (i = 1; i < ROW_ENTRIES; i++) {
        ...
        pText = func_ov008_02055c84(pRecords, table.aIndex[nRow][i]);
