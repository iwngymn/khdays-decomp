/* func_ov008_02073c48 -- Ov008_MissionListConfirm: the mission list's "confirm"
...
extern void func_ov008_02071ebc(Ov008MissionList *pList);                 /* selection step */

void func_ov008_02073c48(Ov008MissionList *pList)
{
    if (pList->bAnimating != 0) {
        return;
    }
    if (pList->bSelectionPending == 0 && pList->nSelected == NO_SELECTION) {
        func_ov008_02071ac8(pList, 1);
