/* func_ov008_02077190 -- Ov008_LoadMissionMenuGraphics: upload the mission
...
extern void  func_ov008_0207714c(u32 nArchiveId, BgCharLoader pLoad);   /* stream a character block */
...
void func_ov008_02077190(void)
{
    ...
    func_ov008_0207714c(func_ov008_02050f08(0x10), GXS_LoadBG0Char);
    func_ov008_0207714c(func_ov008_02050f08(0x11), GXS_LoadBG2Char);
    bAlt = func_02024e5c() == MODE_ALT;
    if (!bAlt) {
    ...
    func_ov008_0205589c(pOwner, func_ov008_02055808(pOwner, 3));
    func_ov008_0205589c(pOwner, func_ov008_02055808(pOwner, 6));
