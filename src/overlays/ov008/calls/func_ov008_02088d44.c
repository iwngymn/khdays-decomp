/* func_ov008_02088d44 -- Ov008_CounterDialogInput: one frame of input on
...
extern void  func_ov008_0208637c(void);                                /* Ov008_DrawSellDialog */
extern void  func_ov008_020878c4(void);                                /* Ov008_RefreshPanelDisplay */

Ov008ShopStep func_ov008_02088d44(void)
{
    ...
    case 0:
        if ((pfnNext == 0 && (pDialog->nRepeatBits & 1) == 0) || pDialog->nRow >= 0) {
            ...
            if (ctx->bTouch != 0) {
                i = 0;
                pBox = data_ov008_0208fea7;
                do {
                    if (func_ov008_02082cec(pBox) != 0) {
                        pDialog->nHold += 1;
                        pDialog->nRow = i;
                        pDialog->bRepeat = 0;
                        nRow = i;
                ...
                if (func_ov008_02082cec(&data_ov008_0208fea7[pDialog->nRow]) != 0) {
            ...
            if (nRow >= 0) {
                nKeys = data_ov008_0208fe64[nRow];
            }
        }
        ...
        if (nKeys & KEY_UP) {
            ...
            func_02033b78(0, 3);
            pfnNext = func_ov008_020893dc;
        }
        break;
    case 1:
        nKeys |= func_020362fc(&ctx->inputSource);
        if (pfnNext == 0 && ctx->bTouch != 0) {
            if (func_ov008_02082cec(data_ov008_0208fe84) != 0) {
                nPressed |= KEY_A;
                pDialog->nChoice = 0;
            } else if (func_ov008_02082cec(data_ov008_0208fe88) != 0) {
                nPressed |= KEY_B;
                pDialog->nChoice = 1;
            }
        }
        if (nKeys & (KEY_PAGE_DOWN | KEY_PAGE_UP)) {
            ...
            if (pDialog->nChoice == 0) {
                ...
                case TAB_BUY:
                    ...
                    func_020235a8(func_ov008_0208b0bc(pDialog->pRecord) + FLAG_ITEM_BOUGHT);
    ...
    if (pfnNext == 0) {
        ...
        case TAB_BUY:
            ...
            func_ov008_02083c44(pDialog->pRecord, pDialog->nCount + pDialog->nBase);
            if (nCountBefore != pDialog->nCount) {
                func_02033b78(0, 0);
            }
            break;
        case TAB_SELL:
            nSpare = func_ov008_0208b0d0(pDialog->pRecord);
            if (pDialog->nCount > nSpare) {
                pDialog->nCount = nSpare;
            }
            func_ov008_02083c44(pDialog->pRecord, pDialog->nBase - pDialog->nCount);
            if (nCountBefore != pDialog->nCount) {
                func_02033b78(0, 0);
            }
            break;
