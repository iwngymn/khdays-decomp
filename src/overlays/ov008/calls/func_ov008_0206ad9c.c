/* func_ov008_0206ad9c -- Ov008_DrawMenuPageTexts: redraw the menu page's
...
extern Ov008MenuList *func_ov008_02069b94(int nListId, u32 nSelection); /* list of the selection */
extern int   func_ov008_02050c54(void);                                 /* Ov008_GetContext */
extern void  func_ov008_0206a190(void *pField);                         /* reset to the narrow set */
extern void  func_02030158(void *pSurface);                             /* Obj_InvokeInnerVtable4 */
extern void  func_ov008_02069bec(Ov008SlotRef *pRef, s16 nId);          /* Ov008_Set_9bec: resolve a slot */
extern char *func_ov008_02055c84(void *pRecords, int nIndex);           /* GetVarRecordByIndex */
extern int   func_ov008_0206a1a8(void *pField, char *pText, int nMaxWidth); /* Ov008_FitTextFieldFont */
extern void  func_ov008_0206ac18(char *pText, int nX, int nY, int nStyle, u32 nColour, int bShadow); /* Ov008_DrawPageAElementWithShadow */
extern void  func_020300f8(void *pSurface);                             /* EnqueueObjGfxCommand */
extern void  func_ov008_02050b3c(int nSlot);                            /* Ov008_MarkSlotUsed */

void func_ov008_0206ad9c(void)
{
    Ov008SlotRef ref;
    Ov008SlotRef subRef;
    ...
    pSel = &pCtx->selection;
    pList = func_ov008_02069b94(pCtx->nListId, (u16)pCtx->nSelection);
    func_ov008_02050c54();
    func_ov008_0206a190(pCtx->textSurface);
    ...
    for (i = 0; i < pList->nCount; i++) {
        ...
        pText = func_ov008_02055c84(pCtx->varRecords, nText);
        func_ov008_0206a1a8(pCtx->textSurface, pText, nId - 4);
        func_ov008_0206ac18(pText, ref.nX / FX_ONE + 4, ref.nY / FX_ONE + 2, 2, COLOUR_TEXT, 1);
        nSubCount = pEntry->nSubCount;
        for (j = 0; j < nSubCount; j++) {
            nSubText = pEntry->aSub[j].nText;
            func_ov008_02069bec(&subRef, pEntry->aSub[j].nId);
            if (pEntry->bEnabled == 0) {
                nSubText = TEXT_DISABLED;
            }
            pText = func_ov008_02055c84(pCtx->varRecords, nSubText);
            func_ov008_0206a1a8(pCtx->textSurface, pText, (subRef.pSlot->nWidth - 8) - pAnchor->nX);
            func_ov008_0206ac18(pText, subRef.nX / FX_ONE + pAnchor->nX, subRef.nY / FX_ONE + pAnchor->nY, 2, COLOUR_TEXT, 1);
        }
    }
    pText = func_ov008_02055c84(pCtx->varRecords, pCtx->nLabelIndex);
    func_ov008_0206a190(pCtx->textSurface);
    func_ov008_0206ac18(pText, 0xfa, 2, 2, COLOUR_LABEL, 1);
    if (data_ov008_02090598[pSel->nEntry].bEnabled != 0) {
        pText = func_ov008_02055c84(pCtx->varRecords, data_ov008_02090598[pSel->nEntry].nHelpText);
        func_ov008_0206a1a8(pCtx->textSurface, pText, 0xf0);
        func_ov008_0206ac18(pText, 8, 0x98, 2, COLOUR_TEXT, 1);
        pText = func_ov008_02055c84(pCtx->varRecords, data_ov008_02090598[pSel->nEntry].aSub[pSel->aSub[pSel->nEntry]].nHelpText);
        func_ov008_0206a1a8(pCtx->textSurface, pText, 0xf0);
        func_ov008_0206ac18(pText, 8, 0xa4, 4, COLOUR_TEXT, 1);
    } else {
        pText = func_ov008_02055c84(pCtx->varRecords, TEXT_DISABLED);
        func_ov008_0206a1a8(pCtx->textSurface, pText, 0xf0);
        func_ov008_0206ac18(pText, 8, 0x98, 2, COLOUR_TEXT, 1);
    }
