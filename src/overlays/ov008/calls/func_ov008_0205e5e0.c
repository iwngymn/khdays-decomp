/* func_ov008_0205e5e0 -- Ov008_RefreshInventoryRow: redraw the visible
...
extern void  func_ov008_0205e0f4(Ov008MenuContext *pCtx, int nRow, int nPlaced, int nCount); /* draw the counts */
...
void func_ov008_0205e5e0(Ov008MenuContext *pCtx, int nItemId)
{
