/* func_ov008_02089e94 -- Ov008_RefreshShopUnlockParams: recompute the four
 ...
 * descriptor data_ov008_0208ff6c is walked while 0x1c9 holds: a mission whose
...
extern const Ov008MissionResourceDescriptor data_ov008_0208ff6c;
extern Ov008ParamTable *data_ov008_02090fb0;
extern void func_ov008_0205652c(Ov008MissionListState *pList, Ov008MissionResourceDescriptor *pDescriptor); /* Ov008_InitMissionList */
extern Ov008MissionListEntry *func_ov008_020565bc(Ov008MissionListState *pList, Ov008MissionListEntry *pEntry); /* Ov008_FindNextMissionEntry */
extern void func_ov008_0205658c(Ov008MissionListState *pList);           /* Ov008_DestroyMissionList */
extern int  func_020235d0(int nField, int nBits);                         /* GameState_GetField */

void func_ov008_02089e94(void)
{
    ...
    descriptor = data_ov008_0208ff6c;
    data_ov008_02090fb0->nParam1c9 = 1;
    data_ov008_02090fb0->nParam1c8 = 1;
    data_ov008_02090fb0->nParam1a0 = 1;
    data_ov008_02090fb0->nParam0e8 = 1;
    func_ov008_0205652c(&listA, &descriptor);
    descriptor.listKind = LIST_KIND_SECOND;
    func_ov008_0205652c(&listB, &descriptor);
    pEntry = 0;
    while (data_ov008_02090fb0->nParam1c9 != 0 && (pEntry = func_ov008_020565bc(&listA, pEntry)) != 0) {
        nRank = func_020235d0(pEntry->missionId * 3 + FIELD_RANK_BASE, FIELD_BITS);
        if (nRank < 3) {
            data_ov008_02090fb0->nParam1c8 = 0;
        }
        if (nRank < 2) {
            data_ov008_02090fb0->nParam1c9 = 0;
        }
        if (nRank < 2) {
            data_ov008_02090fb0->nParam0e8 = 0;
        }
    }
    pEntry = 0;
    nSpecial = 0;
    while (data_ov008_02090fb0->nParam1a0 != 0 && (pEntry = func_ov008_020565bc(&listB, pEntry)) != 0) {
    ...
    data_ov008_02090fb0->nParam1a0 = nCleared >= nSpecial;
    func_ov008_0205658c(&listB);
    func_ov008_0205658c(&listA);
}
