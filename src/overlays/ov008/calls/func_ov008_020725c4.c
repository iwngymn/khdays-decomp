/* func_ov008_020725c4 -- Ov008_InitMissionListProgress: count the mission
...
extern int  func_ov008_0205b690(void);                                    /* touch allowed */
...
extern int  func_ov008_0206fa1c(void);                                    /* Ov008_FireNodeTutorialOnce */
...
extern int  func_ov008_0206fa84(void);                                    /* Ov008_AnyMissionKindPending */
extern void func_ov008_0206fe4c(void);                                    /* ov008_helper_6fe4c */

void func_ov008_020725c4(Ov008MissionList *pList)
{
    int bTouch;
    int nFlagged;
    int nSpecial;
    ...
    pList->bAnimating = func_ov008_0206fa1c();
    pList->nAnimStep = 0;
    ...
    if (func_ov008_02051028() == 0 && func_ov008_02050ff8() == 0 && pList->bAnimating == 0
        && func_ov008_0206fa84() != 0) {
