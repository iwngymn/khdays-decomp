/* func_ov008_02063790 -- Ov008_BuildActionPage: build the page of the grid
...
extern const Ov008TextTriple data_ov008_0208f124;
...
extern void  func_ov008_0205da10(void *pMenu, int nId, int bEnable);     /* Ov008_ResolveEntryAndConfigure */
...
extern void *func_ov008_02054788(void *pMenu, int nId);                  /* FindEntryById */
extern void  func_ov008_02054b18(void *pMenu, void *pEntry, int nValue); /* Ov008_PushSubitemSet */
extern void  func_ov008_02054cc4(void *pMenu, void *pEntry);             /* Ov008_SwapParamOverrides */
extern void  func_ov008_0205cbb0(void *pEntry);                          /* Ov008_SetTag3RowPos */
extern void  func_ov008_02063394(Ov008MenuContext *pCtx, void *pMenu, int hLayer, int bAll); /* Ov008_SetupPresetPanel */
extern void  func_ov008_0205cde8(Ov008MenuContext *pCtx, int nPreset);   /* Ov008_DrawSavePage */
extern void  func_ov008_0206369c(Ov008MenuContext *pCtx, void *pMenu, int hLayer, int nMode, int nPreset); /* Ov008_SetupMenuGrid */
extern void  func_ov008_020635c8(Ov008MenuContext *pCtx, void *pMenu, int hLayer, int nMode, int nPreset); /* Ov008_SetupMenuDisplay */
extern void  func_ov008_02050b3c(int nSlot);                             /* Ov008_MarkSlotUsed */

void func_ov008_02063790(Ov008MenuContext *pCtx, int nAction)
{
    ...
    texts = data_ov008_0208f124;
    pCtx->nPendingAction = nAction;
    pMenu = func_ov008_02050c54();
    hLayer = func_ov008_02050c7c(PAGE_SLOT);
    func_ov008_02050bb0(PAGE_SLOT, 0xe, 4, 0x10, 0x13);
    for (i = 0x50; i <= 0x5f; i++) {
        func_ov008_0205da10(pMenu, i, 0);
    }
    switch (nAction) {
    case 0:
        pCtx->nActionArg = 0;
        ...
        for (i = 0, nY = 4; i < ROW_COUNT; nY += 3, pSurface++, i++) {
            ...
            if (pCtx->bSecondaryPanel != 0) {
                switch (i) {
                case 3:
                    pRecord = func_ov008_02055c84(pCtx->varRecords, TEXT_PRESETS);
                    if (bPreset != 0) {
                        nColour = COLOUR_ON;
                    } else {
                        nColour = COLOUR_OFF;
                    ...
                    break;
                case 4:
                    pRecord = func_ov008_02055c84(pCtx->varRecords, TEXT_GRID);
                    if (bFilled) {
                        nColour = COLOUR_ON;
                    } else {
                        nColour = COLOUR_OFF;
                ...
                pRecord = func_ov008_02055c84(pCtx->varRecords, texts.aText[i - 2]);
                func_02030158(pSurface);
        ...
        func_ov008_0205eafc(pCtx, 0, func_ov008_02055c84(pCtx->varRecords, TEXT_TITLE), COLOUR_ON);
        for (i = 0x50; i <= 0x54; i++) {
            func_ov008_0205da10(pMenu, i, 1);
        }
        if (pCtx->bSecondaryPanel != 0) {
            if (bPreset == 0) {
                func_ov008_02054b18(pMenu, func_ov008_02054788(pMenu, 0x53), 1);
            }
            if (!bFilled) {
                func_ov008_02054b18(pMenu, func_ov008_02054788(pMenu, 0x54), 1);
            }
        } else {
            for (i = 0x52; i <= 0x54; i++) {
                func_ov008_02054b18(pMenu, func_ov008_02054788(pMenu, i), 1);
            }
        }
        func_ov008_02054cc4(pMenu, func_ov008_02054788(pMenu, 0x51));
        func_ov008_0205cbb0(func_ov008_02054788(pMenu, 0x51));
        break;
    case 1:
        pCtx->nPreset = 0;
        func_ov008_02063394(pCtx, pMenu, hLayer, 1);
        func_ov008_0205cde8(pCtx, 0);
        break;
    case 4:
        pCtx->nPreset = 0;
        for (i = 0; i < PRESET_COUNT; i++) {
        ...
        func_ov008_02063394(pCtx, pMenu, hLayer, 0);
        func_ov008_0205cde8(pCtx, pCtx->nPreset);
        break;
    case 2:
        func_ov008_0206369c(pCtx, pMenu, hLayer, 2, pCtx->nPreset);
        break;
    case 5:
        func_ov008_0206369c(pCtx, pMenu, hLayer, 4, pCtx->nPreset);
        break;
    case 7:
        func_ov008_0206369c(pCtx, pMenu, hLayer, 0, 0);
        break;
    case 3:
        func_ov008_020635c8(pCtx, pMenu, hLayer, 3, pCtx->nPreset);
        break;
    case 6:
        func_ov008_020635c8(pCtx, pMenu, hLayer, 5, pCtx->nPreset);
        break;
    case 8:
        func_ov008_020635c8(pCtx, pMenu, hLayer, 1, pCtx->nPreset);
        break;
    }
    func_ov008_02050b3c(PAGE_SLOT);
}
