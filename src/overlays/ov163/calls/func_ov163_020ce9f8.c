...
extern void func_ov163_020ceaf4(void);
extern void func_ov163_020cecb4(void);

struct flagword { unsigned f8 : 8; };

void func_ov163_020ce9f8(int param_1) {
    ...
    func_0203c634(param_1, 1, func_ov163_020ced90);
    func_0203c634(param_1, 0, func_ov163_020ceaf4);
    func_0203c634(param_1, 2, func_ov163_020cecb4);
}
