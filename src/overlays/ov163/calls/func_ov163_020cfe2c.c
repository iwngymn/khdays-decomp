...
extern void func_ov163_020cfed8(void);

typedef struct { int b0 : 1; } Ov163Bit0;
typedef struct { int x, y, z; } VecFx32;

void func_ov163_020cfe2c(int *node) {
    int *state = (int *)node[1];

    if (((Ov163Bit0 *)(state[0] + 0x3cc))->b0) {
    ...
    *(VecFx32 *)(state + 0xf) = *(VecFx32 *)(state + 9);
    ...
    state[0xc] = 0;
    func_0203c634(node, *(signed char *)((int)node + 0x20), func_ov163_020cfed8);
}
