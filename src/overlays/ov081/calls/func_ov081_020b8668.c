...
extern struct Ov047Descriptor data_ov081_020b9670;
extern struct Ov047Descriptor data_ov081_020b9680;

u8 func_ov081_020b8668(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov081_020b9670.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov081_020b9680.bytes, self->slot09, 1,
