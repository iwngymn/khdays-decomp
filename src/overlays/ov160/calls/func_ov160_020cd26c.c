 ...
 * and dispatch null. Otherwise fetch the aim vector (func_ov160_020cca1c), store the angle
...
extern void func_ov160_020cca1c(int *obj, int *out);
extern int func_020050b4(int dx, int dz);
extern void func_ov160_020cd33c(void);
void func_ov160_020cd26c(int self) {
    int *obj = *(int **)(self + 4);
    int buf[3];
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov160_020cd33c);
}
