...
extern void func_ov143_020d4234(void);
extern void func_ov143_020d43c4(void);

void func_ov143_020d4160(int *node) {
    ...
    func_0203c634(node, 0, func_ov143_020d4234);
    func_0203c634(node, 2, func_ov143_020d43c4);
}
