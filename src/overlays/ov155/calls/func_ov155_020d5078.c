...
extern void func_ov155_020d5144(void);
...
void func_ov155_020d5078(int *node) {
    ...
    ((struct ov155_Hw60 *)(*state + 0x60))->hi &= ~0xc;
    ...
    state[7] = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov155_020d5144);
}
