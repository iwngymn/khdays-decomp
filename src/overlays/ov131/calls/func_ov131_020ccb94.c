...
extern void func_ov131_020ccc90(void);
extern void func_ov131_020cce50(void);

struct flagword { unsigned f8 : 8; };

void func_ov131_020ccb94(int param_1) {
    ...
    func_0203c634(param_1, 1, func_ov131_020ccf2c);
    func_0203c634(param_1, 0, func_ov131_020ccc90);
    func_0203c634(param_1, 2, func_ov131_020cce50);
}
