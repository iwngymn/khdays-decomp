...
extern void func_ov190_020d4358(int *state, int a, int b, int p, int q);
extern int func_ov107_020cab14(int obj, int a);
extern void func_0203c634(void *node, int idx, void *cb);
extern VecFx32 data_02041dc8;

void func_ov190_020d50e0(int *node) {
    ...
    if (state[6] >= 0x555) {
        func_ov190_020d4358(state, 0, 0, *(int *)(state[0] + 0x3ac) + 0x14, 0x800);
    }
