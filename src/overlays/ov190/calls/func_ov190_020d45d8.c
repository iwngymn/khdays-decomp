...
extern void func_ov190_020d4690(void);
extern void func_ov190_020d4860(void);

void func_ov190_020d45d8(int self) {
    int *obj = *(int **)(self + 4);
    unsigned short w;
    ...
    func_0203c634(self, 1, &func_ov190_020d48fc);
    func_0203c634(self, 0, &func_ov190_020d4690);
    func_0203c634(self, 2, &func_ov190_020d4860);
}
