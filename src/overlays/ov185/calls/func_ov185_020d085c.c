 ...
 * the other way round.
 * func_ov185_020d0028 takes THREE arguments; Ghidra shows a fourth (leftover in r3). */
...
void func_ov185_020d085c(int self) {
    ...
    func_ov185_020d0028((int)obj, obj + 6, dist);
