 ...
 * fetch its transform into obj[6..9] (func_ov185_020ce6fc) and copy it to obj[2..5]. Finally
...
extern void func_ov185_020ceec0(void);
void func_ov185_020cedf0(int self) {
    ...
    if (obj[1] != 0) {
        func_ov185_020ce6fc(obj, obj + 6);
        *(struct vec4 *)(obj + 2) = *(struct vec4 *)(obj + 6);
    }
    func_ov107_020c9264(*obj, 0, 0);
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov185_020ceec0);
}
