...
extern void func_ov185_020ced10(void);
extern void func_ov185_020ce824(void);
extern void func_ov185_020cea34(void);
void func_ov185_020ce738(int self) {
    int *obj = *(int **)(self + 4);
    ...
    *(struct vec4 *)(obj + 6) = *(struct vec4 *)(obj + 2);
    func_0203c634(self, 1, &func_ov185_020ced10);
    func_0203c634(self, 0, &func_ov185_020ce824);
    func_0203c634(self, 2, &func_ov185_020cea34);
}
