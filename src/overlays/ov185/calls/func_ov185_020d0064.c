...
extern void func_ov185_020d0150(void);
extern void func_ov185_020d0360(void);
void func_ov185_020d0064(int self) {
    int *obj = *(int **)(self + 4);
    ...
    *(struct vec4 *)(obj + 6) = *(struct vec4 *)(obj + 2);
    func_0203c634(self, 1, &func_ov185_020d0464);
    func_0203c634(self, 0, &func_ov185_020d0150);
    func_0203c634(self, 2, &func_ov185_020d0360);
}
