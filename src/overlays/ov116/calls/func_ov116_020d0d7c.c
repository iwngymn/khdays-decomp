...
extern void func_ov116_020d0e68(void);
extern void func_ov116_020d1068(void);
extern void func_ov116_020d1108(void);
void func_ov116_020d0d7c(int *node) {
    ...
    *(struct blk16 *)(state + 0x1d) = *(struct blk16 *)(state + 0x19);
    func_0203c634(node, 0, func_ov116_020d0e68);
    func_0203c634(node, 1, func_ov116_020d1108);
    func_0203c634(node, 2, func_ov116_020d1068);
}
