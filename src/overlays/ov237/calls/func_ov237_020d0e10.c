...
extern void func_ov237_020d0ea0(void);
extern void func_ov237_020d0f58(void);
void func_ov237_020d0e10(int param_1) {
    ...
    if (v != -1) {
        ...
        case 0:
            ...
            break;
        case 1:
            func_0203c634(param_1, 1, (void *)&func_ov237_020d0f58);
            break;
        }
    }
