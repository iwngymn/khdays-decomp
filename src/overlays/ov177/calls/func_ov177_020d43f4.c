...
extern void func_ov177_020d44e0(void);
extern void func_ov177_020d46cc(void);
extern void func_ov177_020d476c(void);
void func_ov177_020d43f4(int *node) {
    ...
    *(struct blk16 *)(state + 0x1d) = *(struct blk16 *)(state + 0x19);
    func_0203c634(node, 0, func_ov177_020d44e0);
    func_0203c634(node, 1, func_ov177_020d476c);
    func_0203c634(node, 2, func_ov177_020d46cc);
}
