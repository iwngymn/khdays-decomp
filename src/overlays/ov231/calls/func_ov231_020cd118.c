/* func_ov231_020cd118 -- enter the state: reset the move slots, cache three sub-object pointers,
...
extern void func_ov231_020cd2b4(void);
extern void func_ov231_020cd510(void);

void func_ov231_020cd118(int self) {
    int *ctx;
    int lo;
    int spread;
    unsigned short v;
    ...
    *(unsigned char *)(ctx[0] + 0x1c6) = 0;
    ...
    func_0203c634(self, 0, func_ov231_020cd2b4);
    func_0203c634(self, 2, func_ov231_020cd510);
}
