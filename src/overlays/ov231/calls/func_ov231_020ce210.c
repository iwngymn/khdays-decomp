/* func_ov231_020ce210 -- the two-shot tick: track the aim point, then fire each of the two
 ...
 * aimed straight down the owner's own axis, not at the raw target. func_ov231_020cca74 turns it
 ...
 *
 * The direction handed to func_ov231_020cf0dc is {sin, ctx[0x10], cos} -- the Q12 heading at
...
extern void func_ov231_020cf0dc(int muzzle, int a, const VecFx32 *dir, signed char spin, int pt);
...
void func_ov231_020ce210(int self) {
    int *ctx;
    ...
    func_ov231_020cca74(&out, self, &ref);
    ...
    if ((ctx[0xa] >= 0x1298 && *(unsigned char *)((char *)ctx + 0x4b) == 2)
        ...
        *(unsigned char *)((char *)ctx + 0x4b) -= 1;
        ...
        if ((((Hw60 *)(*(int *)(ctx[0] + *(unsigned char *)((char *)ctx + 0x4b) * 4 + 0x38c) + 0x60))->lo
            ...
            func_ov231_020cf0dc(*(int *)(ctx[0] + *(unsigned char *)((char *)ctx + 0x4b) * 4 + 0x38c),
                                ctx[3], &dir,
