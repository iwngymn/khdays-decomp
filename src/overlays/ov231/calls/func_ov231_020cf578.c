/* func_ov231_020cf578 -- acquire a target and arm the state, or give up if there is none.
 *
 ...
 * updated and effect 5 fires before handing off to func_ov231_020cf66c.
 *
...
extern void func_ov231_020cf66c(void);

void func_ov231_020cf578(int self) {
    int *ctx;
    VecFx32 d;
    int target;
    unsigned short v;
    ...
    *(unsigned char *)((char *)ctx + 0x26) = 0;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov231_020cf66c);
}
