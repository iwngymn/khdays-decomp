...
extern const struct Msg data_ov132_020d0da2;
extern void func_ov132_020cfc58(void);

void func_ov132_020cf7c4(struct Node *node)
{
    struct State *st;
    FxVec vFwd;
    FxVec vToTarget;
    ...
    func_0203c634(node, node->bSlot, (void *)func_ov132_020cfc58);
}
