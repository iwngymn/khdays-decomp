...
extern void func_ov132_020ceab0(void);
extern void func_ov132_020cec70(void);

struct flagword { unsigned f8 : 8; };

void func_ov132_020ce9b4(int param_1) {
    ...
    func_0203c634(param_1, 1, func_ov132_020ced4c);
    func_0203c634(param_1, 0, func_ov132_020ceab0);
    func_0203c634(param_1, 2, func_ov132_020cec70);
}
