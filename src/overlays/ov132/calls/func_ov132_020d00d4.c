...
extern const struct Msg data_ov132_020d0d94;
...
void func_ov132_020d00d4(struct Node *node)
{
    struct State *st;
    void *world;
    void *aVictims[4];
    ...
    ov132_scanVictims(st, &shape, aVictims, &vDir, &vPush, &vImpact, &msgA);
    ...
    nHits = func_ov132_020ce3cc(*(void **)((char *)world + 0x7c), &shape, aChildren);
    i = 0;
    if (nHits > 0) {
        do {
            ...
            if (func_ov002_02076dac(*(void **)(*(char **)((char *)aChildren[i] + 0x28) + 0x158),
                ...
                ov132_emitChildEvent(&msgB, &vImpact2);
                pfnHook = *(void (**)(char *, struct Msg *, int))(st->pActor + 0x24);
                if (pfnHook != 0) {
