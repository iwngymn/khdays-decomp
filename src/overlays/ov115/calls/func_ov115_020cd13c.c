...
extern void func_ov115_020cd228(void);
extern void func_ov115_020cd428(void);
extern void func_ov115_020cd4c8(void);
void func_ov115_020cd13c(int *node) {
    ...
    *(struct blk16 *)(state + 0x1d) = *(struct blk16 *)(state + 0x19);
    func_0203c634(node, 0, func_ov115_020cd228);
    func_0203c634(node, 1, func_ov115_020cd4c8);
    func_0203c634(node, 2, func_ov115_020cd428);
}
