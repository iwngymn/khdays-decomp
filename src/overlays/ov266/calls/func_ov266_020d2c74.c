...
extern void func_ov266_020d2d1c(void);
extern void func_ov266_020d2f60(void);
extern void func_ov266_020d2db0(void);

struct hi_flags_020cec74 { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov266_020d2c74(int param_1) {
    ...
    *(int *)(child + 4) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov266_020d2d1c);
    func_0203c634(param_1, 1, (void *)&func_ov266_020d2f60);
    func_0203c634(param_1, 2, (void *)&func_ov266_020d2db0);
}
