...
extern void func_ov266_020d2f60(void);
extern void func_ov266_020d2ff8(void);
extern void func_ov266_020d3590(void);
void func_ov266_020d2d1c(int param_1) {
    ...
    if (v != -1) {
        ...
        case 0:
            func_0203c634(param_1, 1, (void *)&func_ov266_020d2f60);
            break;
        case 1:
            func_0203c634(param_1, 1, (void *)&func_ov266_020d2ff8);
            break;
        case 2:
            func_0203c634(param_1, 1, (void *)&func_ov266_020d3590);
            break;
        }
    }
