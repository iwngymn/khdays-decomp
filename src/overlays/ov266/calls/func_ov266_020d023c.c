...
extern void func_ov266_020d0308(void);
extern void func_ov266_020d05fc(void);
...
void func_ov266_020d023c(void *self) {
    ...
    func_0203c634(self, 0, func_ov266_020d0308);
    func_0203c634(self, 2, func_ov266_020d05fc);
}
