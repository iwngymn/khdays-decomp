...
extern void func_ov124_020d0774(void);

struct ov124_LowByteFlags { unsigned bits : 8; };

void func_ov124_020d06d4(int *node) {
    ...
    ((struct ov124_LowByteFlags *)(*(int *)(*state + 0x388) + 8))->bits &= ~1;
    func_ov107_020c5af8(*state, 0, 0x48, state[5]);
    state[10] = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov124_020d0774);
}
