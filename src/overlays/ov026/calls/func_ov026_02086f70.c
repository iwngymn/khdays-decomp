/* func_ov026_02086f70 -- Ov008_HideCounterPanel: take the counter panel
...
extern void *func_ov026_02083530(void *pOwner, int nTag);                 /* ov008_FindEntryByTag */
extern void  func_ov026_020835c4(void *pOwner, void *pEntry);             /* Ov008_TagTracker_InvokeCallback */
...
void func_ov026_02086f70(void)
{
    ...
    if (ctx->nTab != TAB_SPECIAL) {
        ...
        func_ov026_020843e8(pWidgets, func_ov026_0208427c(pWidgets, 9), 0);
