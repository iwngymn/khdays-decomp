/* func_ov026_0208d22c -- Ov008_CreateParamTable: allocate and zero the 0x158-byte
 * param table (data_ov026_0209136c) and load its five record lists from the
...
extern int   func_ov026_0208d170(u32 *pCount, Ov008ParamRecord **ppRecords, Ov008FillRecordFn pfnFill, int nDbId); /* Ov008_LoadParamRecords */
extern void  func_ov026_0208cf08(Ov008ParamRecord *pRecord, void *pRaw, int nIndex);   /* shop record */
extern void  func_ov026_0208cf28(Ov008ParamRecord *pRecord, void *pRaw, int nIndex);   /* item list record */
extern void  func_ov026_0208cfc4(Ov008ParamRecord *pRecord, void *pRaw, int nIndex);   /* recipe record */
extern void  func_ov026_0208d064(Ov008ParamRecord *pRecord, void *pRaw, int nIndex);   /* reward record */
extern u32   func_020235d0(int nField, int nBits);                       /* GameState_GetField */
extern void  func_ov026_0208cd44(void);                                  /* post-load pass */

void func_ov026_0208d22c(void)
{
    data_ov026_0209136c = NNSi_FndAllocFromDefaultExpHeap(sizeof(Ov008ParamTable));
    MI_CpuFill8(data_ov026_0209136c, 0, sizeof(Ov008ParamTable));
    func_ov026_0208d170(&data_ov026_0209136c->aCount[0], &data_ov026_0209136c->apRecords[0], func_ov026_0208cf08, DB_SHOP);
    func_ov026_0208d170(&data_ov026_0209136c->aCount[1], &data_ov026_0209136c->apRecords[1], func_ov026_0208cf28, DB_ITEM_LIST);
    func_ov026_0208d170(&data_ov026_0209136c->aCount[2], &data_ov026_0209136c->apRecords[2], func_ov026_0208cfc4, DB_RECIPES);
    func_ov026_0208d170(&data_ov026_0209136c->aCount[3], &data_ov026_0209136c->apRecords[3], func_ov026_0208d064, DB_REWARDS_A);
    func_ov026_0208d170(&data_ov026_0209136c->aCount[4], &data_ov026_0209136c->apRecords[4], func_ov026_0208d064, DB_REWARDS_B);
    ...
    data_ov026_0209136c->bShowAll = func_020235d0(FIELD_RANK, 3) == RANK_SHOW_ALL;
    func_ov026_0208cd44();
}
