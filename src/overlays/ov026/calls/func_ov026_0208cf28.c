/* func_ov026_0208cf28 -- Ov008_BuildSlotPacketA: fill the kind-0 slot packet from
...
void func_ov026_0208cf28(Ov008SlotPacket *pOut, Ov008SlotEntry *pIn)
{
    void *pItemDef = data_ov026_0209136c->pRecords[pIn->nIndex - 1].pItemDef;
