/* func_ov026_02085fc8 -- Ov008_InitColumnCells: create the 48 cells of the
...
void func_ov026_02085fc8(void)
{
    ...
    for (i = 0; i < ROW_CELLS; i++) {
        nY = (0x4d - (8 - i) * 8) << 12;
        pPanel->aCell[0][i] = func_ov026_02085d7c(hSlots, 0, 0, nY, LEFT_X);
        pPanel->aCell[1][i] = func_ov026_02085d7c(hSlots, 3, 0, nY, LEFT_X);
        pPanel->aCell[2][i] = func_ov026_02085d7c(hSlots, 2, 0, nY, LEFT_X);
        pPanel->aCell[3][i] = func_ov026_02085d7c(hSlots, 1, 0, nY, RIGHT_X);
        pPanel->aCell[4][i] = func_ov026_02085d7c(hSlots, 3, 0, nY, RIGHT_X);
        pPanel->aCell[5][i] = func_ov026_02085d7c(hSlots, 2, 0, nY, RIGHT_X);
    }
