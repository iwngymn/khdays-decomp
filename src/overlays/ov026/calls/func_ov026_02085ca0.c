/* func_ov026_02085ca0 -- Ov008_DrawNumber3Shadowed: draw nValue as a right-aligned
...
extern u16 data_ov026_02091314[];                                       /* L"%3d" */
...
void func_ov026_02085ca0(void *pSurface, int nValue, int nX, int nY, int nColour)
{
    u16 aDigit[4] = { 0, 0, 0, 0 };
    int i;

    func_020262a0(aDigit, 4, data_ov026_02091314, nValue);
