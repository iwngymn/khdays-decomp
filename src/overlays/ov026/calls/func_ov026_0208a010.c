/* func_ov026_0208a010 -- Ov008_DrawShopDetailPanel: redraw the shop's detail
...
void func_ov026_0208a010(void)
{
    ...
    func_ov026_02085bf4(pSurface, pPanel->pRecord->pItemDef->pName, 0x92 - ((pPanel->nTitleWidth + 0x10) >> 1), 0x3b, TEXT_STYLE, 8);
    func_ov026_02085bf4(pSurface, pPanel->apLabel[pPanel->nSelection], 0x80, 0x4e, TEXT_STYLE, 0x10);
    ...
    func_ov026_02085bf4(pSurface, pPanel->pTextLeft, 0x50, 0x6a, TEXT_STYLE, 0x10);
    func_ov026_02085bf4(pSurface, pPanel->pTextRight, 0xb0, 0x6a, TEXT_STYLE, 0x10);
    func_ov026_02086af4(pPanel->pRecord, pPanel->nQuantity);
    pos.nX = ((pPanel->nChoice == 0 ? 0 : 0x60) + 0x20) << 12;
    pos.nY = func_ov026_020842f8(pWidgets, func_ov026_0208427c(pWidgets, 1))->nY;
