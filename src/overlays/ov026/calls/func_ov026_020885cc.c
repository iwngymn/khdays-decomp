/* func_ov026_020885cc -- Ov008_ShopRefreshSelection: redraw the shop list
...
extern void *func_ov026_02083530(void *pTracker, u16 nTag);                 /* ov008_FindEntryByTag */
extern void  func_ov026_020835fc(void *pTracker, void *pCell, u8 nMode);    /* Ov008_StampTileMode */
extern void  func_ov026_020835c4(void *pTracker, void *pCell);              /* Ov008_TagTracker_InvokeCallback */

void func_ov026_020885cc(void)
{
    ...
    if (pView->apRows != 0) {
        ...
        if (pRecord->nKind != KIND_RECIPE
            ...
            func_ov026_02085e58(pText, nIcon);
            goto placed;
        }
    }
    func_0203011c(data_ov026_02091368->descSurface, 0, 0xa0, 0x100, 0x20);
    func_ov026_020843e8(data_ov026_02091368->widgets, func_ov026_0208427c(data_ov026_02091368->widgets, WIDGET_DESC), 0);
placed:
    pos = *func_ov026_020842f8(pWidgets, func_ov026_0208427c(pWidgets, WIDGET_CURSOR));
    pos.nY = ((pView->nRow - pView->nScroll) * 16 + 0x20) << 12;
    func_ov026_02084330(pWidgets, func_ov026_0208427c(pWidgets, WIDGET_CURSOR), &pos);
    func_ov026_0208744c(pView->nScroll, pView->nScrollArg);
    ...
    for (i = 0; i < ROW_COUNT; i++) {
        pCell = func_ov026_02083530(ctx->tracker, (u16)(nTagBase + i));
        func_ov026_020835fc(ctx->tracker, pCell, (u8)(i == nOffset ? nModeSel : nMode));
        func_ov026_020835c4(ctx->tracker, pCell);
    }
}
