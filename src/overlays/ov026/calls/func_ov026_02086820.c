/* func_ov026_02086820 -- Ov008_ShowThreeDigitCells: show a number (clamped to
...
void func_ov026_02086820(int hSlots, u32 nValue, int *aCell)
{
    ...
    func_ov026_020843e8(pGroup, func_ov026_0208427c(pGroup, WIDGET_DIGITS_A), 1);
    func_ov026_020843e8(pGroup, func_ov026_0208427c(pGroup, WIDGET_DIGITS_B), 1);
