/* func_ov026_0208d360 -- Ov008_SortParamRecordsByItemOrder: in-place quicksort of
...
void func_ov026_0208d360(Ov008ParamRecord **apRecord, int nCount)
{
    ...
    func_ov026_0208d360(apRecord, nLow);
    func_ov026_0208d360(apRecord + nLow, nCount - nLow);
}
