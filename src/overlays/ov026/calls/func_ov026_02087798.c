/* func_ov026_02087798 -- Ov008_DrawShopRowMarks: show the marker cells of
...
extern u32  func_ov026_0208e218(Ov008ParamRecord **apRecords, u32 nIndex, int nArg); /* Ov008_QueryRecordUnlock */
...
void func_ov026_02087798(int nRow, Ov008ParamRecord *pRecord)
{
    ...
    nUnlock = func_ov026_0208e218(pView->apRows, nIndex, 0);
    if (ctx->nTab != TAB_RECIPES) {
        ...
        nItemId = func_ov026_0208df6c(pRecord);
        func_02032710(ctx->hSlots, pView->aCellG[nRow], data_0204be18->aItemCount[nItemId] != func_ov026_0208df80(pRecord));
        return;
    }
