/* func_ov026_0208532c -- Ov008_LoadShopResources: load the shop panel's
...
extern void  func_ov026_02083194(void *pTracker, const Ov008SurfaceConfig *pConfig);
...
extern void  func_ov026_0208325c(void *pTracker, const char *pPath); /* Ov008_LoadLayoutResource */
extern void  func_ov026_02083704(void *pTracker, int bEnable);
...
void func_ov026_0208532c(void)
{
    ...
    ctx->pContainerA = func_02024ee8(data_ov026_02091250, HEAP_FILE);
    ctx->pContainerB = func_02024ee8(data_ov026_02091260, HEAP_FILE);
    func_ov026_02083194(ctx->trackerB, &config);
    func_ov026_02083194(ctx->tracker, &config);
    ...
    nSlot = data_ov026_0209114a[ctx->nPage * 4];
    if (nSlot >= 0) {
    ...
    func_ov026_0208325c(ctx->trackerB, data_ov026_02091274);
    func_ov026_0208325c(ctx->tracker, data_ov026_02091274);
    func_ov026_02083704(ctx->tracker, 1);
    ...
    func_ov026_020835c4(ctx->trackerB, func_ov026_02083530(ctx->trackerB, 1000));
    func_ov026_020835c4(ctx->trackerB, func_ov026_02083530(ctx->trackerB, 0x3e9));
    func_ov026_020835c4(ctx->trackerB, func_ov026_02083530(ctx->trackerB, 0x3f2));
    func_ov026_020835c4(ctx->tracker, func_ov026_02083530(ctx->tracker, 0));
    func_ov026_020835c4(ctx->tracker, func_ov026_02083530(ctx->tracker, 1));
}
