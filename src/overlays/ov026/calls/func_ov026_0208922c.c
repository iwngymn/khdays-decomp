/* func_ov026_0208922c -- Ov008_DrawSellDialog: redraw the shop's quantity
...
extern void  func_ov026_02085c48(void *pSurface, u32 nValue, int nX, int nY, int nStyle); /* draw a number */
...
extern void  func_ov026_02084488(void *pWidgets, void *pEntry, int nFrame);             /* Ov008_ReleaseTwoSlotsEx */
extern UiLayoutPos *func_ov026_020842f8(void *pWidgets, void *pEntry);                  /* Ov008_GetEntryPos */
extern void  func_ov026_02084330(void *pWidgets, void *pEntry, UiLayoutPos *pPos);      /* Ov008_SetEntryPos */

void func_ov026_0208922c(void)
{
    ...
    if (ctx->nTab == 0) {
        pLabel = data_ov026_02091368->apVarText[1];
        ctx->columns.nRightBase = -nTotal;
    } else {
        pLabel = data_ov026_02091368->apVarText[0];
        ctx->columns.nLeftBase = nTotal;
    }
    func_ov026_02085bf4(pSurface, pDialog->pRecord->pItemDef->pName, 0x44, 0x48, TEXT_STYLE, 8);
    func_ov026_02085c48(pSurface, nPrice, 0xb0, 0x48, TEXT_STYLE);
    pSurface->pFont = ctx->fontB;
    func_ov026_02085bf4(pSurface, pLabel, 0xb2, 0x4a, LABEL_STYLE, 8);
    func_ov026_02085bf4(pSurface, pLabel, 0xb2, 0x5e, LABEL_STYLE, 8);
    pSurface->pFont = ctx->fontA;
    func_ov026_02085bf4(pSurface, data_ov026_02091368->apVarText[2], 0x34, 0x5c, TEXT_STYLE, 8);
    func_ov026_02085bf4(pSurface, data_ov026_02091368->apVarText[4], 0x61, 0x5c, TEXT_STYLE, 8);
    func_ov026_02085c48(pSurface, pDialog->nCount, 0x78, 0x5c, TEXT_STYLE);
    func_ov026_02085c48(pSurface, nTotal, 0xb0, 0x5c, TEXT_STYLE);
    ...
    case 0:
        if (pDialog->nPending != 0) {
            ...
            func_ov026_020843e8(pWidgets, func_ov026_0208427c(pWidgets, WIDGET_CONFIRM), 1);
            func_ov026_02084488(pWidgets, func_ov026_0208427c(pWidgets, WIDGET_CONFIRM), 0);
        }
        break;
    case 1:
        if (pDialog->nPending != 0) {
            func_ov026_020843e8(pWidgets, func_ov026_0208427c(pWidgets, WIDGET_CONFIRM), 0);
            func_ov026_020843e8(pWidgets, func_ov026_0208427c(pWidgets, WIDGET_QTY), 1);
        }
        func_ov026_02085bf4(pSurface, pDialog->pTextLeft, 0x50, 0x77, TEXT_STYLE, 0x10);
        func_ov026_02085bf4(pSurface, pDialog->pTextRight, 0xb0, 0x77, TEXT_STYLE, 0x10);
    case 2:
        pos.nX = ((pDialog->nChoice == 0 ? 0 : 0x60) + 0x20) << 12;
        pos.nY = func_ov026_020842f8(pWidgets, func_ov026_0208427c(pWidgets, WIDGET_QTY))->nY;
