/* func_ov026_0208d170 -- Ov008_LoadParamRecords: load message db nDbId (slot 0xf),
...
int func_ov026_0208d170(u32 *pCount, Ov008ParamRecord **ppRecords, Ov008FillRecordFn pfnFill, int nDbId)
{
    u32 i;
    u32 nCount;
    void *pRaw;
