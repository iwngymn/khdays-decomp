/* func_ov026_02085884 -- Ov008_InitShopSurfaces: bind the shop panel's three
...
extern void  func_ov026_02085828(void *pSurface, int nX, int nY, int nWidth, int nHeight, int nRows, void *pVram, int nUnk1c, void *pPixels); /* Ov008_UploadTileSurface */
extern void  func_ov026_02084d3c(void *pLoader, const char *pPath);       /* Ov008_Set_5c4c */
extern void *func_ov026_02084d74(void *pRecords, int nIndex);             /* GetVarRecordByIndex */

void func_ov026_02085884(void)
{
    ...
    func_0202ff58(ctx->fontA, data_ov026_020912b0);
    func_0202ff58(ctx->fontB, data_ov026_020912c8);
    func_0202ff58(ctx->fontC, data_ov026_020912e0);
    func_ov026_02085828(ctx->textSurface, 0, 0, 0x20, 0x18, 0, ctx->pixelsB, 0x14, ctx->fontA);
    func_ov026_02085828(ctx->surfaceB, 10, 0, 0x16, 2, 0xc0, ctx->pixelsA, 5, ctx->fontA);
    func_ov026_02085828(ctx->surfaceC, 10, 0x12, 0x16, 6, 0x118, ctx->pixelsA, 5, ctx->fontA);
    func_ov026_02085828(ctx->surfaceD, 4, 2, 0x18, 0x10, 0x220, ctx->pixelsA, 5, ctx->fontA);
    ctx->nFlags |= 9;
    func_ov026_02084d3c(ctx->textLoader, data_ov026_020912f8);
    apText[0] = func_ov026_02084d74(ctx->textLoader, 0x1a);
    apText[1] = func_ov026_02084d74(ctx->textLoader, 0x1b);
    apText[2] = func_ov026_02084d74(ctx->textLoader, 0x1c);
    apText[3] = func_ov026_02084d74(ctx->textLoader, 0x1e);
    apText[4] = func_ov026_02084d74(ctx->textLoader, 0x1d);
}
