/* func_ov026_0208e218 -- Ov008_QueryRecordUnlock: unlock state of record
...
u32 func_ov026_0208e218(Ov008ParamRecord **apRecords, int nIndex, u32 bSet)
{
    ...
    if (pRecord->nKind != RECORD_KIND_REWARD) {
        ...
        if (bSet != 0) {
            func_02025640(data_ov026_0209136c->apPendingBits[nList], nBit);
        }
        bSet = func_02025694(data_ov026_0209136c->apPendingBits[nList], nBit) != 0;
        return bSet | (func_02025694(data_ov026_0209136c->apUnlockBits[nList], nBit) != 0) << 1;
    }
    ...
    nBit &= 0x1f;
    if (bSet != 0) {
        func_02025640(&data_ov026_0209136c->aPendingSummary[nList], nBit);
    }
    bSet = func_02025694(&data_ov026_0209136c->aPendingSummary[nList], nBit) != 0;
