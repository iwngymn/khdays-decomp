/* func_ov026_020889c0 -- Ov008_HideShopList: tear the shop list display
...
extern void  func_ov026_020835e0(void *pTracker, void *pCell);              /* ov008_InvokeCallback40 */
extern void  func_02032450(int hSlots, int nCell);                          /* Slot_UnlinkIfLinked */
extern void  func_ov026_02089c54(void);                                     /* Ov008_SetupMenuScreen */
extern void  func_ov026_0208a734(void);                                     /* Ov008_Set_7884 */
extern void  func_ov026_02087234(void);                                     /* Ov008_HideListCells */
extern void *func_ov026_0208c2c0(void);                                     /* detail confirm entry */

void func_ov026_020889c0(void)
{
    ...
    for (i = 0; i < ROW_COUNT; i++) {
        pCell = func_ov026_02083530(ctx->tracker, (u16)(i + (nTab == TAB_RECIPES ? ROW_TAG_BASE_RECIPE : ROW_TAG_BASE)));
        func_ov026_020835e0(ctx->tracker, pCell);
    ...
    func_ov026_020843e8(pWidgets, func_ov026_0208427c(pWidgets, WIDGET_DESC), 0);
    if (nTab == 2 && pView->pfnPending != func_ov026_0208c2c0) {
    ...
    func_ov026_020843e8(pWidgets, func_ov026_0208427c(pWidgets, 0x33), 0);
    func_ov026_020843e8(pWidgets, func_ov026_0208427c(pWidgets, 0x34), 0);
    func_ov026_020843e8(pWidgets, func_ov026_0208427c(pWidgets, 4), 0);
    func_ov026_020843e8(pWidgets, func_ov026_0208427c(pWidgets, 5), 0);
    func_ov026_02087234();
}
