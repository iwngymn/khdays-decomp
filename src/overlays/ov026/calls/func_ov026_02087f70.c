/* func_ov026_02087f70 -- Ov008_SetupShopPage: build the shop panel for the
...
extern void  func_ov026_02087ebc(int nWidgetA, int nWidgetB, int nTag, int nList, int nText, int nColumn); /* Ov008_ShowTierPage */
...
extern UiLayoutPos *func_ov026_02084374(void *pWidgets, void *pEntry); /* Ov008_GetEntryBlock2c */
extern void  func_ov026_02084330(void *pWidgets, void *pEntry, UiLayoutPos *pPos); /* Ov008_SetEntryPos */
extern void  func_ov026_0208e558(u16 *aCount);                         /* Ov008_CountAffordableRecords */
extern int   func_ov026_02087570(int bKeep, int bForce);               /* Ov008_RebuildShopList */
extern void  func_ov026_02087d6c(Ov008ParamRecord **apRows, u32 nCount, int nFirst); /* Ov008_ShowShopRows */
extern void  func_ov026_02089854(void);                                /* refresh the recipe rows */
extern void  func_ov026_0208737c(u32 nCount);                          /* Ov008_ResetListTo */
extern void  func_ov026_0208744c(u32 nScroll, int nArg);               /* Ov008_ScrollListToRow */
extern void  func_ov026_0208894c(void);                                /* Ov008_UpdateScrollArrows */

void func_ov026_02087f70(int bKeep)
{
    UiLayoutPos pos;
    UiLayoutPos anchor;
    int aX[2];
    ...
    switch (ctx->nTab) {
    case TAB_SHOP:
        func_ov026_02087ebc(0x6f, 0x79, 0x3ea, 100, 0x65, 3);
        break;
    case TAB_ITEMS:
        func_ov026_02087ebc(0xd3, 0xdd, 0x3eb, 200, 0xc9, 5);
        break;
    case TAB_RECIPES:
        func_ov026_02087ebc(0x137, 0x141, 0x3ec, 300, 0x12d, 7);
        break;
    case TAB_REWARDS:
        func_ov026_02087ebc(0x19a, 0x1a5, 0x3ed, 400, 0x191, 10);
        break;
    }
    aX[0] = 0x30 << 12;
    aX[1] = 0xb6 << 12;
    ...
    for (i = 0; i < ROW_COUNT; i++) {
        ...
        pView->aCellIconA[i] = func_ov026_02085d7c(hSlots, nKind, 1, nX, nY);
        if (nTab == TAB_REWARDS) {
            nKind = 4;
        } else {
            nKind = 2;
        }
        pView->aCellIconB[i] = func_ov026_02085d7c(hSlots, nKind, 1, nX, nY);
        func_0203281c(hSlots, pView->aCellIconA[i], 0);
        func_0203281c(hSlots, pView->aCellIconB[i], 0);
        pView->aCellText[i] = func_ov026_02085d7c(hSlots, 0, ctx->nRow, aX[0], nY);
        if (nTab == TAB_REWARDS) {
            pView->aCellRewardA[i] = func_ov026_02085d7c(hSlots, 7, 1, 0xc1 << 12, nY);
            func_0203281c(hSlots, pView->aCellRewardA[i], 0);
            pView->aCellRewardB[i] = func_ov026_02085d7c(hSlots, 0x17, 0, 0xb6 << 12, nY);
            func_0203281c(hSlots, pView->aCellRewardB[i], 0);
        } else if (nTab == TAB_SHOP) {
            pView->aCellShop[i] = func_ov026_02085d7c(hSlots, 8, 1, 0xb4 << 12, nY);
            func_0203281c(hSlots, pView->aCellShop[i], 0);
        }
        if (nTab != TAB_REWARDS) {
            pView->aCellPrice[i] = func_ov026_02085d7c(hSlots, 0xb, 1, aX[0] - (0xb << 12), nY + 0x4000);
            func_0203281c(hSlots, pView->aCellPrice[i], 0);
        }
        nY += ROW_Y_STEP;
    }
    pLeft = func_ov026_0208427c(pWidgets, WIDGET_LEFT);
    pRight = func_ov026_0208427c(pWidgets, WIDGET_RIGHT);
    func_ov026_020843e8(pWidgets, pLeft, 1);
    func_ov026_020843e8(pWidgets, pRight, 1);
    if (nTab != TAB_REWARDS) {
        func_ov026_02084330(pWidgets, pLeft, func_ov026_02084374(pWidgets, pLeft));
        func_ov026_02084330(pWidgets, pRight, func_ov026_02084374(pWidgets, pRight));
        pEntry = func_ov026_0208427c(pWidgets, WIDGET_TAB_ANCHOR);
        anchor = *func_ov026_02084374(pWidgets, pEntry);
        for (nId = WIDGET_TAB_FIRST; nId <= WIDGET_TAB_LAST; nId++) {
            if (nTab == TAB_RECIPES && (nId == 0x2c || nId == 0x2e)) {
                continue;
            }
            func_ov026_020843e8(pWidgets, func_ov026_0208427c(pWidgets, nId), 1);
            pos = *func_ov026_02084374(pWidgets, func_ov026_0208427c(pWidgets, nId));
            if (nTab == TAB_RECIPES && pos.nX > anchor.nX) {
                pos.nX -= 0x18 << 12;
            }
            func_ov026_02084330(pWidgets, func_ov026_0208427c(pWidgets, nId), &pos);
        }
    } else {
        pBlock = func_ov026_02084374(pWidgets, pLeft);
        pos = *pBlock;
        pos.nX -= 1 << 16;
        func_ov026_02084330(pWidgets, pLeft, &pos);
        pBlock = func_ov026_02084374(pWidgets, pRight);
        pos = *pBlock;
        pos.nX += 1 << 16;
        func_ov026_02084330(pWidgets, pRight, &pos);
    }
    pView->nScrollArg = 0;
    pView->nScrollPending = 0;
    pView->bListReady = 1;
    if (nTab == TAB_REWARDS) {
        func_ov026_0208e558(pBuy->aFunds);
        pBuy->aFunds[0] += 3;
        pBuy->aFunds[1] += 3;
    }
    if (bKeep != 0) {
    ...
    if (func_ov026_02087570(bKeep, 0) == 0) {
        do {
        ...
        } while (func_ov026_02087570(bKeep, 0) == 0);
        if (pShop->nCategory == 0) {
            func_ov026_02087570(bKeep, 1);
        }
    }
    if (bKeep != 0) {
        func_ov026_02087d6c(pView->apRows, pView->nCount, pView->nScroll);
        if (ctx->nTab == TAB_RECIPES && pView->apRows != 0) {
            func_ov026_02089854();
        }
        func_ov026_0208737c(pView->nCount);
    } else {
        func_ov026_02087d6c(pView->apRows, pView->nCount, pView->nScroll);
        func_ov026_0208737c(pView->nCount);
        func_ov026_0208744c(pView->nScroll, 0);
    }
    pEntry = func_ov026_0208427c(pWidgets, WIDGET_CURSOR);
    ...
    func_ov026_02084330(pWidgets, pEntry, &pos);
    func_ov026_020843e8(pWidgets, pEntry, 1);
    func_ov026_0208894c();
}
