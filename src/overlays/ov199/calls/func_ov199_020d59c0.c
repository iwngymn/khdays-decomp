...
extern void func_ov199_020d5a68(void);
extern void func_ov199_020d5b44(void);
extern void func_ov199_020d5ae0(void);

struct hi_flags_020cec74 { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov199_020d59c0(int param_1) {
    ...
    *(int *)(child + 4) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov199_020d5a68);
    func_0203c634(param_1, 1, (void *)&func_ov199_020d5b44);
    func_0203c634(param_1, 2, (void *)&func_ov199_020d5ae0);
}
