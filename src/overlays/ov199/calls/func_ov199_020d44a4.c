...
extern void func_ov199_020d455c(void);
extern void func_ov199_020d46e4(void);

void func_ov199_020d44a4(int self) {
    int *obj = *(int **)(self + 4);
    unsigned short w;
    ...
    func_0203c634(self, 1, &func_ov199_020d47c8);
    func_0203c634(self, 0, &func_ov199_020d455c);
    func_0203c634(self, 2, &func_ov199_020d46e4);
}
