/* func_ov201_020d2e68 -- ov201's move CHOOSER, the steering variant.
 *
 * Byte-identical to func_ov200_020cf228 modulo this overlay's own symbols; that is the rep and
 * carries the analysis. See func_ov208_020d1be0 for the plain chooser shape.
 *
 ...
 *                                   func_ov201_020d3148 as the handler instead of queueing
 *   otherwise                    -> burn one d100 roll, then pick a new ctx[0x20] in
 *                                   [+0x224, +0x224 + |+0x228 - +0x224|], then check three slots
 *                                   via func_ov201_020d419c: all three clear -> move 6; else if the
...
extern int func_ov201_020d419c(int slot);
extern void func_ov201_020d3148(void);
extern char data_02042264[];
extern char data_02042258[];

void func_ov201_020d2e68(int self) {
    int target;
    int *owner;
    int *ctx;
    int tgt;
    ...
    if (owner[0x4f] != 0x7fffffff) {
        ...
        if (ctx[0x20] <= 0) {
            ...
            if (func_ov201_020d419c(((struct AiState *)(ctx[0]))->field_390)
                && func_ov201_020d419c(((struct AiState *)(ctx[0]))->field_394)
                && func_ov201_020d419c(*(int *)(ctx[0] + 0x398))) {
                ((struct AiState *)(ctx[0]))->pendingAction = 6;
                func_0203c634(self, *(signed char *)(self + 0x20), 0);
                return;
            }
            if (!func_ov201_020d419c(((struct AiState *)(ctx[0]))->field_394)) {
                return;
            }
            if (!func_ov201_020d419c(*(int *)(ctx[0] + 0x398))) {
                return;
            }
        ...
        func_0203c634(self, *(signed char *)(self + 0x20), func_ov201_020d3148);
        return;
    }
