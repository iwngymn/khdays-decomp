...
extern void func_ov135_020d052c(void);
extern void func_ov135_020d06d4(void);

void func_ov135_020d0468(int *node) {
    ...
    func_0203c634(node, 0, func_ov135_020d052c);
    func_0203c634(node, 2, func_ov135_020d06d4);
}
