...
struct ov135_LowByteFlags {
    unsigned bits : 8;
};

void func_ov135_020d1060(int *node) {
    int *state = (int *)node[1];
    ((struct ov135_Hw60 *)(*state + 0x60))->hi &= ~1;
    ...
    ((struct ov135_LowByteFlags *)(*(int *)(*state + 0x38c) + 8))->bits &= ~1;
    func_ov107_020c5af8(*state, 0, 0x4a, state[15]);
