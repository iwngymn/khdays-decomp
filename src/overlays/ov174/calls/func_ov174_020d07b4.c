...
extern void func_ov174_020d08a0(void);
extern void func_ov174_020d0adc(void);
extern void func_ov174_020d0b7c(void);
void func_ov174_020d07b4(int *node) {
    ...
    *(struct blk16 *)(state + 0x1d) = *(struct blk16 *)(state + 0x19);
    func_0203c634(node, 0, func_ov174_020d08a0);
    func_0203c634(node, 1, func_ov174_020d0b7c);
    func_0203c634(node, 2, func_ov174_020d0adc);
}
