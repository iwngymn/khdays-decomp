/* c634 init: reset owner status bytes (+0x1c6=0, +0x1c7=-1, +0x424=-1), clear bit0 of the
...
extern void func_ov227_020d1664(void);
extern void func_ov227_020d1968(void);
void func_ov227_020d157c(int self) {
    int *obj = *(int **)(self + 4);
    int i = 0;
    ...
    *(char *)(*obj + 0x424) = -1;
    ...
    func_0203c634(self, 0, &func_ov227_020d1664);
    func_0203c634(self, 2, &func_ov227_020d1968);
}
