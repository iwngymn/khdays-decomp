...
extern void func_ov208_020d3e14(void);
extern void func_ov208_020d3ebc(void);
extern void func_ov208_020d3e8c(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov208_020d3d6c(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov208_020d3e14);
    func_0203c634(param_1, 1, (void *)&func_ov208_020d3ebc);
    func_0203c634(param_1, 2, (void *)&func_ov208_020d3e8c);
}
