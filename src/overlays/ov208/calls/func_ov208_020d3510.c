/*
 * func_ov208_020d3510 -- x3. AI-state entry: reconfigure flags, kick a fixed motion, spawn effect 0x49.
...
extern void func_ov208_020d362c(void);

void func_ov208_020d3510(int *self) {
    ...
    *hw = h & ~0xff00 | (((((unsigned int)h << 0x10) >> 0x18 | 0x40) << 0x18) >> 0x10);
    ...
    state[0xb] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov208_020d362c);
}
