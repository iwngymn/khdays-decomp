...
extern void func_ov263_020d3044(void);
extern void func_ov263_020d311c(void);
extern void func_ov263_020d30bc(void);

struct hi_flags_020cec74 { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov263_020d2f9c(int param_1) {
    ...
    *(int *)(child + 4) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov263_020d3044);
    func_0203c634(param_1, 1, (void *)&func_ov263_020d311c);
    func_0203c634(param_1, 2, (void *)&func_ov263_020d30bc);
}
