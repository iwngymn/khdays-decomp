...
extern void func_ov167_020d080c(void);
extern void func_ov167_020d09f8(void);
extern void func_ov167_020d0a98(void);
void func_ov167_020d0720(int *node) {
    ...
    *(struct blk16 *)(state + 0x1d) = *(struct blk16 *)(state + 0x19);
    func_0203c634(node, 0, func_ov167_020d080c);
    func_0203c634(node, 1, func_ov167_020d0a98);
    func_0203c634(node, 2, func_ov167_020d09f8);
}
