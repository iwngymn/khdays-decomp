/*
 * func_ov246_020d1960 -- x3. AI-state entry: reconfigure flags, spawn effect 0x4b, dispatch.
 ...
 * 020c5af8(state[0], 0, 0x4b, state[0x14]). Clear *(u8)(state[0]+0x1c7), hand off via 0203c634 (cb=0).
 */
...
void func_ov246_020d1960(int *self) {
    ...
    *hw = h & ~0xff00 | (((((unsigned int)h << 0x10) >> 0x18 | 0x86) << 0x18) >> 0x10);
    ...
    func_ov107_020c5af8(*state, 0, 0x4b, state[0x14]);
