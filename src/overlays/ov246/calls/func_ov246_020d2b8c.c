/* func_ov246_020d2b8c -- AI drop step: the state's hit target (+0x2c) is
...
extern int   func_ov246_020d2764(DropState *pState, Vec3 *pStep, Vec3 *pNormal, fx32 nY);
...
extern void  func_ov246_020d2e50(void);
...
void func_ov246_020d2b8c(DropNode *pNode)
{
    ...
    vStep.y = -0x32000;
    if (func_ov246_020d2764(pState, &vStep, &vNormal, vStep.y) != 0) {
    ...
    if (func_ov246_020d2764(pState, &vStep, &vNormal, vStep.y) != 0) {
        ...
        func_0203c634(pNode, pNode->nSlot, func_ov246_020d2e50);
    } else {
