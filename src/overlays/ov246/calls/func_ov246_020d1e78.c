...
extern void func_ov246_020d1f20(void);
extern void func_ov246_020d1fb0(void);
extern void func_ov246_020d1f98(void);

struct hi_flags_020cec74 { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov246_020d1e78(int param_1) {
    ...
    *(int *)(child + 4) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov246_020d1f20);
    func_0203c634(param_1, 1, (void *)&func_ov246_020d1fb0);
    func_0203c634(param_1, 2, (void *)&func_ov246_020d1f98);
}
