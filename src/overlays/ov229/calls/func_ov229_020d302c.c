...
extern void func_ov229_020d3450(int);
extern void func_ov229_020d30bc(int);
extern void func_ov229_020d32bc(int);
void func_ov229_020d302c(int param_1) {
    ...
    *(int *)(child + 0xc) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 1, (void *)&func_ov229_020d3450);
    func_0203c634(param_1, 0, (void *)&func_ov229_020d30bc);
    func_0203c634(param_1, 2, (void *)&func_ov229_020d32bc);
}
