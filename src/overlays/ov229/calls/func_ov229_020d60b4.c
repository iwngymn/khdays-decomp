...
extern void func_ov229_020d615c(void);
extern void func_ov229_020d6218(void);
extern void func_ov229_020d61d4(void);

struct hi_flags_020cec74 { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov229_020d60b4(int param_1) {
    ...
    *(int *)(child + 4) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov229_020d615c);
    func_0203c634(param_1, 1, (void *)&func_ov229_020d6218);
    func_0203c634(param_1, 2, (void *)&func_ov229_020d61d4);
}
