/* c634 handler: set owner hw60 hi bit 0x40, arm func_ov229_020d2f70(owner,0), then set hi
 * bits 0x80 and 0xe, set bit0 of owner+0x1ae, clear bit0 of the low byte at *(owner+0x3ac)+8,
 * clear obj[0x13], and dispatch into func_ov229_020d3624. */
...
extern void func_ov229_020d3624(void);
...
void func_ov229_020d3544(int self) {
    int *obj = *(int **)(self + 4);
    hw60_or(*obj, 0x40);
    func_ov229_020d2f70(*obj, 0);
    hw60_or(*obj, 0x80);
    hw60_or(*obj, 0xe);
    *(unsigned short *)(*obj + 0x1ae) |= 1;
    ((struct b8 *)(*(int *)(*obj + 0x3ac) + 8))->b &= ~1;
    obj[0x13] = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov229_020d3624);
}
