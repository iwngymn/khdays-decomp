...
extern void func_ov114_020cca68(void);
extern void func_ov114_020ccc64(void);

struct hw60 { unsigned short lo : 8, hi : 8; };
struct b8 { unsigned int f : 8; };

void func_ov114_020cc98c(int *self) {
    int *s = (int *)self[1];
    int zero = 0;
    ...
    func_0203c634(self, 1, (void *)&func_ov114_020ccd24);
    func_0203c634(self, 0, (void *)&func_ov114_020cca68);
    func_0203c634(self, 2, (void *)&func_ov114_020ccc64);
}
