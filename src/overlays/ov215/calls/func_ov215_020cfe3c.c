...
extern void *func_ov215_020d265c(void *self);
...
extern void func_ov215_020cfc08(void);
extern void func_ov215_020cfcdc(void);
extern void func_ov215_020d0204(void);
extern void func_ov215_020d025c(void);
extern void func_ov215_020d02e8(void);
extern void func_ov215_020d0524(void);
extern void func_ov215_020d0620(void);
extern void func_ov215_020d0698(void);
extern void func_ov215_020d06f4(void);
extern void func_ov215_020d0a28(void);
extern void func_ov215_020d0a54(void);

void func_ov215_020cfe3c(char *self)
{
    KindTable kinds;
    ParamBlock params;
    SpawnSeed seed;
    ...
    *(void **)(self + 0x8) = (void *)func_ov215_020d0204;
    *(void **)(self + 0xc) = (void *)func_ov215_020d025c;
    *(void **)(self + 0x1c) = (void *)func_ov215_020d02e8;
    *(void **)(self + 0x30) = (void *)func_ov215_020d0698;
    *(void **)(self + 0x34) = (void *)func_ov215_020d0524;
    *(void **)(self + 0x1d0) = (void *)func_ov215_020d06f4;
    *(void **)(self + 0x1dc) = (void *)func_ov215_020d0620;
    *(void **)(self + 0x1e0) = (void *)func_ov215_020d0a28;
    *(void **)(self + 0x1e4) = (void *)func_ov215_020d0a54;
    ...
    *(ParamBlock *)(self + 0x1fc) = params;
...

    {
        ...
        *(void **)(self + 0x384) = rig;
        *(void **)((char *)rig + 0x74) = (void *)func_ov215_020cfc08;
    }
    *(char **)(*(char **)(self + 0x384) + 0x84) = self;
...

    {
        ...
        *(int *)(self + 0x438) = func_0203bdfc(*(void **)(self + 0x384), data_ov215_020d288c);

        {
            *(void **)(self + 0x420) = func_0203b898(func_ov107_020c9440(self, 0xa));
            *(void **)(*(char **)(self + 0x420) + 0x6c) = (void *)func_ov215_020cfcdc;
            *(char **)(*(char **)(self + 0x420) + 0x84) = self;
            func_0203c7ac(*(void **)(self + 0x420), 0);
            *(int *)(self + 0x434) = func_0203bdfc(*(void **)(self + 0x420), data_ov215_020d2898);
        }
    }
    ...
    *(void **)(self + 0x3c0) = func_ov215_020d265c(self);
