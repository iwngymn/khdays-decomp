 ...
 * and dispatch null. Otherwise fetch the aim vector (func_ov137_020cc9e0), store the angle
...
extern void func_ov137_020cc9e0(int *obj, int *out);
extern int func_020050b4(int dx, int dz);
extern void func_ov137_020cd2d8(void);
void func_ov137_020cd208(int self) {
    int *obj = *(int **)(self + 4);
    int buf[3];
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov137_020cd2d8);
}
