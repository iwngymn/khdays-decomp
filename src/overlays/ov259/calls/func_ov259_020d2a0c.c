...
extern void func_ov259_020d2ab4(void);
extern void func_ov259_020d2b90(void);
extern void func_ov259_020d2b2c(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov259_020d2a0c(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov259_020d2ab4);
    func_0203c634(param_1, 1, (void *)&func_ov259_020d2b90);
    func_0203c634(param_1, 2, (void *)&func_ov259_020d2b2c);
}
