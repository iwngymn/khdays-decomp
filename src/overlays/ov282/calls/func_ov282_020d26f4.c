/*
 * func_ov282_020d26f4 -- x3. AI-state tick: aim at the target, steer, and close in until in range or
...
extern void func_ov282_020d2820(void);

void func_ov282_020d26f4(int *self) {
    ...
    *(char *)(*(int *)(*state + 0x384) + 0xa8) = 0;
    state[0x14] = 0x6000;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov282_020d2820);
}
