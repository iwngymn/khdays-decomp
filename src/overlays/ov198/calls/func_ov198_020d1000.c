...
extern void func_ov198_020d05f4(int owner, int a);
extern int  func_02023eb4();
extern void VEC_Subtract();
extern void func_ov198_020d10d8(void);

void func_ov198_020d1000(int *self) {
    int *obj = (int *)self[1];
    int lo, range;
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), &func_ov198_020d10d8);
}
