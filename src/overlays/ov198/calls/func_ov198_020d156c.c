...
extern void func_ov198_020d1630(void);

struct hw60 { unsigned short lo : 8, hi : 8; };
struct ov198b_LowByteFlags { unsigned bits : 8; };

void func_ov198_020d156c(int *node) {
    ...
    ((struct ov198b_LowByteFlags *)(*(int *)(*state + 0x38c) + 8))->bits &= ~1;
    func_ov107_020c5af8(*state, 0, 0x4b, *state + 0x74);
    func_0203c634(node, *(signed char *)(node + 8), func_ov198_020d1630);
}
