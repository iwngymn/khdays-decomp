...
extern void func_ov150_020d05f8(void);
extern void func_ov150_020d0788(void);

void func_ov150_020d0524(int *node) {
    ...
    func_0203c634(node, 0, func_ov150_020d05f8);
    func_0203c634(node, 2, func_ov150_020d0788);
}
