...
extern void func_ov054_020b6cd4(void);
extern void func_ov054_020b702c(void);

void *func_ov054_020b6024(char *self, int msg) {
    char *blk = data_ov054_020b74a0 + 0x2ca4;
    void *next = 0;
    Vec3 delta;
