...
extern unsigned int data_ov054_020b7468[];
extern unsigned int data_ov054_020b747c[];
extern void func_ov054_020b6ac8(int group, int param);

void func_ov054_020b6878(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x60);
    ...
    func_ov022_02091254((struct Group *)*(void **)(self + 0x2000 + 0x644),
                        (struct Peer *)self, data_ov054_020b7468, (char *)&cfg);
    *(void **)((char *)*(void **)(self + 0x2000 + 0x644) + 0x20) =
        (void *)&func_ov054_020b6ac8;
    ...
    func_ov022_02091254((struct Group *)((char *)*(void **)(self + 0x2000 + 0x644) + 0x30),
                        (struct Peer *)self, data_ov054_020b747c, (char *)&cfg);
