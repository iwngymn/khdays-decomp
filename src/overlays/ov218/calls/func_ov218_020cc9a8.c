...
extern void func_ov218_020cca60(void);
extern void func_ov218_020ccc58(void);

void func_ov218_020cc9a8(int self) {
    int *obj = *(int **)(self + 4);
    unsigned short w;
    ...
    func_0203c634(self, 0, &func_ov218_020cca60);
    func_0203c634(self, 2, &func_ov218_020ccc58);
}
