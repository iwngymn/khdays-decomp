...
extern void func_ov218_020ce534(void);
extern void func_ov218_020ce798(void);
extern void func_ov218_020ce5ac(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov218_020ce48c(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov218_020ce534);
    func_0203c634(param_1, 1, (void *)&func_ov218_020ce798);
    func_0203c634(param_1, 2, (void *)&func_ov218_020ce5ac);
}
