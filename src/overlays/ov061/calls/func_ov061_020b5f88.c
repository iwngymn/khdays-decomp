...
extern struct Ov047Descriptor data_ov061_020b6f90;
extern struct Ov047Descriptor data_ov061_020b6fa0;

u8 func_ov061_020b5f88(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov061_020b6f90.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov061_020b6fa0.bytes, self->slot09, 1,
