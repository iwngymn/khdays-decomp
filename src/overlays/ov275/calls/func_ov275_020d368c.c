/*
 * func_ov275_020d368c -- x4 (ov206/207/274/275). AI-state tick: track a target, steer a stored
...
extern void func_ov275_020d37d8(void);

void func_ov275_020d368c(int *self) {
    ...
    *(char *)(*(int *)(*state + 0x384) + 0xa8) = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov275_020d37d8);
}
