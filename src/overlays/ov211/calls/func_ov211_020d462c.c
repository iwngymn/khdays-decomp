/*
 * func_ov211_020d462c -- x3. AI-state tick: aim at the acquired target, steer, then fire once ready.
...
extern void func_ov211_020d4738(void);

void func_ov211_020d462c(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov211_020d4738);
}
