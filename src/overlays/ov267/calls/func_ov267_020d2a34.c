/* func_ov267_020d2a34 -- the idle/approach tick: run the think timer down, re-acquire the target,
 * and either let the chooser (func_ov267_020d1920) queue a move or fall back to the idle anim.
 *
 ...
 *
 * A reactive opening short-circuits everything: if func_ov267_020d124c(ctx, 1) fires straight away
 ...
 * or too far -- or when func_ov267_020d1ddc says so. Only a target sitting comfortably in the band
...
extern int func_ov267_020d1ddc(int self);
extern int func_ov267_020d1920(int self, int dist);
...
void func_ov267_020d2a34(int self) {
    int *ctx;
    VecFx32 v;
    int gap;

    ctx = *(int **)(self + 4);
    if (func_ov267_020d124c(ctx, 1) != 0) {
    ...
    if (func_ov267_020d121c(ctx, 1) != 0 || func_ov267_020d124c(ctx, 1) != 0) {
        *(int *)(ctx[0] + 0x5a8) = func_ov107_020cab14(ctx[0], 0);
        if (*(int *)(ctx[0] + 0x5a8) != 0) {
            ...
            if (func_ov267_020d1920(self, gap) != 0) {
                func_0203c634(self, *(signed char *)(self + 0x20), 0);
                return;
            }
            if (gap > 0x9800 || gap < 0x3000 || func_ov267_020d1ddc(self) != 0) {
                ((struct AiState *)(ctx[0]))->pendingAction = 4;
                func_0203c634(self, *(signed char *)(self + 0x20), 0);
                return;
            }
