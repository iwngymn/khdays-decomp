/* func_ov267_020d1920 -- the move CHOOSER for ov212's family: pick a move, then (for move 6, the
...
extern void func_ov267_020d11fc(int *ctx, int a);
...
int func_ov267_020d1920(int self, int dist) {
    int *ctx;
    int roll;
    VecFx32 v;
    int other;
