...
extern void func_ov267_020d4b3c(void);
extern void func_ov267_020d4d80(void);
extern void func_ov267_020d4bd0(void);

struct hi_flags_020cec74 { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov267_020d4a94(int param_1) {
    ...
    *(int *)(child + 4) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov267_020d4b3c);
    func_0203c634(param_1, 1, (void *)&func_ov267_020d4d80);
    func_0203c634(param_1, 2, (void *)&func_ov267_020d4bd0);
}
