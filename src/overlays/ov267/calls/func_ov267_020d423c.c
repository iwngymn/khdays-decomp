...
extern void func_ov267_020d2020(int a);
extern void func_0203c634(void *self, int idx, void *cb);
extern void func_ov267_020d431c(void);

struct hw60 { unsigned short lo : 8, hi : 8; };
struct b8 { unsigned f : 8; };

void func_ov267_020d423c(void *self) {
    ...
    func_ov267_020d2020((int)ctx);
    func_0203c634(self, *(signed char *)((char *)self + 0x20), func_ov267_020d431c);
}
