/*
 * func_ov122_020cfee4 -- Ov122_Actor_HandleEvent.
 *
 * The actor class event handler installed in the +0x1c onAction slot by the ov122 initializer,
 * shared byte-for-byte with ov120 and ov121. Against both of them even the relocations match,
 ...
 *
 * Ghidra: Ov122_Actor_HandleEvent(Ov120Actor *pActor, ActorEventMsg *pMsg, uint uParam), types
...
void func_ov122_020cfee4(struct Ov120Actor *actor, struct ActorEventMsg *msg, u32 param)
{
