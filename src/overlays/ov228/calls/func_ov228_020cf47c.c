/* func_ov228_020cf47c -- the move dispatcher: play whatever move was queued at ctx[0]+0x1c7, then
...
extern void func_ov228_020cf810(void);
extern void func_ov228_020cf904(void);
extern void func_ov228_020cfc10(void);
extern void func_ov228_020cfddc(void);
extern void func_ov228_020d02e0(void);
extern void func_ov228_020d0900(void);
extern void func_ov228_020d0cb0(void);
extern void func_ov228_020d0f50(void);
extern void func_ov228_020d112c(void);
extern void func_ov228_020d1424(void);
extern void func_ov228_020d1a54(void);
extern void func_ov228_020d1c48(void);
extern void func_ov228_020d1d30(void);
extern void func_ov228_020d1e8c(void);

void func_ov228_020cf47c(int self) {
    int *ctx;
    int move;
    ...
    if (move != -1) {
        ...
        case 0:
            func_0203c634(self, 1, func_ov228_020cf810);
            break;
        case 1:
            func_0203c634(self, 1, func_ov228_020cf904);
            break;
        case 2:
            func_0203c634(self, 1, func_ov228_020cfc10);
            break;
        case 4:
            func_0203c634(self, 1, func_ov228_020cfddc);
            break;
        case 5:
            func_0203c634(self, 1, func_ov228_020d02e0);
            break;
        case 6:
            func_0203c634(self, 1, func_ov228_020d0900);
            break;
        case 7:
            func_0203c634(self, 1, func_ov228_020d0cb0);
            break;
        case 8:
            func_0203c634(self, 1, func_ov228_020d0f50);
            break;
        case 9:
            func_0203c634(self, 1, func_ov228_020d112c);
            break;
        case 10:
            func_0203c634(self, 1, func_ov228_020d1424);
            break;
        case 11:
            func_0203c634(self, 1, func_ov228_020d1a54);
            break;
        case 3:
            func_0203c634(self, 1, func_ov228_020d1c48);
            break;
        case 12:
            func_0203c634(self, 1, func_ov228_020d1d30);
            break;
        case 13:
            func_0203c634(self, 1, func_ov228_020d1e8c);
            break;
        }
    }
