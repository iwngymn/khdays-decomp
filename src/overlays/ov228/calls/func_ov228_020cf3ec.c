...
extern void func_ov228_020cf810(int);
extern void func_ov228_020cf47c(int);
extern void func_ov228_020cf67c(int);
void func_ov228_020cf3ec(int param_1) {
    ...
    *(int *)(child + 0xc) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 1, (void *)&func_ov228_020cf810);
    func_0203c634(param_1, 0, (void *)&func_ov228_020cf47c);
    func_0203c634(param_1, 2, (void *)&func_ov228_020cf67c);
}
