...
extern void func_ov301_020cbfc4(void *obj);

void *func_ov301_020cbf38(int arg)
{
    char name[0x1d] = { 0 };
    void *obj = func_0203d15c(0x394);

    *(signed char *)((int)obj + 0x19c) = 0x75;
    OS_SPrintf(name, &data_ov301_020cc760, 0x75);
    *(int *)((int)obj + 0x1a4) = func_ov107_020c9c24(name);
    *(void **)((int)obj + 0x18c) = func_ov301_020cbfc4;
