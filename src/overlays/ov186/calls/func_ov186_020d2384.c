 ...
 * fetch its transform into obj[6..9] (func_ov186_020d1e48) and copy it to obj[2..5]. Finally
...
extern void func_ov186_020d1e48(int *obj, int *out);
extern void func_ov107_020c9264(int owner, int a, int b);
extern void func_0203c634(int self, int index, void *cb);
extern void func_ov186_020d2454(void);
void func_ov186_020d2384(int self) {
    int *obj = *(int **)(self + 4);
    ...
    if (obj[1] != 0) {
        func_ov186_020d1e48(obj, obj + 6);
        *(struct vec4 *)(obj + 2) = *(struct vec4 *)(obj + 6);
    }
    func_ov107_020c9264(*obj, 0, 0);
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov186_020d2454);
}
