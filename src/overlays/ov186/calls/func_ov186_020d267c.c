 ...
 * the other way round.
 * func_ov186_020d1e48 takes THREE arguments; Ghidra shows a fourth (leftover in r3). */
...
void func_ov186_020d267c(int self) {
    ...
    func_ov186_020d1e48((int)obj, obj + 6, dist);
