...
extern void func_ov186_020d0b30(void);
extern void func_ov186_020d0644(void);
extern void func_ov186_020d0854(void);
void func_ov186_020d0558(int self) {
    int *obj = *(int **)(self + 4);
    ...
    *(struct vec4 *)(obj + 6) = *(struct vec4 *)(obj + 2);
    func_0203c634(self, 1, &func_ov186_020d0b30);
    func_0203c634(self, 0, &func_ov186_020d0644);
    func_0203c634(self, 2, &func_ov186_020d0854);
}
