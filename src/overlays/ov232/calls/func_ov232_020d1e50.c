/* func_ov232_020d1e50 -- the two-shot tick: track the aim point, then fire each of the two
 ...
 * aimed straight down the owner's own axis, not at the raw target. func_ov232_020d06b4 turns it
 ...
 *
 * The direction handed to func_ov232_020d2d1c is {sin, ctx[0x10], cos} -- the Q12 heading at
...
extern void func_ov232_020d2d1c(int muzzle, int a, const VecFx32 *dir, signed char spin, int pt);
...
void func_ov232_020d1e50(int self) {
    int *ctx;
    ...
    func_ov232_020d06b4(&out, self, &ref);
    ...
    if ((ctx[0xa] >= 0x1298 && *(unsigned char *)((char *)ctx + 0x4b) == 2)
        ...
        *(unsigned char *)((char *)ctx + 0x4b) -= 1;
        ...
        if ((((Hw60 *)(*(int *)(ctx[0] + *(unsigned char *)((char *)ctx + 0x4b) * 4 + 0x38c) + 0x60))->lo
            ...
            func_ov232_020d2d1c(*(int *)(ctx[0] + *(unsigned char *)((char *)ctx + 0x4b) * 4 + 0x38c),
                                ctx[3], &dir,
