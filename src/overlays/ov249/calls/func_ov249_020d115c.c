...
extern void func_ov249_020d1580(int);
extern void func_ov249_020d11ec(int);
extern void func_ov249_020d13ec(int);
void func_ov249_020d115c(int param_1) {
    ...
    *(int *)(child + 0xc) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 1, (void *)&func_ov249_020d1580);
    func_0203c634(param_1, 0, (void *)&func_ov249_020d11ec);
    func_0203c634(param_1, 2, (void *)&func_ov249_020d13ec);
}
