...
extern void func_ov244_020d1064(void);
extern void func_ov244_020d10f4(void);
extern void func_ov244_020d10dc(void);

struct hi_flags_020cec74 { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov244_020d0fbc(int param_1) {
    ...
    *(int *)(child + 4) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov244_020d1064);
    func_0203c634(param_1, 1, (void *)&func_ov244_020d10f4);
    func_0203c634(param_1, 2, (void *)&func_ov244_020d10dc);
}
