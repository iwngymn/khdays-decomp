...
extern void func_ov244_020cfa04(void);
extern void func_ov244_020cfc24(void);
extern void func_ov244_020cfbc8(void);
struct hw60 { unsigned short lo:8, hi:8; };
struct b8 { unsigned int f:8; };
void func_ov244_020cf8e4(int self) {
    int obj = *(int *)(self + 4);
    int f384;
    ...
    *(int *)(obj + 0x30) = f384 + 0xad;
    ...
    func_0203c634(self, 0, &func_ov244_020cfa04);
    func_0203c634(self, 1, &func_ov244_020cfc24);
    func_0203c634(self, 2, &func_ov244_020cfbc8);
}
