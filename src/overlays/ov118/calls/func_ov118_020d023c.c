...
extern void func_ov118_020d0328(void);
extern void func_ov118_020d0538(void);
void func_ov118_020d023c(int self) {
    int *obj = *(int **)(self + 4);
    ...
    *(struct vec4 *)(obj + 6) = *(struct vec4 *)(obj + 2);
    func_0203c634(self, 1, &func_ov118_020d063c);
    func_0203c634(self, 0, &func_ov118_020d0328);
    func_0203c634(self, 2, &func_ov118_020d0538);
}
