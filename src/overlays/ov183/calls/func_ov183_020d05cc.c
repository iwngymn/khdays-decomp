...
extern void func_ov183_020d06a8(void);
extern void func_ov183_020d08a0(void);

struct hw60 { unsigned short lo : 8, hi : 8; };
struct b8 { unsigned int f : 8; };

void func_ov183_020d05cc(int *self) {
    int *s = (int *)self[1];
    int zero = 0;
    ...
    func_0203c634(self, 1, (void *)&func_ov183_020d0954);
    func_0203c634(self, 0, (void *)&func_ov183_020d06a8);
    func_0203c634(self, 2, (void *)&func_ov183_020d08a0);
}
