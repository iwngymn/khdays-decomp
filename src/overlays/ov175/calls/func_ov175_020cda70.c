...
extern int func_ov175_020ccb34(int self);
extern int data_02042264;

void func_ov175_020cda70(int *self) {
    ...
    mag = func_ov175_020cca9c((int)self, v1);
    if (mag > 0x100) {
        mag = 0x180;
    }
    ...
    if (counter <= 0) {
        ...
        state[0x17] = 0;
        if (roll < 0x3c && func_ov175_020ccb34((int)self) != 0) {
            st = 8;
        } else {
            st = 5;
        }
