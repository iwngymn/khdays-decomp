...
extern void func_ov224_020d14ec(void);
extern void func_ov224_020d1810(void);
void func_ov224_020d1404(int self) {
    int *obj = *(int **)(self + 4);
    int i = 0;
    ...
    *(char *)(*obj + 0x40c) = -1;
    ...
    func_0203c634(self, 0, &func_ov224_020d14ec);
    func_0203c634(self, 2, &func_ov224_020d1810);
}
