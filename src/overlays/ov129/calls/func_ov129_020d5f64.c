...
extern void func_ov129_020d6028(void);
extern void func_ov129_020d61b0(void);

void func_ov129_020d5f64(int *node) {
    ...
    func_0203c634(node, 0, func_ov129_020d6028);
    func_0203c634(node, 2, func_ov129_020d61b0);
}
