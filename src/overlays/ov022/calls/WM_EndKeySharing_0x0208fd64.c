 ...
 * WM_EndKeySharing_0x0208fd64 but tail-calls func_ov022_0208f888 (Ov022_VeneerTo_Ov022_EnterBlockReaction in Ghidra). It belongs to ov022,
 * not NitroSDK; retain the historical linkage symbol until a coordinated symbol rename. */
extern void *func_ov022_0208f888();

void *WM_EndKeySharing_0x0208fd64() {
