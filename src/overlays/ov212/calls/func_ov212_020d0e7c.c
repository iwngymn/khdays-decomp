...
extern void func_ov212_020d0f24(void);
extern void func_ov212_020d1168(void);
extern void func_ov212_020d0fb8(void);

struct hi_flags_020cec74 { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov212_020d0e7c(int param_1) {
    ...
    *(int *)(child + 4) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov212_020d0f24);
    func_0203c634(param_1, 1, (void *)&func_ov212_020d1168);
    func_0203c634(param_1, 2, (void *)&func_ov212_020d0fb8);
}
