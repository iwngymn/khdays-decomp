...
extern void func_ov139_020cc768(void);
extern void func_ov139_020cc920(void);
...
void func_ov139_020cc694(int *this)
{
    int node = this[1];
    ...
    *(int *)(node + 0x50) = *(int *)(*(int *)node + 0x384) + 0xad;
    ...
    func_0203c634((int)this, 1, (int)&func_ov139_020cca14);
    func_0203c634((int)this, 0, (int)&func_ov139_020cc768);
    func_0203c634((int)this, 2, (int)&func_ov139_020cc920);
}
