...
extern void func_ov139_020ccb84(void);
...
void func_ov139_020ccab8(int *node) {
    ...
    ((struct ov139_Hw60 *)(*state + 0x60))->hi &= ~0xc;
    ...
    state[15] = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov139_020ccb84);
}
