...
extern void func_ov142_020d05f4(void);
extern void func_ov142_020d0784(void);

void func_ov142_020d0520(int *node) {
    ...
    func_0203c634(node, 0, func_ov142_020d05f4);
    func_0203c634(node, 2, func_ov142_020d0784);
}
