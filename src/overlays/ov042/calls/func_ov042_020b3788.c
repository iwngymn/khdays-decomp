 ...
 * and one against the model of the object it is attached to -- clears the 0xc7-byte
...
extern struct Ov047Descriptor data_ov042_020b4790;
extern struct Ov047Descriptor data_ov042_020b47a0;

u8 func_ov042_020b3788(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov042_020b4790.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov042_020b47a0.bytes, self->slot09, 1,
        &self->attach2644->model0c->field28);
    func_ov022_020b1cec((char *)self + 0xda0, 0xc7);
