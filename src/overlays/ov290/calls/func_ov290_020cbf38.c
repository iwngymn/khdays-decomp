...
extern void func_ov290_020cbfc4(void *obj);

void *func_ov290_020cbf38(int arg)
{
    char name[0x1d] = { 0 };
    void *obj = func_0203d15c(0x384);

    *(signed char *)((int)obj + 0x19c) = 0x6c;
    OS_SPrintf(name, &data_ov290_020cc020, 0x6c);
    *(int *)((int)obj + 0x1a4) = func_ov107_020c9c24(name);
    *(void **)((int)obj + 0x18c) = func_ov290_020cbfc4;
