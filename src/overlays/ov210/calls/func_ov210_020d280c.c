/*
 * func_ov210_020d280c -- x3. AI-state tick: aim at the acquired target, steer, then fire once ready.
...
extern void func_ov210_020d2918(void);

void func_ov210_020d280c(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov210_020d2918);
}
