...
extern void func_ov210_020d3ffc(int a, int b, int c);
extern long long func_01ff8a14(int num, int denom);
extern void func_ov107_020c5c54(int obj, void *v);
extern void func_0203c634(int self, int idx, int cb);
extern void func_ov210_020d233c(void);

void func_ov210_020d2230(int *self) {
    ...
    if (*(unsigned char *)((char *)state + 0x64) == 0) {
        ...
        func_ov210_020d3ffc(leaderVal, 0, 0);
    ...
    if (q == 0x100000000LL) {
        state[0xb] = 0;
        func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)func_ov210_020d233c);
    }
}
