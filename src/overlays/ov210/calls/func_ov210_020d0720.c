/*
 * func_ov210_020d0720 -- x3. AI-state entry: initialise the sub-state and register three handlers.
...
extern void func_ov210_020d0a48(void);

void func_ov210_020d0720(int *self) {
    ...
    *hw = h & ~0xff00 | (((((unsigned int)h << 0x10) >> 0x18 | 6) << 0x18) >> 0x10);
    func_0203c634((int)self, 1, (int)&func_ov210_020d0b48);
    func_0203c634((int)self, 0, (int)&func_ov210_020d07d0);
    func_0203c634((int)self, 2, (int)&func_ov210_020d0a48);
}
