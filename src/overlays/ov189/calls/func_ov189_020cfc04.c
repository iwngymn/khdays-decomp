...
void func_ov189_020cfc04(int param_1) {
    struct Box box;
    struct Pose g;
    char *pg;
    void *sub;
    ...
    *(void **)(((unsigned int)param_1) + 8) = func_ov189_020d0010;
    ...
    *(void **)(((unsigned int)param_1) + 0x1e0) = func_ov189_020d06bc;
    *(void **)(((unsigned int)param_1) + 0x1e4) = func_ov189_020d06e8;
    ...
    *(void **)(((unsigned int)param_1) + 0x384) = func_0203b898(func_ov107_020c9440(((unsigned int)param_1), 0));
    ...
    ((void **)self)[0xe4] = func_0203bee8(self[0xe1], 1, data_ov189_020d20ac);
    ((void **)self)[0xe5] = func_0203bee8(self[0xe1], 1, data_ov189_020d20b4);
    ((void **)self)[0xe6] = func_0203bee8(self[0xe1], 1, data_ov189_020d20bc);
    ((void **)self)[0xe7] = func_0203bee8(self[0xe1], 1, data_ov189_020d20c8);
    ((void **)self)[0xe8] = func_0203bee8(self[0xe1], 1, data_ov189_020d20d8);
    ((void **)self)[0xe9] = func_0203bee8(self[0xe1], 1, data_ov189_020d20e8);
    ((void **)self)[0xea] = func_0203bee8(self[0xe1], 1, data_ov189_020d20f4);
    ((void **)self)[0xeb] = func_0203bee8(self[0xe1], 1, data_ov189_020d2104);
    ((void **)self)[0xec] = func_0203bee8(self[0xe1], 1, data_ov189_020d2110);
    ((void **)self)[0xed] = func_0203bee8(self[0xe1], 1, data_ov189_020d2120);
    ((void **)self)[0xee] = func_0203bee8(self[0xe1], 1, data_ov189_020d2130);
    ((void **)self)[0xef] = func_0203bee8(self[0xe1], 1, data_ov189_020d2140);

    ((void **)self)[0xf0] =
        func_ov107_020c9e50(func_ov107_020c9440(self, 1), &data_ov189_020d2150);
