...
extern void func_ov189_020d0a50(void);
extern void func_ov189_020d0c20(void);

void func_ov189_020d0998(int self) {
    int *obj = *(int **)(self + 4);
    unsigned short w;
    ...
    func_0203c634(self, 1, &func_ov189_020d0cbc);
    func_0203c634(self, 0, &func_ov189_020d0a50);
    func_0203c634(self, 2, &func_ov189_020d0c20);
}
