...
extern void func_ov222_020d32f4(void);
extern void func_ov222_020d3618(void);
void func_ov222_020d320c(int self) {
    int *obj = *(int **)(self + 4);
    int i = 0;
    ...
    *(char *)(*obj + 0x40c) = -1;
    ...
    func_0203c634(self, 0, &func_ov222_020d32f4);
    func_0203c634(self, 2, &func_ov222_020d3618);
}
