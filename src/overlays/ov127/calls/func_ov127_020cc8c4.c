...
extern void func_ov127_020cc988(void);
extern void func_ov127_020ccb10(void);

void func_ov127_020cc8c4(int *node) {
    ...
    func_0203c634(node, 0, func_ov127_020cc988);
    func_0203c634(node, 2, func_ov127_020ccb10);
}
