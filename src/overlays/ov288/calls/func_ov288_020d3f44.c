/*
 * func_ov288_020d3f44 -- Ov287_Actor_ResolveHit.
 *
 * Hit resolution handler installed in the +0x1d0 slot by func_ov288_020d3844, shared with
...
extern const struct ImpactIdPairs data_ov288_020d5314;

int func_ov288_020d3f44(struct Actor *actor, void *other, struct HitEvent *event)
{
