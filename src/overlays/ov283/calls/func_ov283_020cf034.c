...
extern void func_ov283_020cf0f0(void);
extern void func_ov283_020cf158(void);
void func_ov283_020cf034(int param_1) {
    ...
    if (v != -1) {
        ...
        case 0:
            func_0203c634(param_1, 1, (void *)&func_ov283_020cf0f0);
            break;
        case 1:
