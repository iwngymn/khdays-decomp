/* func_ov268_020d1be8 -- ov268's move CHOOSER.
 *
 * Byte-identical to func_ov208_020d1be0 modulo this overlay's own symbols; that is the rep of
 * the family and carries the analysis. See func_ov206_020cde58 for the chooser shape itself.
 *
...
extern int func_ov268_020d0ea8(int obj, int kind);
...
void func_ov268_020d1be8(int self) {
    int *ctx;
    int toTarget[3];
    int forward[3];
    int target;
    ...
    target = func_ov268_020d0ea8(ctx[0], 0);
    ctx[4] = target;
    if (target == 0) {
