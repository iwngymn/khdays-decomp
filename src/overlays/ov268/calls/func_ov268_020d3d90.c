...
extern void func_ov268_020d3e38(void);
extern void func_ov268_020d3ee0(void);
extern void func_ov268_020d3eb0(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov268_020d3d90(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov268_020d3e38);
    func_0203c634(param_1, 1, (void *)&func_ov268_020d3ee0);
    func_0203c634(param_1, 2, (void *)&func_ov268_020d3eb0);
}
