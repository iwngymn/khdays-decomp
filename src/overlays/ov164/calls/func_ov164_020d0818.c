...
extern void func_ov164_020d0914(void);
extern void func_ov164_020d0ad4(void);

struct flagword { unsigned f8 : 8; };

void func_ov164_020d0818(int param_1) {
    ...
    func_0203c634(param_1, 1, func_ov164_020d0bb0);
    func_0203c634(param_1, 0, func_ov164_020d0914);
    func_0203c634(param_1, 2, func_ov164_020d0ad4);
}
