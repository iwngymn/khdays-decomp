...
extern void func_ov154_020d1504(void);
...
void func_ov154_020d1438(int *node) {
    ...
    ((struct ov154_Hw60 *)(*state + 0x60))->hi &= ~0xc;
    ...
    state[7] = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov154_020d1504);
}
