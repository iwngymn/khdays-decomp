/* func_ov154_020d04d4 -- broadcast this node's position. When the caller's flag word has both
 * bit 0 and bit 4 set, build the 14-byte message from the template at data_ov154_020d1c84, pack
...
extern struct Msg data_ov154_020d1c84;

int func_ov154_020d04d4(int self, int a, unsigned int *flags, int d) {
