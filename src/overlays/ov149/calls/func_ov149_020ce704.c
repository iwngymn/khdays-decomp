...
extern void func_ov149_020ce7d8(void);
extern void func_ov149_020ce968(void);

void func_ov149_020ce704(int *node) {
    ...
    func_0203c634(node, 0, func_ov149_020ce7d8);
    func_0203c634(node, 2, func_ov149_020ce968);
}
