/*
 * func_ov119_020cce30 -- x3. AI-state entry: initialise the sub-state and register three handlers.
...
extern void func_ov119_020ccef4(void);
extern void func_ov119_020cd0f0(void);

void func_ov119_020cce30(int *self) {
    ...
    *hw = h & ~0xff00 | (((((unsigned int)h << 0x10) >> 0x18 | 6) << 0x18) >> 0x10);
    ...
    func_0203c634((int)self, 1, (int)&func_ov119_020cd144);
    func_0203c634((int)self, 0, (int)&func_ov119_020ccef4);
    func_0203c634((int)self, 2, (int)&func_ov119_020cd0f0);
}
