/*
 * func_ov119_020cd224 -- x3. AI-state entry: reconfigure flags, set the turn rate, spawn effect 0x48.
...
extern void func_ov119_020cd314(void);

void func_ov119_020cd224(int *self) {
    ...
    *hw = h & ~0xff00 | (((((unsigned int)h << 0x10) >> 0x18 | 0x82) << 0x18) >> 0x10);
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov119_020cd314);
}
