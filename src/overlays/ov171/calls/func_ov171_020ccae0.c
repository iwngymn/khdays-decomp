...
extern void func_ov171_020ccbcc(void);
extern void func_ov171_020ccdb8(void);
extern void func_ov171_020cce58(void);
void func_ov171_020ccae0(int *node) {
    ...
    *(struct blk16 *)(state + 0x1d) = *(struct blk16 *)(state + 0x19);
    func_0203c634(node, 0, func_ov171_020ccbcc);
    func_0203c634(node, 1, func_ov171_020cce58);
    func_0203c634(node, 2, func_ov171_020ccdb8);
}
