/* Accumulate the owner rate (+0x2c) into the timer at (child)+0x38; once it reaches
...
void func_ov240_020cf998(int param_1) {
    int child = *(int *)(param_1 + 4);
    int t = *(int *)(child + 0x38) + *(int *)(*(int *)param_1 + 0x2c);
    *(int *)(child + 0x38) = t;
    if (t < 0xd48) return;
    {
