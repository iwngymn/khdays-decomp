...
extern void func_ov240_020cea34(void);
extern void func_ov240_020cebec(void);

void func_ov240_020ce97c(int self) {
    int *obj = *(int **)(self + 4);
    unsigned short w;
    ...
    func_0203c634(self, 1, &func_ov240_020cec88);
    func_0203c634(self, 0, &func_ov240_020cea34);
    func_0203c634(self, 2, &func_ov240_020cebec);
}
