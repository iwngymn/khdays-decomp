/* func_ov247_020d3120 -- face the target and arm the timed follow-up.
 ...
 * from the caller's per-tick amount, and the action is dispatched with func_ov247_020d31f8.
 *
...
extern void func_ov247_020d31f8(void);

void func_ov247_020d3120(int self) {
    int *ctx;
    Vec3 v;
    int target;
