/* func_ov247_020d49ac -- AI drop step: the state's hit target (+0x2c) is
...
extern int   func_ov247_020d4584(DropState *pState, Vec3 *pStep, Vec3 *pNormal, fx32 nY);
...
extern void  func_ov247_020d4c70(void);
...
void func_ov247_020d49ac(DropNode *pNode)
{
    ...
    vStep.y = -0x32000;
    if (func_ov247_020d4584(pState, &vStep, &vNormal, vStep.y) != 0) {
    ...
    if (func_ov247_020d4584(pState, &vStep, &vNormal, vStep.y) != 0) {
        ...
        func_0203c634(pNode, pNode->nSlot, func_ov247_020d4c70);
    } else {
