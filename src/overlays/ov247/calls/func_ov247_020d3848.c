/*
 * func_ov247_020d3848 -- x3. AI-state entry: reconfigure flags, spawn effect 0x49, dispatch.
 * hw60.hi &= ~1 then hw60.hi |= 0x86 on the +0x60 hw flags; clear bit0 of the low byte of the word at
 * *(state[0]+0x384)+8. Spawn via 020c5af8(state[0], 0, 0x49, state[0x14]). Clear *(u8)(state[0]+0x1c7)
...
void func_ov247_020d3848(int *self) {
