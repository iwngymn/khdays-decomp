/* func_ov247_020d3eb8 -- c634 handler: arm the owner for a dash/lunge and hand off to func_ov247_020d3f8c.
 *
...
extern void func_ov247_020d3f8c(void);
void func_ov247_020d3eb8(int self) {
    int *obj = *(int **)(self + 4);
    int *dst = obj + 5;
    obj[9] = 0;
    obj[10] = 0;
    ...
    *(struct vec *)(obj + 5) = *(struct vec *)(*obj + 0x394);
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov247_020d3f8c);
}
