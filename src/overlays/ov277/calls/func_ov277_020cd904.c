...
extern void func_ov277_020cd9c8(void);
extern void func_ov277_020cdabc(void);
extern void func_ov277_020cdfb8(void);
void func_ov277_020cd904(int param_1) {
    ...
    if (v != -1) {
        ...
        case 0:
            func_0203c634(param_1, 1, (void *)&func_ov277_020cd9c8);
            break;
        case 1:
            func_0203c634(param_1, 1, (void *)&func_ov277_020cdabc);
            break;
        case 2:
            func_0203c634(param_1, 1, (void *)&func_ov277_020cdfb8);
            break;
        }
    }
