...
extern void func_ov277_020d0ffc(void);
extern void func_ov277_020d108c(void);
extern void func_ov277_020d1074(void);

struct hi_flags_020cec74 { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov277_020d0f54(int param_1) {
    ...
    *(int *)(child + 4) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov277_020d0ffc);
    func_0203c634(param_1, 1, (void *)&func_ov277_020d108c);
    func_0203c634(param_1, 2, (void *)&func_ov277_020d1074);
}
