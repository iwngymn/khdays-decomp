...
extern void func_ov180_020d4538(void);
extern void func_ov180_020d4738(void);
extern void func_ov180_020d47d8(void);
void func_ov180_020d444c(int *node) {
    ...
    *(struct blk16 *)(state + 0x1d) = *(struct blk16 *)(state + 0x19);
    func_0203c634(node, 0, func_ov180_020d4538);
    func_0203c634(node, 1, func_ov180_020d47d8);
    func_0203c634(node, 2, func_ov180_020d4738);
}
