...
extern void func_ov204_020d04c8(void);
extern void func_ov204_020d069c(void);

void func_ov204_020d03f4(int *node) {
    ...
    func_0203c634(node, 0, func_ov204_020d04c8);
    func_0203c634(node, 2, func_ov204_020d069c);
}
