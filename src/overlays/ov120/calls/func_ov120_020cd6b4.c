...
extern struct Ov120AreaMsg data_ov120_020cdf02;
extern void func_ov120_020cd9f8(void);
...
void func_ov120_020cd6b4(struct Ov120ActionNode *node)
{
    ...
    if (*state->pGate48 == 0) {
        ...
        func_0203c634(node, node->bSlot, func_ov120_020cd9f8);
    }
}
