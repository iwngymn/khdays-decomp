...
extern void func_ov253_020d3f30(void);
extern void func_ov253_020d3ff4(void);
extern void func_ov253_020d3fc4(void);

struct hi_flags_020cec74 { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov253_020d3e88(int param_1) {
    ...
    *(int *)(child + 4) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov253_020d3f30);
    func_0203c634(param_1, 1, (void *)&func_ov253_020d3ff4);
    func_0203c634(param_1, 2, (void *)&func_ov253_020d3fc4);
}
