...
extern struct Ov047Descriptor data_ov065_020b72dc;
extern struct Ov047Descriptor data_ov065_020b72ec;

u8 func_ov065_020b60ec(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov065_020b72dc.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov065_020b72ec.bytes, self->slot09, 1,
