...
struct ov286_LowByteFlags { unsigned bits : 8; };

void func_ov286_020d3e50(int *node) {
    ...
    ((struct ov286_LowByteFlags *)(*(int *)(*state + 0x38c) + 8))->bits &= ~1;
    state[10] = 0;
    func_ov107_020c5af8(*state, 0, 0x48, state[3]);
    func_0203c634(node, *(signed char *)(node + 8), func_ov286_020d3f18);
}
