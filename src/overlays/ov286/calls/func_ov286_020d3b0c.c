...
extern void func_ov286_020d3bd0(void);
extern void func_ov286_020d3d18(void);

void func_ov286_020d3b0c(int *node) {
    ...
    func_0203c634(node, 0, func_ov286_020d3bd0);
    func_0203c634(node, 2, func_ov286_020d3d18);
}
