...
extern void func_ov220_020d25a8(void);
extern void func_ov220_020d27b8(void);

void func_ov220_020d24f0(int self) {
    int *obj = *(int **)(self + 4);
    unsigned short w;
    ...
    func_0203c634(self, 1, &func_ov220_020d291c);
    func_0203c634(self, 0, &func_ov220_020d25a8);
    func_0203c634(self, 2, &func_ov220_020d27b8);
}
