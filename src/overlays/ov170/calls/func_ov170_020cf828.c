...
extern int func_ov170_020ce854(int self, void *out);
...
extern int func_ov170_020ce8ec(int self);
extern int data_02042264;

void func_ov170_020cf828(int *self) {
    ...
    mag = func_ov170_020ce854((int)self, v1);
    if (mag > 0x100) {
        mag = 0x180;
    }
    ...
    if (counter <= 0) {
        ...
        state[0x17] = 0;
        if (roll < 0x3c && func_ov170_020ce8ec((int)self) != 0) {
            st = 8;
        } else {
            st = 5;
        }
