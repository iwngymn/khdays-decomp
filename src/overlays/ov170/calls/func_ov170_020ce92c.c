...
extern void func_ov170_020cea18(void);
extern void func_ov170_020cec04(void);
extern void func_ov170_020ceca4(void);
void func_ov170_020ce92c(int *node) {
    ...
    *(struct blk16 *)(state + 0x1d) = *(struct blk16 *)(state + 0x19);
    func_0203c634(node, 0, func_ov170_020cea18);
    func_0203c634(node, 1, func_ov170_020ceca4);
    func_0203c634(node, 2, func_ov170_020cec04);
}
