...
extern void func_ov223_020d13e8(void);
extern void func_ov223_020d170c(void);
void func_ov223_020d1300(int self) {
    int *obj = *(int **)(self + 4);
    int i = 0;
    ...
    *(char *)(*obj + 0x40c) = -1;
    ...
    func_0203c634(self, 0, &func_ov223_020d13e8);
    func_0203c634(self, 2, &func_ov223_020d170c);
}
