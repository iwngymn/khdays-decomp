...
extern struct Ov047Descriptor data_ov039_020b55a4;
extern struct Ov047Descriptor data_ov039_020b55b4;

u8 func_ov039_020b3ca8(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov039_020b55a4.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov039_020b55b4.bytes, self->slot09, 1,
