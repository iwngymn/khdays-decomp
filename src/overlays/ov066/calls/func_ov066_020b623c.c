/* Creates the ov066 panel's sub-object: allocates it from the default expanding heap,
...
extern int data_ov066_020b6b54;

void func_ov066_020b623c(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x30);
    ...
    func_ov022_02091298(*(void **)(self + 0x2000 + 0x644), self,
                        &data_ov066_020b6b54, cfg, 2, 0xa);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x20) =
        (void *)&func_ov066_020b6398;
}
