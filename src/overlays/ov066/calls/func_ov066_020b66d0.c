/* Per-frame update for the ov066 panel. Raises the two visibility flag pairs while the
...
extern void func_ov066_020b6454(char *self);
...
int func_ov066_020b66d0(char *self)
{
    struct VecFx32 vDelta;
    struct VecFx32 vTmp;
    int nRet = 0;
    char *blk = data_ov066_020b6b80 + 0xc50 + 0x2000;
    int nEnergy;
    int nLimit;
    int *pLink;
    int nZero;
