...
extern void func_ov168_020d444c(void);
extern void func_ov168_020d4638(void);
extern void func_ov168_020d46d8(void);
void func_ov168_020d4360(int *node) {
    ...
    *(struct blk16 *)(state + 0x1d) = *(struct blk16 *)(state + 0x19);
    func_0203c634(node, 0, func_ov168_020d444c);
    func_0203c634(node, 1, func_ov168_020d46d8);
    func_0203c634(node, 2, func_ov168_020d4638);
}
