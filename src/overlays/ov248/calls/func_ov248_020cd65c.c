/* func_ov248_020cd65c -- the move dispatcher: play whatever move was queued at ctx[0]+0x1c7, then
...
extern void func_ov248_020cd9f0(void);
extern void func_ov248_020cdae4(void);
extern void func_ov248_020cddf0(void);
extern void func_ov248_020cdfbc(void);
extern void func_ov248_020ce4c0(void);
extern void func_ov248_020ceae0(void);
extern void func_ov248_020cee90(void);
extern void func_ov248_020cf130(void);
extern void func_ov248_020cf33c(void);
extern void func_ov248_020cf634(void);
extern void func_ov248_020cfc64(void);
extern void func_ov248_020cfeb8(void);
extern void func_ov248_020cffa0(void);
extern void func_ov248_020d00fc(void);

void func_ov248_020cd65c(int self) {
    int *ctx;
    int move;
    ...
    if (move != -1) {
        ...
        case 0:
            func_0203c634(self, 1, func_ov248_020cd9f0);
            break;
        case 1:
            func_0203c634(self, 1, func_ov248_020cdae4);
            break;
        case 2:
            func_0203c634(self, 1, func_ov248_020cddf0);
            break;
        case 4:
            func_0203c634(self, 1, func_ov248_020cdfbc);
            break;
        case 5:
            func_0203c634(self, 1, func_ov248_020ce4c0);
            break;
        case 6:
            func_0203c634(self, 1, func_ov248_020ceae0);
            break;
        case 7:
            func_0203c634(self, 1, func_ov248_020cee90);
            break;
        case 8:
            func_0203c634(self, 1, func_ov248_020cf130);
            break;
        case 9:
            func_0203c634(self, 1, func_ov248_020cf33c);
            break;
        case 10:
            func_0203c634(self, 1, func_ov248_020cf634);
            break;
        case 11:
            func_0203c634(self, 1, func_ov248_020cfc64);
            break;
        case 3:
            func_0203c634(self, 1, func_ov248_020cfeb8);
            break;
        case 12:
            func_0203c634(self, 1, func_ov248_020cffa0);
            break;
        case 13:
            func_0203c634(self, 1, func_ov248_020d00fc);
            break;
        }
    }
