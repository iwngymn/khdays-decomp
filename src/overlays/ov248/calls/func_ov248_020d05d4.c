...
extern void func_ov248_020d067c(void);
extern void func_ov248_020d0714(void);
extern void func_ov248_020d06f4(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov248_020d05d4(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov248_020d067c);
    func_0203c634(param_1, 1, (void *)&func_ov248_020d0714);
    func_0203c634(param_1, 2, (void *)&func_ov248_020d06f4);
}
