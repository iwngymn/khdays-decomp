 ...
 * triple (param_5..7) into owner fields +0x394/+0x39c/+0x3a0, and set owner hw60 hi bit 1. */
...
void func_ov230_020d5c58(int param_1, struct vec v, struct vec v2) {
    func_ov107_020c5c54(param_1, &v);
    *(struct vec *)(param_1 + 0x394) = v2;
    {
