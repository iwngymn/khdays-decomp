...
extern u8 func_ov035_020b39a8(struct Runtime *);
extern int func_ov035_020b446c(int *);
...
void func_ov035_020b32a0(struct InitConfig *cfg) {
    struct OpenParams p;
    ...
    *(long long *)obj = 0;
    ...
    func_0202b914(*(signed char *)(obj + 0x4bc), data_ov035_020b4c1c,
                  1, cfg->type + 7);

    *(void **)(obj + 0x664) = (void *)&func_ov035_020b355c;
    *(void **)(obj + 0x668) = (void *)&func_ov035_020b36e0;
    *(void **)(obj + 0x66c) = (void *)&func_ov035_020b37ec;
    *(void **)(obj + 0x670) = 0;
    *(void **)(obj + 0x674) = 0;
    *(void **)(obj + 0x678) = (void *)&func_ov035_020b34d0;
    *(void **)(obj + 0x67c) = (void *)&func_ov035_020b353c;
    *(void **)(obj + 0x684) = (void *)&func_ov035_020b3824;

    mode = func_02020a9c();
    if (mode != 0x2a) {
        *(SetupHandler *)(obj + 0x68c) = func_ov035_020b39a8;
    } else {
        *(SetupHandler *)(obj + 0x68c) = 0;
    }
    *(StateHandler *)(obj + 0x688) = func_ov035_020b446c;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b ? func_02016f10((void *)b, data_ov035_020b4bbc) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b ? func_02016f10((void *)b, data_ov035_020b4bcc) : -1;
    b = bone(obj);
    *(int *)(obj + 0x514) = b ? func_02016f10((void *)b, data_ov035_020b4bac) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b ? func_02016f10((void *)b, data_ov035_020b4b8c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b ? func_02016f10((void *)b, data_ov035_020b4b9c) : -1;
