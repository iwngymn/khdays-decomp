...
extern void func_ov245_020d23b8(void);
extern void func_ov245_020d2434(void);
void func_ov245_020d2268(int param_1) {
    ...
    if (v != -1) {
        ...
        case 0:
            ...
            break;
        case 1:
            func_0203c634(param_1, 1, (void *)&func_ov245_020d2434);
            break;
        }
    }
