...
extern void func_ov245_020d5e44(void);
extern void func_ov245_020d5fe4(void);

void func_ov245_020d5d8c(int self) {
    int *obj = *(int **)(self + 4);
    unsigned short w;
    ...
    func_0203c634(self, 0, &func_ov245_020d5e44);
    func_0203c634(self, 2, &func_ov245_020d5fe4);
}
