...
extern void func_ov245_020d16d8(void);
extern void func_ov245_020d1798(void);
extern void func_ov245_020d1780(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov245_020d1630(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov245_020d16d8);
    func_0203c634(param_1, 1, (void *)&func_ov245_020d1798);
    func_0203c634(param_1, 2, (void *)&func_ov245_020d1780);
}
