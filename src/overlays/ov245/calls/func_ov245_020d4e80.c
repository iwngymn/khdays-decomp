...
extern void func_ov245_020d4f14(int);
extern void func_ov245_020d4fd4(int);
struct node60_020d5f60 { unsigned short lo : 8; unsigned short hi : 8; };
void func_ov245_020d4e80(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov245_020d4f14);
    func_0203c634(param_1, 1, (void *)&func_ov245_020d4fd4);
}
