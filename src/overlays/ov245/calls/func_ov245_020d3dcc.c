...
extern int func_ov245_020d3e74(int);
extern int func_ov245_020d3f84(int);
extern int func_ov245_020d3f34(int);
void func_ov245_020d3dcc(int param_1) {
    ...
    *(int *)(owner + 0xc) = *(int *)owner + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov245_020d3e74);
    func_0203c634(param_1, 1, (void *)&func_ov245_020d3f84);
    func_0203c634(param_1, 2, (void *)&func_ov245_020d3f34);
}
