...
extern void func_ov245_020d0cf8(void);
extern void func_ov245_020d0de4(void);
extern void func_ov245_020d0d70(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov245_020d0c50(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov245_020d0cf8);
    func_0203c634(param_1, 1, (void *)&func_ov245_020d0de4);
    func_0203c634(param_1, 2, (void *)&func_ov245_020d0d70);
}
