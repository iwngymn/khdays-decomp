...
extern void func_ov245_020d2f5c(void);
extern void func_ov245_020d2fec(void);
extern void func_ov245_020d2fd4(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov245_020d2eb4(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov245_020d2f5c);
    func_0203c634(param_1, 1, (void *)&func_ov245_020d2fec);
    func_0203c634(param_1, 2, (void *)&func_ov245_020d2fd4);
}
