 ...
 * -- the vector at state[0x12] with y raised by 0x2400 -- to the render hook and latch the pending
 ...
 * Written as `v.x = p[0]; v.y = p[1] + 0x2400; v.z = p[2];` the loads stay split and nine
...
void func_ov279_020d0dec(int *self) {
