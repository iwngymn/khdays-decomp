...
extern void func_ov192_020d28f4(void);
extern void func_ov192_020d2b94(void);
extern void func_ov192_020d2aec(void);

void func_ov192_020d27fc(int *node) {
    ...
    func_0203c634(node, 0, func_ov192_020d28f4);
    func_0203c634(node, 1, func_ov192_020d2b94);
    func_0203c634(node, 2, func_ov192_020d2aec);
}
