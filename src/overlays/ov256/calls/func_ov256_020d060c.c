...
extern void func_ov256_020d06b4(void);
extern void func_ov256_020d079c(void);
extern void func_ov256_020d072c(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov256_020d060c(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov256_020d06b4);
    func_0203c634(param_1, 1, (void *)&func_ov256_020d079c);
    func_0203c634(param_1, 2, (void *)&func_ov256_020d072c);
}
