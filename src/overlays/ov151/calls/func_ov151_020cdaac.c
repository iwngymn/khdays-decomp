...
extern void func_ov151_020cdb80(void);
extern void func_ov151_020cdd08(void);

void func_ov151_020cdaac(int *node) {
    ...
    func_0203c634(node, 0, func_ov151_020cdb80);
    func_0203c634(node, 2, func_ov151_020cdd08);
}
