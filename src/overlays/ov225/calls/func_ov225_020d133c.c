...
extern void func_ov225_020d1424(void);
extern void func_ov225_020d1764(void);
void func_ov225_020d133c(int self) {
    int *obj = *(int **)(self + 4);
    int i = 0;
    ...
    *(char *)(*obj + 0x40c) = -1;
    ...
    func_0203c634(self, 0, &func_ov225_020d1424);
    func_0203c634(self, 2, &func_ov225_020d1764);
}
