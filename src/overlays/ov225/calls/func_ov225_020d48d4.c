...
extern void func_ov225_020d497c(void);
extern void func_ov225_020d4a54(void);
extern void func_ov225_020d49f4(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov225_020d48d4(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov225_020d497c);
    func_0203c634(param_1, 1, (void *)&func_ov225_020d4a54);
    func_0203c634(param_1, 2, (void *)&func_ov225_020d49f4);
}
