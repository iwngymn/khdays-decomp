/* func_ov225_020d4b14 -- enter the charge state: reset the flags and the timers, snapshot the
 * anchor position, then branch on ctx[0x16] to one of two charge profiles.
 *
 * One of a 4-member shape family; the twins live in ov221/ov222/ov224 and are byte-identical
 ...
 *                     rand(0x1000) + 0x2000 at ctx[0x15]; continues at func_ov225_020d4e8c
 *   ctx[0x16] == 1 -> anim 0x600, reach 0x700, 0x32000, no random hold;
 *                     continues at func_ov225_020d4fc0
...
extern void func_ov225_020d4e8c(void);
extern void func_ov225_020d4fc0(void);

void func_ov225_020d4b14(int self) {
    int *ctx;
    u16 v;
    int p;
    ...
    *(signed char *)((int)ctx + 0x64) = 0;
    ...
    case 0:
        *(int *)(ctx[0] + 0x70) = 0x432;
        ...
        ctx[0x14] = 0x400;
        func_0203c634(self, *(signed char *)(self + 0x20), func_ov225_020d4e8c);
        break;
    case 1:
        *(int *)(ctx[0] + 0x70) = 0x600;
        ...
        ctx[0x12] = 0x700;
        ctx[0x13] = 0x32000;
        func_0203c634(self, *(signed char *)(self + 0x20), func_ov225_020d4fc0);
        break;
    }
}
