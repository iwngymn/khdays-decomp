/*
 * func_ov287_020d0304 -- Ov287_Actor_ResolveHit.
 *
 * Hit resolution handler installed in the +0x1d0 slot by func_ov287_020cfc04, shared with
...
extern const struct ImpactIdPairs data_ov287_020d16d4;

int func_ov287_020d0304(struct Actor *actor, void *other, struct HitEvent *event)
{
    struct ImpactIdPairs ids;
    struct HitState *st;

    st = actor->pHitState214;
    ids.alternate = data_ov287_020d16d4.alternate;
    ids.normal = data_ov287_020d16d4.normal;
