/*
 * func_ov271_020d0d00 -- x3. AI-state tick: wait out a timer, aim at the target, fire, reroll a delay.
...
extern void func_ov271_020d0dfc(void);

void func_ov271_020d0d00(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov271_020d0dfc);
}
