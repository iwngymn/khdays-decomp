...
extern void func_ov156_020cc9c4(void *state, void *p);
extern long long func_01ff8a14(int a, int b);
extern void func_ov156_020ccaa8(void *state, int a, int b, void *p);
extern int func_02023eb4(int);
extern void func_0203c634(void *obj, int idx, void *value);

void func_ov156_020cdd6c(int *node) {
    int a = node[0];
    int *state = (int *)node[1];
    state[0xb] += *(int *)(a + 0x2c);
    if (*(unsigned char *)((char *)state + 0x38) == 0) {
        if (state[0xb] >= 0x4cc) {
            func_ov156_020cc9c4(state, (char *)state + 0x20);
    ...
    if (state[0xb] >= 0x4cc && state[0xb] <= 0xbba) {
        ...
        func_ov156_020ccaa8(state, (int)res, (int)(res >> 32), (char *)state + 0x20);
    }
