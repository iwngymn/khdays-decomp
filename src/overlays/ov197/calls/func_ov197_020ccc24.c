...
extern void func_ov197_020cccdc(void);
extern void func_ov197_020cce64(void);

void func_ov197_020ccc24(int self) {
    int *obj = *(int **)(self + 4);
    unsigned short w;
    ...
    func_0203c634(self, 1, &func_ov197_020ccf48);
    func_0203c634(self, 0, &func_ov197_020cccdc);
    func_0203c634(self, 2, &func_ov197_020cce64);
}
