...
extern void func_ov136_020d234c(void);
extern void func_ov136_020d24f4(void);

void func_ov136_020d2288(int *node) {
    ...
    func_0203c634(node, 0, func_ov136_020d234c);
    func_0203c634(node, 2, func_ov136_020d24f4);
}
