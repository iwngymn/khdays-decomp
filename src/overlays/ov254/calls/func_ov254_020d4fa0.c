...
extern void func_ov254_020d5048(void);
extern void func_ov254_020d5190(void);
extern void func_ov254_020d50f0(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov254_020d4fa0(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov254_020d5048);
    func_0203c634(param_1, 1, (void *)&func_ov254_020d5190);
    func_0203c634(param_1, 2, (void *)&func_ov254_020d50f0);
}
