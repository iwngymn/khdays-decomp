...
extern void func_ov254_020d24bc(void);
extern void func_ov254_020d2564(void);
extern void func_ov254_020d2560(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov254_020d2414(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov254_020d24bc);
    func_0203c634(param_1, 1, (void *)&func_ov254_020d2564);
    func_0203c634(param_1, 2, (void *)&func_ov254_020d2560);
}
