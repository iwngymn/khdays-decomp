...
struct ov165_LowByteFlags {
    unsigned bits : 8;
};

void func_ov165_020d45f8(int *node) {
    int *state = (int *)node[1];
    ((struct ov165_Hw60 *)(*state + 0x60))->hi &= ~1;
    ...
    ((struct ov165_LowByteFlags *)(*(int *)(*state + 0x388) + 8))->bits &= ~1;
    func_ov107_020c5af8(*state, 0, 0x49, state[21]);
