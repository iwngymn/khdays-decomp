...
extern void func_ov276_020d1160(int);
extern void func_ov276_020d0e28(int);
extern void func_ov276_020d0fc8(int);
void func_ov276_020d0d98(int param_1) {
    ...
    *(int *)(child + 0xc) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 1, (void *)&func_ov276_020d1160);
    func_0203c634(param_1, 0, (void *)&func_ov276_020d0e28);
    func_0203c634(param_1, 2, (void *)&func_ov276_020d0fc8);
}
