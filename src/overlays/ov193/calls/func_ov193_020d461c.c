...
extern void func_ov193_020d4714(void);
extern void func_ov193_020d49b4(void);
extern void func_ov193_020d490c(void);

void func_ov193_020d461c(int *node) {
    ...
    func_0203c634(node, 0, func_ov193_020d4714);
    func_0203c634(node, 1, func_ov193_020d49b4);
    func_0203c634(node, 2, func_ov193_020d490c);
}
