...
extern void func_ov193_020d6158(void);

struct hw60 { unsigned short lo : 8, hi : 8; };
struct ov193_LowByteFlags { unsigned bits : 8; };
struct vec3 { int a, b, c; };

void func_ov193_020d6070(int *node) {
