...
extern void func_ov216_020cce54(struct Ov214State *state, unsigned int kind,
                                struct Ov214Params *params);
extern void func_ov216_020ce5f0(void);
...
void func_ov216_020cdf6c(struct Ov214Task *task)
{
    ...
    if (state->nPhase6e >= state->nPhaseMax6f) {
        ...
        state->nCallback50 = 0;
        state->bEffect70 = 0;
        func_0203c634(task, task->nSlot20, func_ov216_020ce5f0);
        return;
    }
