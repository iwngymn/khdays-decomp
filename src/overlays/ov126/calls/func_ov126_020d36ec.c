...
extern void func_ov126_020d3794(void);
extern void func_ov126_020d3824(void);
extern void func_ov126_020d380c(void);

struct hi_flags_020cfaac { unsigned short pad : 8; unsigned short flags : 8; };

void func_ov126_020d36ec(int param_1) {
    ...
    *(int *)(child + 8) = *(int *)child + 0xb0;
    ...
    func_0203c634(param_1, 0, (void *)&func_ov126_020d3794);
    func_0203c634(param_1, 1, (void *)&func_ov126_020d3824);
    func_0203c634(param_1, 2, (void *)&func_ov126_020d380c);
}
