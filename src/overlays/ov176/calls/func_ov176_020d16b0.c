...
extern int func_ov176_020d06dc(int self, void *out);
...
extern int func_ov176_020d0774(int self);
extern int data_02042264;

void func_ov176_020d16b0(int *self) {
    ...
    mag = func_ov176_020d06dc((int)self, v1);
    if (mag > 0x100) {
        mag = 0x180;
    }
    ...
    if (counter <= 0) {
        ...
        state[0x17] = 0;
        if (roll < 0x3c && func_ov176_020d0774((int)self) != 0) {
            st = 8;
        } else {
            st = 5;
        }
