...
extern void func_ov046_020b3508(void);
extern void func_ov046_020b362c(void);
extern void func_ov046_020b38b8(void);
extern void func_ov046_020b3488(void);
extern void func_ov046_020b34f4(void);
extern void func_ov046_020b3770(void);
extern void func_ov046_020b38ec(void);
extern void func_ov046_020b462c(void);
...
void func_ov046_020b3290(struct PanelInitConfig *config)
{
    ...
    *(long long *)object = 0;
    ...
    func_0202b914(*(signed char *)(object + 0x4bc), (void *)data_ov046_020b4ac8, 1,
                  config->objectType + 7);

    *(void **)(object + 0x664 + 0x00) = (void *)&func_ov046_020b3508;
    *(void **)(object + 0x664 + 0x04) = (void *)&func_ov046_020b362c;
    *(void **)(object + 0x664 + 0x08) = (void *)&func_ov046_020b38b8;
    *(void **)(object + 0x664 + 0x0c) = 0;
    *(void **)(object + 0x664 + 0x10) = 0;
    *(void **)(object + 0x664 + 0x14) = (void *)&func_ov046_020b3488;
    *(void **)(object + 0x664 + 0x18) = (void *)&func_ov046_020b34f4;
    *(void **)(object + 0x664 + 0x20) = (void *)&func_ov046_020b3770;
    *(void **)(object + 0x664 + 0x28) = (void *)&func_ov046_020b38ec;
    *(void **)(object + 0x664 + 0x24) = (void *)&func_ov046_020b462c;
...
test:
    ...
    *(int *)(object + 0x520) = bone != 0
        ? func_02016f10((void *)bone, &data_ov046_020b4a68) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x518) = bone != 0
        ? func_02016f10((void *)bone, &data_ov046_020b4a58) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x51c) = bone != 0
        ? func_02016f10((void *)bone, &data_ov046_020b4a78) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x524) = bone != 0
        ? func_02016f10((void *)bone, &data_ov046_020b4a88) : -1;
