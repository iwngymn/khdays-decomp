/* func_ov138_020d2ad4 -- c634 handler: arm the owner for a dash/lunge and hand off to func_ov138_020d2ba8.
 *
...
extern void func_ov138_020d2ba8(void);
void func_ov138_020d2ad4(int self) {
    int *obj = *(int **)(self + 4);
    int *dst = obj + 5;
    obj[9] = 0;
    obj[10] = 0;
    ...
    *(struct vec *)(obj + 5) = *(struct vec *)(*obj + 0x394);
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov138_020d2ba8);
}
