/*
 * func_ov138_020d133c -- x3. AI-state tick: face the acquired target, set the aim rate, dispatch.
...
extern void func_ov138_020d1428(void);

void func_ov138_020d133c(int *self) {
    ...
    *(unsigned short *)(*state + 0x1b0) |= 0xc;
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov138_020d1428);
}
