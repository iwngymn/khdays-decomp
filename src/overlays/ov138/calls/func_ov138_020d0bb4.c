/*
 * func_ov138_020d0bb4 -- x3. AI-state entry: reconfigure flags, spawn effect 0x48, dispatch.
...
extern void func_ov138_020d0c7c(void);

void func_ov138_020d0bb4(int *self) {
    ...
    *hw = h & ~0xff00 | (((((unsigned int)h << 0x10) >> 0x18 | 0x80) << 0x18) >> 0x10);
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov138_020d0c7c);
}
