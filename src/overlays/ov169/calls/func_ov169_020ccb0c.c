...
extern void func_ov169_020ccbf8(void);
extern void func_ov169_020ccde4(void);
extern void func_ov169_020cce84(void);
void func_ov169_020ccb0c(int *node) {
    ...
    *(struct blk16 *)(state + 0x1d) = *(struct blk16 *)(state + 0x19);
    func_0203c634(node, 0, func_ov169_020ccbf8);
    func_0203c634(node, 1, func_ov169_020cce84);
    func_0203c634(node, 2, func_ov169_020ccde4);
}
