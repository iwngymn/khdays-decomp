 ...
 * and one against the model of the object it is attached to -- clears the 0xcd-byte
...
extern struct Ov047Descriptor data_ov058_020b7da4;
extern struct Ov047Descriptor data_ov058_020b7db4;

u8 func_ov058_020b64a8(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov058_020b7da4.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov058_020b7db4.bytes, self->slot09, 1,
        &self->attach2644->model0c->field28);
    func_ov022_020b1cec((char *)self + 0xda0, 0xcd);
