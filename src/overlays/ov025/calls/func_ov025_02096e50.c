/* func_ov025_02096e50 -- Ov008_UpdateGridDrag: one step of dragging a node with
...
void func_ov025_02096e50(Ov008MenuContext *pCtx)
{
    u16 nCol;
    u16 nRow;
    ...
    if (func_ov025_02094618(&nCol, &nRow, pCtx->nDragX, pCtx->nDragY) != 0) {
        pCtx->nColumn = nCol;
        pCtx->nRowSel = nRow;
        if (func_ov025_02093d0c(pCtx, 0) != 0) {
