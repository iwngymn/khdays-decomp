/* func_ov025_0209522c -- Ov008_ShowGridPage: make page nPage of the grid
...
extern const Ov008PageTags3 data_ov025_020b3cf8;
extern const Ov008PageTags2 data_ov025_020b3c9c;
extern int   func_ov025_02084a50(void);                                  /* Ov008_GetCtxBlock9500 */
extern void *func_ov025_020894b0(int nTracker, u32 nTag);                /* ov008_FindEntryByTag */
...
void func_ov025_0209522c(Ov008MenuContext *pCtx, int nPage, int bSound)
{
    ...
    tags3 = data_ov025_020b3cf8;
    tags2 = data_ov025_020b3c9c;
    nTracker = func_ov025_02084a50();
    switch (pCtx->nPageCount) {
    case 1:
        break;
    case 3:
        func_ov025_02089544(nTracker, func_ov025_020894b0(nTracker, (u16)tags3.aHide[pCtx->nVisiblePage]));
        func_ov025_02089544(nTracker, func_ov025_020894b0(nTracker, (u16)tags3.aShow[nPage]));
        break;
    case 2:
        func_ov025_02089544(nTracker, func_ov025_020894b0(nTracker, (u16)tags2.aHide[pCtx->nVisiblePage]));
        func_ov025_02089544(nTracker, func_ov025_020894b0(nTracker, (u16)tags2.aShow[nPage]));
        break;
    }
    ...
    for (nRow = 0; nRow < GRID_ROWS; nRow++) {
        for (nCol = 0; nCol < GRID_COLS; nCol++) {
            ...
            if (pCtx->aGrid[nPage][nRow][nCol] == GRID_ID_LOCKED) {
                pCell->isActive = 1;
                func_ov025_0208a5f8(pCell->aTexParams, func_ov025_0208ffc4(pCtx, TAG_LOCKED)->pTexture);
            } else if (pCtx->apPageSlot[nPage][nCell] == 0) {
                pCell->isActive = 0;
            } else {
                pCell->isActive = 1;
                func_ov025_0208a5f8(pCell->aTexParams, func_ov025_0208ffc4(pCtx, pCtx->apPageSlot[nPage][nCell]->nTag)->pTexture);
            }
        }
    }
