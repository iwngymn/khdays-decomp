/* func_ov025_02096ce0 -- Ov008_UpdateKnobDrag: one step of dragging the
...
extern void func_ov025_020918d8(Ov008MenuContext *pCtx, int nPos, int nBase, int nRows, int nRange); /* eased scroll */
...
void func_ov025_02096ce0(Ov008MenuContext *pCtx)
{
    ...
    if (touch.nTouching != 0) {
        ...
        case LIST_MODE_PAGE:
            ...
            nRange = KNOB_RANGE;
            nRows = VISIBLE_ROWS;
            pfnHighlight = func_ov025_020915d4;
            break;
        case LIST_MODE_BUSY:
            pCtx->bDrag = 0;
            return;
        ...
        func_ov025_020918d8(pCtx, nPos, nBase, nRows, nRange);
        nSelected = *pSelected;
        switch (pCtx->nListMode) {
        case LIST_MODE_PAGE:
