/* func_ov025_02094988 -- Ov008_MoveGridCursor: put the grid cursor on cell
...
extern UiLayoutPos *func_ov025_020884c8(int nCtx, void *pEntry);                 /* Ov008_GetEntryPos */
...
extern void *func_ov025_020b35d0(int *pList, Ov008Message15Record *pRecord);     /* text of a record */
extern void *func_ov025_020922fc(Ov008MenuContext *pCtx, u32 nPage, u32 nCol, u32 nRow); /* Ov008_FindGridHit */
extern int   func_ov025_02094724(Ov008MenuContext *pCtx, Ov008ShapeEntry *pEntry, void *pHit, int nDx, int nDy); /* Ov008_DrawCardCountAndIcons */
...
extern int   func_ov025_020967d4(Ov008MenuContext *pCtx);                        /* the cursor cell can be filled */
...
int func_ov025_02094988(Ov008MenuContext *pCtx, int nCol, int nRow, int nStep)
{
    UiLayoutPos pos = {0, 0};
    void *pAnchor;
    int nDx;
    ...
    pAnchor = func_ov025_0208843c(nCtx, WIDGET_ANCHOR);
    pos.nX = nCol << 16;
    pos.nY = nRow << 16;
    ...
    func_ov025_02088564(nCtx, pAnchor, &pos);
    pAnchorPos = func_ov025_020884c8(nCtx, pAnchor);
    pos.nX = pAnchorPos->nX + 0x6000;
    pos.nY = pAnchorPos->nY - 0xd000;
    func_ov025_02088500(nCtx, func_ov025_0208843c(nCtx, WIDGET_CURSOR_A), &pos);
    func_ov025_02088500(nCtx, func_ov025_0208843c(nCtx, WIDGET_CURSOR_B), &pos);
    ...
    if (func_ov025_02094724(pCtx, pShape, pHit, nDx, nDy) != 0) {
        func_ov025_0208884c(nCtx, func_ov025_0208843c(nCtx, WIDGET_CURSOR_B), 0);
        ...
        if (nStep != 0 && pCtx->pListNode != 0) {
            if (pCtx->pCountText != 0) {
                func_ov025_02091070(pCtx, 0, pCtx->pCountText, COLOUR_COUNT);
            }
            func_ov025_0208884c(nCtx, func_ov025_0208843c(nCtx, WIDGET_CURSOR_A), 0);
            func_ov025_0208884c(nCtx, func_ov025_0208843c(nCtx, WIDGET_CURSOR_B), 1);
        }
    ...
    } else if (func_ov025_020967d4(pCtx) != 0) {
    ...
    pSlotWidget = func_ov025_0208843c(nCtx, WIDGET_SLOT);
    if (pRecord != 0 && pRecord->nPlacedSlot >= 0) {
        func_ov025_0208884c(nCtx, pSlotWidget, 1);
        func_ov025_02088928(nCtx, pSlotWidget, (u16)pRecord->nPlacedSlot);
    } else {
        func_ov025_0208884c(nCtx, pSlotWidget, 0);
    }
    return 1;
}
