/* func_ov025_020956f8 -- Ov008_EnterMenuState: put the grid menu into state
...
void func_ov025_020956f8(Ov008MenuContext *pCtx, int nState)
{
    UiLayoutPos pos = { 0, 0 };
    int nCtx;
    void *pEntry;
    ...
    pEntry = func_ov025_0208843c(nCtx, WIDGET_DRAG);
    ...
    case STATE_GRID:
        ...
        func_ov025_020887c0(nCtx, pEntry, 0);
