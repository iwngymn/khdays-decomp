/* func_ov025_0209446c -- Ov008_RemoveGridNode: take the entry out of page
...
int func_ov025_0209446c(Ov008MenuContext *pCtx, u32 nPage, u32 nCol, u32 nRow, int bSilent)
{
    ...
    if (bSilent == 0 && pCtx->nBusy == 0) {
        func_ov025_02090d04(pCtx, (*pSlot)->nItemId, -1);
    ...
    *pSlot = 0;
    pNode = func_ov025_020922fc(pCtx, nPage, nCol, nRow);
    if (pNode != 0) {
