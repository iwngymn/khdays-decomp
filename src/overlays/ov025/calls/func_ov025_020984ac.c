/* func_ov025_020984ac -- Ov008_MenuKeyUp: the menu's "up" key handler.
 ...
 * cursor one row up (func_ov025_02094988) and, if that took, arms the move,
...
void func_ov025_020984ac(Ov008MenuContext *pCtx)
{
    u16 touch[3];
    ...
    case 2:
        ...
        if (func_ov025_020947b4(pCtx, (int)(func_02020400(pCtx->nPage + pCtx->nPageCount - 1, pCtx->nPageCount) >> 32)) == 0) {
            return;
        }
