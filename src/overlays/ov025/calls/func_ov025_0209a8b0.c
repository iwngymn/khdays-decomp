/* func_ov025_0209a8b0 -- Ov008_StepSaveSlotLoad: drive one save slot's load
...
extern void func_ov025_02099b74(Ov008SaveMenu *pMenu, int nSlot);             /* start the slot read */
extern int func_ov025_02099a94(Ov008SaveMenu *pMenu, int nSlot, int nPhase, int nArg); /* poll the slot read */
extern void func_ov025_0209a74c(Ov008SaveMenu *pMenu, int nSlot, int nResult); /* Ov008_BuildSaveSlotEntry */

u8 func_ov025_0209a8b0(Ov008SaveMenu *pMenu, int nSlot, int nUnused, int nArg)
{
    int nResult;
    u8 nPhase;
    ...
    case LOAD_PHASE_START:
        ...
        func_ov025_02099b74(pMenu, nSlot);
        pMenu->nLoadPhase = LOAD_PHASE_WAIT;
        break;
    case LOAD_PHASE_WAIT:
        nResult = func_ov025_02099a94(pMenu, nSlot, nPhase, nArg);
        if (nResult == READ_NO_CARD) {
            ...
            func_ov025_0209a74c(pMenu, nSlot, nResult);
            pMenu->nLoadPhase = LOAD_PHASE_DONE;
        }
        break;
    }
