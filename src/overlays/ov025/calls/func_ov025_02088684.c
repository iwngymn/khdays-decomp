...
extern Point *func_ov025_020884c8(int owner, Ov008ListEntry *entry);
...
void func_ov025_02088684(int owner, int xOffset, int clearBase)
{
    Point finalPosition;
    Point basePosition;
    ...
    do {
        if (((entry->flags << 28) >> 31) == 0) {
            ...
            currentPosition = func_ov025_020884c8(owner, entry);
