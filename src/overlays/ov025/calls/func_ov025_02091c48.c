/* func_ov025_02091c48 -- Ov008_InitGridMenuSurfaces: create the grid menu's
...
extern const TileSurfaceCfg data_ov025_020b3da8;
...
extern void  func_ov025_02091b18(Ov008MenuContext *pCtx, void *pRecords, int nRow); /* Ov008_DrawTextRow */

void func_ov025_02091c48(Ov008MenuContext *pCtx)
{
    ...
    cfgPanelA = data_ov025_020b3da8;
    cfgPanelB = data_ov025_020b3dd0;
    cfgCursor = data_ov025_020b3df8;
    rows = data_ov025_020b3f80;
    func_ov025_0208985c(pCtx->records, data_ov025_020b4dbc);
    cfgPanelA.nVramTarget = func_ov025_02084aa4(SLOT_PANEL);
    cfgPanelA.pPixels = func_ov025_02084c84();
    func_0202ff98(&pCtx->panelSurfaceA, &cfgPanelA);
    cfgPanelB.nVramTarget = func_ov025_02084aa4(SLOT_PANEL);
    cfgPanelB.pPixels = func_ov025_02084c84();
    func_0202ff98(&pCtx->panelSurfaceB, &cfgPanelB);
    pCtx->panelSurfaceB.bDirty = 4;
    cfgCursor.nVramTarget = func_ov025_02084aa4(SLOT_ROWS);
    cfgCursor.pPixels = func_ov025_02084c84();
    func_0202ffb0(&pCtx->cursorSurface, &cfgCursor);
    pCtx->cursorSurface.bDirty = 2;
    pFile = func_0201ef9c(func_ov025_02084d18(ARCHIVE_MEMBER_FONT), HEAP_FILE);
    ...
    for (i = 0; i < ROW_COUNT; i++) {
        pCfg->nVramTarget = func_ov025_02084aa4(SLOT_ROWS);
        pCfg->pPixels = func_ov025_02084c84();
        func_0202ffb0(pSurface, pCfg);
        func_ov025_02091b18(pCtx, pCtx->records, i);
        pCfg++;
        pSurface++;
    }
}
