/* func_ov025_020ab7b0 -- Ov008_LayoutMissionBadges: place the mission
...
extern const Ov008SlotTags data_ov025_020b47ec;
extern const Ov008RankTags data_ov025_020b46d8;
...
extern void  func_ov025_020a9aa0(int nOwner, u32 nTag, short nX, short nY); /* Ov008_SetTagValueDup */
extern void  func_ov025_020a9b1c(int nOwner, u32 nTag, short nX, short nY); /* Ov008_SetTagValueAndNotify */
extern u32   func_020235d0(int nField, int nBits);                       /* GameState_GetField */
extern u32   func_ov025_020ab748(Ov008MissionMenu *pMenu, u32 nWord);    /* Ov008_BuildRankMask2 */
extern u8    func_ov025_0208df00(Ov008MissionListEntry *pEntry);         /* Ov008_UpdateMissionSummaryTier */
extern int   func_ov025_0208deec(void);                                  /* cleared mission count */
extern void *func_ov025_020894b0(int nOwner, int nTag);                  /* ov008_FindEntryByTag */
extern void  func_ov025_02089544(int nOwner, void *pEntry);              /* Ov008_TagTracker_InvokeCallback */

void func_ov025_020ab7b0(Ov008MissionMenu *pMenu)
{
    Ov008SlotTags tags;
    ...
    if (bUnlocked == 0) {
        func_ov025_020a9aa0(nOwner, TAG_LOCKED, 2, 2);
    } else {
        func_ov025_020a9aa0(nOwner, tags.aTag[pEntry->nTextSlot], 2, 2);
    }
    if (bTransition != 0) {
        if (pMenu->bTransfer != 0) {
            switch (func_020235d0(pEntry->missionId * 3 + FIELD_MISSION_TRANSFER, 3)) {
            case 1:
                func_ov025_020a9aa0(nOwner, TAG_TRANSFER_1, 0x17, 3);
                break;
            case 2:
                func_ov025_020a9aa0(nOwner, TAG_TRANSFER_2, 0x17, 3);
                break;
            case 3:
                func_ov025_020a9aa0(nOwner, TAG_TRANSFER_3, 0x17, 3);
                break;
            case 4:
                func_ov025_020a9aa0(nOwner, TAG_TRANSFER_0, 0x17, 3);
                break;
            case 0:
            default:
                func_ov025_020a9b1c(nOwner, TAG_TRANSFER_0, 0x17, 3);
                break;
            }
        } else {
            nStage = func_020235d0(pEntry->missionId * 3 + FIELD_MISSION_STAGE, 3);
            nY = 0x18 - (nStage - 1);
            func_ov025_020a9b1c(nOwner, TAG_STAGE, 0x15, 3);
            func_ov025_020a9b1c(nOwner, TAG_STAGE, 0x16, 3);
            switch (nStage) {
            case 1:
                func_ov025_020a9aa0(nOwner, TAG_STAGE_1, nY, 3);
                break;
            case 2:
                func_ov025_020a9aa0(nOwner, TAG_STAGE_2, nY, 3);
                break;
            case 3:
                func_ov025_020a9aa0(nOwner, TAG_STAGE, nY, 3);
                break;
            default:
                func_ov025_020a9b1c(nOwner, TAG_STAGE, 0x16, 3);
                break;
        ...
        nMask = func_ov025_020ab748(pMenu, pEntry->nWord);
        nRanks = 0;
        if (nMask & 1) {
            nRanks++;
        }
        ...
        for (i = 0; (int)i < RANK_TILES; i++) {
            ...
            if (nTag != -1) {
                func_ov025_020a9aa0(nOwner, nTag, (short)(i + TILE_X_FIRST), 2);
            } else {
                func_ov025_020a9b1c(nOwner, TAG_RANK_DONE, (short)(i + TILE_X_FIRST), 2);
            }
        }
        func_ov025_020a9b1c(nOwner, TAG_BADGE, 0x16, 3);
        if (pEntry->bSpecial != 0 || (pEntry->nFlags & 2)) {
            bCleared = func_020235d0(pEntry->missionId * 3 + FIELD_MISSION_STATUS, 3) == 3;
            if (bCleared) {
                func_ov025_020a9aa0(nOwner, TAG_BADGE, 0x16, 3);
            } else {
                bStarted = func_020235d0(pEntry->missionId * 3 + FIELD_MISSION_STATUS, 3) >= 2;
                if (bStarted) {
                    func_ov025_020a9aa0(nOwner, TAG_STARTED, 0x16, 3);
                } else {
                    func_ov025_020a9aa0(nOwner, TAG_STARTED_ALT, 0x17, 3);
                }
            }
        } else {
            bCleared = func_020235d0(pEntry->missionId * 3 + FIELD_MISSION_STATUS, 3) == 3;
            if (bCleared) {
                func_ov025_020a9aa0(nOwner, TAG_CLEARED_PLAIN, 0x16, 3);
            } else {
                bStarted = func_020235d0(pEntry->missionId * 3 + FIELD_MISSION_STATUS, 3) >= 2;
                if (bStarted) {
                    func_ov025_020a9aa0(nOwner, TAG_STARTED_PLAIN, 0x16, 3);
                }
            }
        }
        func_ov025_020a9aa0(nOwner, TAG_FOLLOW, 0x17, 1);
    }
    tierTags = data_ov025_020b46d8;
    nTier = func_ov025_0208df00(pEntry);
    nCleared = func_ov025_0208deec();
    ...
    func_ov025_020a9aa0(nOwner, tierTags.aTag[nTier], 0x1c, 3);
    if (nTier == 0) {
        func_ov025_02089544(nOwner, func_ov025_020894b0(nOwner, 0xf));
    } else {
        func_ov025_02089544(nOwner, func_ov025_020894b0(nOwner, 3));
    }
    if (nTier == 0) {
