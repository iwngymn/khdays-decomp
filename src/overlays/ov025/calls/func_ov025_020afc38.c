/* func_ov025_020afc38 -- Ov008_ConfirmPageBSelection: accept the current entry of
...
extern void func_ov025_02084830(int nEntry);               /* Ov008_SetGlobalConfigAndInit */
...
void func_ov025_020afc38(void)
{
    ...
    pPage->bConfirmed = 1;
    if (pPage->nKind != 0) {
        func_ov025_02084798(pPage->nEntry, -1);
    } else {
        func_ov025_02084830(pPage->nEntry);
    }
    func_020235a8(data_ov025_020b5588[pPage->nFlagBase] + FLAG_PAGE_CONFIRM);
