/* func_ov025_020aa298 -- Ov008_DrawMissionInfoLines: draw the mission
...
extern const u16 data_ov025_020b5410[];                                /* blank line */
extern const u16 data_ov025_020b5414[];                                /* record time format */
extern const u16 data_ov025_020b5438[];                                /* record plain format */
extern const u16 data_ov025_020b5444[];                                /* no record format */
...
extern int   func_ov025_020aa168(const u16 *pText);                    /* text height */
...
extern void  func_ov025_020a9858(int nRecord, u8 *pMinutes, u8 *pSeconds, u8 *pFrames); /* split a time record */
...
static inline int Ov008_DrawInfoLine(Ov008MissionMenu *pMenu, int nY, const u16 *pText)
{
    ...
    return func_ov025_020aa168(pText);
}
...
#define Ov008_BeginPrefixedLine(pBuffer)                                        pTail = pBuffer;                                                            func_020200e4(pTail, func_ov025_02089894(pMenu->records, TEXT_PREFIX));     pTail += func_020200c8(pTail)

void func_ov025_020aa298(Ov008MissionMenu *pMenu, volatile Ov008MissionListEntry *pEntry /* khdays: reloaded after every call */, Ov008MissionNameNode *pNode)
{
    u16 aLine[0x80];
    u16 aRecord[0x80];
    u8 nMinutes;
    ...
    if (func_ov025_02084e38() != 0) {
        if (pMenu->bTransfer == 0) {
            nHeight += Ov008_DrawInfoLine(pMenu, nY, func_ov025_02089894(pMenu->records, TEXT_CAPTION_A));
            nY += LINE_STEP;
            if (pEntry->nDuration != 0) {
                Ov008_BeginPrefixedLine(aLine);
                if (pEntry->nDuration >= 60) {
                    func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, TEXT_MINUTES), pEntry->nDuration / 60);
                    pTail += func_020200c8(pTail);
                }
                if (pEntry->nDuration % 60 != 0) {
                    func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, TEXT_SECONDS), pEntry->nDuration % 60);
                    pTail += func_020200c8(pTail);
                }
                func_020200e4(pTail, func_ov025_02089894(pMenu->records, TEXT_DURATION_END));
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aLine);
                nY += LINE_STEP;
            }
            if (pEntry->nEnemies != 0) {
                Ov008_BeginPrefixedLine(aLine);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, TEXT_ENEMIES), pEntry->nEnemies);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aLine);
                nY += LINE_STEP;
            }
            if (pEntry->nInfoFlags & 1) {
                Ov008_BeginPrefixedLine(aLine);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, 0xc), pEntry->nInfoFlags & 1);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aLine);
                nY += LINE_STEP;
            }
            if (pEntry->nInfoFlags & 2) {
                Ov008_BeginPrefixedLine(aLine);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, 0xd), pEntry->nInfoFlags & 2);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aLine);
                nY += LINE_STEP;
            }
            if (pEntry->nInfoFlags & 4) {
                Ov008_BeginPrefixedLine(aLine);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, 0xe), pEntry->nInfoFlags & 4);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aLine);
                nY += LINE_STEP;
            }
            if (pEntry->nStatA != 0) {
                Ov008_BeginPrefixedLine(aLine);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, 0xf), pEntry->nStatA);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aLine);
                nY += LINE_STEP;
            }
            if (pEntry->nStatB != 0) {
                Ov008_BeginPrefixedLine(aLine);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, 0x10), pEntry->nStatB);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aLine);
                nY += LINE_STEP;
            }
            if (pEntry->nStatC != 0) {
                Ov008_BeginPrefixedLine(aLine);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, 0x11), pEntry->nStatC);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aLine);
                nY += LINE_STEP;
            }
            if (pEntry->nStatD != 0) {
                Ov008_BeginPrefixedLine(aLine);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, 0x12), pEntry->nStatD);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aLine);
                nY += LINE_STEP;
            }
            if (pEntry->nStatE != 0) {
                Ov008_BeginPrefixedLine(aLine);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, 0x13), pEntry->nStatE);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aLine);
                nY += LINE_STEP;
            }
            nHeight += Ov008_DrawInfoLine(pMenu, nY, data_ov025_020b5410);
            nY += LINE_STEP;
        }
        if (pMenu->bTransfer == 0) {
            nHeight += Ov008_DrawInfoLine(pMenu, nY, func_ov025_02089894(pMenu->records, TEXT_CAPTION_B));
            nY += LINE_STEP;
            switch (pEntry->nRewardKind) {
            case 0:
                Ov008_BeginPrefixedLine(aRecord);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, TEXT_REWARD_FIRST), 1);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aRecord);
                nY += LINE_STEP;
                break;
            case 1:
                Ov008_BeginPrefixedLine(aRecord);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, TEXT_REWARD_FIRST + 1), 1);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aRecord);
                nY += LINE_STEP;
                break;
            case 2:
                Ov008_BeginPrefixedLine(aRecord);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, TEXT_REWARD_FIRST + 2), 1);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aRecord);
                nY += LINE_STEP;
                break;
            case 3:
                Ov008_BeginPrefixedLine(aRecord);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, TEXT_REWARD_FIRST + 3), 1);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aRecord);
                nY += LINE_STEP;
                break;
            case 4:
                Ov008_BeginPrefixedLine(aRecord);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, TEXT_REWARD_FIRST + 4), 1);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aRecord);
                nY += LINE_STEP;
                break;
            case 5:
                Ov008_BeginPrefixedLine(aRecord);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, TEXT_REWARD_FIRST + 6), 1);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aRecord);
                nY += LINE_STEP;
                break;
            case 6:
                Ov008_BeginPrefixedLine(aRecord);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, TEXT_REWARD_FIRST + 7), 1);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aRecord);
                nY += LINE_STEP;
                break;
            case 7:
                Ov008_BeginPrefixedLine(aRecord);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, TEXT_REWARD_FIRST + 8), 1);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aRecord);
                nY += LINE_STEP;
                break;
            case 8:
                Ov008_BeginPrefixedLine(aRecord);
                func_020262a0(pTail, 0x100, func_ov025_02089894(pMenu->records, TEXT_REWARD_FIRST + 9), 1);
                nHeight += Ov008_DrawInfoLine(pMenu, nY, aRecord);
                nY += LINE_STEP;
                break;
            }
            pLabel = func_ov025_02089894(pMenu->records, TEXT_RECORD);
            ...
            if ((int)func_020235d0(nMissionId * 3 + FIELD_MISSION_STAGE, 3) >= 0 && nRecord != -1) {
                switch (pEntry->nRewardKind) {
                case 0:
                    func_ov025_020a9858(nRecord, &nMinutes, &nSeconds, &nFrames);
                    func_020262a0(aRecord, 0x100, data_ov025_020b5414, pLabel, nMinutes, nSeconds, nFrames);
                    break;
                case 1:
                case 2:
                case 3:
                ...
                case 8:
                default:
                    func_020262a0(aRecord, 0x100, data_ov025_020b5438, pLabel, nRecord);
                    break;
                }
            } else {
                func_020262a0(aRecord, 0x100, data_ov025_020b5444, pLabel);
            }
            func_020302ec(pMenu->surface, 6, nY, COLOUR_RECORD, COLOUR_RECORD, aRecord);
            nHeight += func_ov025_020aa168(aRecord);
            nHeight += Ov008_DrawInfoLine(pMenu, nY + LINE_STEP, data_ov025_020b5410);
            nY += 2 * LINE_STEP;
        }
    }
