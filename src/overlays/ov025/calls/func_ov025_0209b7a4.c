/* func_ov025_0209b7a4 -- Ov008_SaveMenuDrawPrompt: redraw the save menu's
...
extern void  func_ov025_0209a590(void *pSurface, int nX, int nY, int nStyle, const u16 *pText); /* Ov008_DrawTextNewline */
...
void func_ov025_0209b7a4(Ov008SaveMenu *pMenu, int nPhase)
{
    u16 text[TEXT_CAP];
    int nRecord;
    u16 *pText;
    ...
    switch (nPhase) {
    case PHASE_PICK:
        func_ov025_0209a590(pMenu->promptSurface, 0x62, 0, 2, func_ov025_02089894(pMenu->varRecords, 1));
        break;
    case PHASE_CONFIRM:
        ...
        pText = func_ov025_02089894(pMenu->varRecords, nRecord);
        func_020262a0(text, TEXT_CAP, pText, pMenu->nSlot + 1);
        func_ov025_0209a500(pMenu->promptSurface, 0x10, 0, 2, text, 0);
        func_ov025_0209a500(pMenu->promptSurface, 0x50, 0x12, 2, func_ov025_02089894(pMenu->varRecords, 5), 2);
        func_ov025_0209a500(pMenu->promptSurface, 0xae, 0x12, 2, func_ov025_02089894(pMenu->varRecords, 6), 2);
        break;
    case PHASE_SAVING:
        func_02030278(pMenu->promptSurface, 0x10, 0, 2, func_ov025_02089894(pMenu->varRecords, 0xb), 0);
        break;
    case PHASE_WAIT:
        func_02030278(pMenu->promptSurface, 0x10, 0, 2, func_ov025_02089894(pMenu->varRecords, 7), 0);
        break;
    case PHASE_DONE:
        ...
        func_02030278(pMenu->promptSurface, 0x10, 0, 4, func_ov025_02089894(pMenu->varRecords, nRecord), 0);
        break;
    }
