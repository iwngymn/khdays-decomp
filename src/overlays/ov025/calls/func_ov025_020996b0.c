/* func_ov025_020996b0 -- Ov008_RunPendingGridAction: perform the grid menu's
...
extern void func_ov025_0209794c(Ov008MenuContext *pCtx);                 /* Ov008_ClearGridMenu */
extern void MIi_CpuCopy16(const void *pSrc, void *pDst, u32 nSize);
extern void func_ov025_020974e4(Ov008MenuContext *pCtx);                 /* place the equipped items */
extern void func_ov025_0209522c(Ov008MenuContext *pCtx, int nA, int nB); /* rebuild the grid */
...
void func_ov025_020996b0(void)
{
    ...
    case ACTION_SAVE_PRESET:
        ...
        func_ov025_02095cbc(pCtx, MODE_SAVED);
        func_02033b78(0, SOUND_SAVED);
        break;
    case ACTION_LOAD_PRESET:
        func_ov025_0209794c(pCtx);
        ...
        func_ov025_02095cbc(pCtx, MODE_LOADED);
        func_ov025_020a4264();
    ...
    case ACTION_CLEAR_GRID:
        func_ov025_0209794c(pCtx);
        func_ov025_02095cbc(pCtx, MODE_CLEARED);
