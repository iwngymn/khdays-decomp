/* func_ov025_020a6c58 -- Ov008_ScrollListTo: set a scroll list's position.
...
extern void func_ov025_020a685c(Ov008MissionList *pList);                 /* Ov008_LayoutMenuRows */
extern void func_ov025_020a694c(Ov008MissionList *pList);                 /* Ov008_PositionListCursor */
extern void func_ov025_020a6a00(Ov008MissionList *pList);
extern void func_ov025_020a67dc(Ov008MissionList *pList);                 /* Ov008_UpdateScrollArrows */

void func_ov025_020a6c58(Ov008MissionList *pList, int nPos, int nTarget, int bNow)
{
    int nFirst;
    int nRows;
    ...
    if (bNow != 0 && pList->bAnimating == 0) {
        ...
        if (pList->nSelected < nFirst) {
            func_ov025_020a6b10(pList, nFirst, -1);
        }
        if (pList->nSelected > nFirst + (nRows - 1)) {
            func_ov025_020a6b10(pList, nFirst + (nRows - 1), -1);
        }
    }
