/* func_ov025_020974e4 -- Ov008_LoadGridFromSave: rebuild the grid menu's
...
extern void  func_ov025_02092e94(Ov008MenuContext *pCtx, Ov008TrackedNode *pNode); /* Ov008_AssignTrackedNodeId */
extern int   func_ov025_02092a34(Ov008MenuContext *pCtx, Ov008TrackedNode *pNode, int nPage, int nCol, int nRow, int nArg); /* register the node */
extern void  func_020300f8(void *pSurface);                                 /* EnqueueObjGfxCommand */
extern void  func_ov025_02087260(void *pSummary, void *pSlots, void *pList); /* RebuildViewAndCountCells */

void func_ov025_020974e4(Ov008MenuContext *pCtx)
{
            ...
            if (data_0204be18->aEquipped[i][j] != 0) {
                ...
                if (pCtx->aGridCount[nItemId] < data_0204be18->aItemCount[nItemId]) {
                    ...
                    if (pCtx->pListNode->nPlacedSlot >= 0) {
                        ...
                        func_ov025_02092e94(pCtx, pNode);
                        func_ov025_02092a34(pCtx, pNode, i, nCol - pCtx->pListNode->nOffsetCol, nRow - pCtx->pListNode->nOffsetRow, 0);
                        pNode->nPage = i;
    ...
    func_ov025_02087260(pCtx->summary, pCtx->apPageSlot, pCtx->nodeList);
}
