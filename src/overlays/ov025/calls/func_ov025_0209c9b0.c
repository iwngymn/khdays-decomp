/* func_ov025_0209c9b0 -- Ov008_MenuSelectionRight: the "right" action on the
 ...
 * moves the highlight to the next selectable item via func_ov025_0209c858
...
extern void *func_ov025_0209bf74(int nListId, int nSelection);        /* item ring lookup (result unused) */
