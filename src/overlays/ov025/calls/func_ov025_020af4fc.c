/* func_ov025_020af4fc -- Ov008_OpenTutorialPage: initialise page B as the
...
void func_ov025_020af4fc(void)
{
    Ov008PageB *pPage = func_ov025_02084b14();

    MI_CpuFill8(pPage, 0, PAGE_B_SIZE);
    pPage->header = *func_ov025_02084fa8();
    pPage->pArchive = func_0201ef9c(data_ov025_020b5674, 14);
    func_ov025_020b07ec(pPage->list, pPage->pArchive);
    func_ov025_020b0818(pPage->list, (u16)data_ov025_020b5588[pPage->header.aWord[0]]);
    pPage->nFlags |= 4;
