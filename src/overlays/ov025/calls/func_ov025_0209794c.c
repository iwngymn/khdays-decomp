/* func_ov025_0209794c -- Ov008_ClearGridMenu: empty the grid menu.  Resets the
...
extern void func_ov025_02092f34(Ov008MenuContext *pCtx, void *pNode);     /* remove a tracked node */
...
void func_ov025_0209794c(Ov008MenuContext *pCtx)
{
    void *pNode;
    void *pNext;
    int nRow;
