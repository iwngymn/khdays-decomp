/* func_ov025_020a84dc -- Ov008_TouchScrollList: drive the list from the touch
...
extern void func_ov025_02088b1c(int nCtx, void *pOut);                     /* copy the touch state */
extern void func_ov025_020a6c58(Ov008ScrollList *pList, int nPos, int nTarget, int bNow);
extern void func_ov025_020a6b10(Ov008ScrollList *pList, u32 nWord, int nTarget);

void func_ov025_020a84dc(Ov008ScrollList *pList)
{
    ...
    if (touch.nTouching == 1) {
        if (touch.nPhase == 0) {
            ...
            func_ov025_020a6c58(pList, nPos, NO_TARGET, 1);
        }
    } else {
        func_ov025_020a6b10(pList, pList->nWord, -1);
        pList->nDragA = 0;
        pList->nDragB = 0;
    }
}
