/* func_ov025_0209249c -- Ov008_FindPanelCardOfKind: scan the three-bank card grid
...
extern void *func_ov025_02089894(void *pRecords, int nTier);   /* GetVarRecordByIndex */

int func_ov025_0209249c(int self, int nKind)
{
    int i;
    int j;
    char *base;
        ...
        do {
            ...
            if (pCard != 0 && pCard->nState - CARD_STATE_A <= 1u && pCard->nKind == nKind) {
                if (pCard->nState == CARD_STATE_B) {
                    *(void **)(self + 0x2078) = func_ov025_02089894((void *)(self + 0x28c), TIER_STATE_B);
                } else {
                    *(void **)(self + 0x2078) = func_ov025_02089894((void *)(self + 0x28c), TIER_STATE_A);
                }
                return 1;
            }
            j++;
