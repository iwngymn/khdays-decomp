/* func_ov025_0209c2a0 -- Ov008_FitTextFieldFont: pick the glyph set for a text field
...
extern void func_ov025_0209c288(Ov008TextField *pField);            /* reset to the narrow set */
extern int func_02013768(int nSet, int nLength, char *pText, char **ppRest); /* Text_MeasureLineWidth */
extern int func_ov025_02084cb4(void);                                /* wide glyph set */
extern int func_ov025_02084c84(void);                                /* narrow glyph set */

int func_ov025_0209c2a0(Ov008TextField *pField, char *pText, int nMaxWidth)
{
    char *pRest = 0;
    int nWidest;
    int nWidth;
    ...
    if (pField != 0 && pText != 0) {
        ...
        if (nWidest > nMaxWidth) {
            nSet = func_ov025_02084cb4();
            bWide = 1;
        } else {
            nSet = func_ov025_02084c84();
            bWide = 0;
        }
