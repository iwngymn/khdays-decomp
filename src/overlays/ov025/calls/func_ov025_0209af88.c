/* func_ov025_0209af88 -- Ov008_SaveMenuTick: per-frame step of the save menu,
...
extern long long func_ov025_020b0e30(void);                              /* tick at menu open */
extern u64  func_02020368(long long nValue, unsigned int nDivisor, int nUnused); /* _ll_udiv */
extern void func_ov025_02099eec(u32 nSeconds);                           /* Ov008_RenderTimeDigits */
extern int  func_ov025_02099a94(Ov008SaveMenu *pMenu);                   /* Ov008_PollSaveCardOp */
extern void MI_CpuCopy8(const void *pSrc, void *pDst, u32 nSize);
extern void func_ov025_020b0e1c(void);                                   /* disarm the card poll */
extern u8   func_ov025_0209a8b0(Ov008SaveMenu *pMenu, int nSlot);        /* Ov008_StepSaveSlotLoad */
extern void func_ov025_0209bb84(Ov008SaveMenu *pMenu);                   /* rebuild the slot rows */
extern void func_ov025_0209b604(Ov008SaveMenu *pMenu);                   /* Ov008_RefreshSaveRowDigits (pMenu unused) */
...
extern void func_ov025_0209b248(Ov008SaveMenu *pMenu);                   /* page scroll tick */
extern void func_ov025_0209b560(Ov008SaveMenu *pMenu);                   /* slot rows tick */

void func_ov025_0209af88(Ov008SaveMenu *pMenu)
{
    long long nElapsed;
    int nResult;
    ...
    switch (pMenu->nPhase) {
    case PHASE_PICK:
        nElapsed = func_020031d4() - func_ov025_020b0e30();
        func_ov025_02099eec((u32)(data_0204be18->nPlayTimeSeconds + func_02020368(nElapsed << 6, TICKS_PER_SECOND, 0)));
        break;
    case PHASE_SAVING:
        nResult = func_ov025_02099a94(pMenu);
        ...
        break;
    case PHASE_RELOAD:
        if (func_ov025_0209a8b0(pMenu, pMenu->nSlot) == LOAD_DONE) {
            MI_CpuCopy8(&pMenu->backup, data_0204be18, GAME_STATE_SIZE);
            func_ov025_0209bb84(pMenu);
            func_ov025_0209b604(pMenu);
            func_ov025_0209b138(0, 0);
            func_ov025_0209b7a4(pMenu, PHASE_RELOAD);
    ...
    if (pMenu->nState != 0) {
        func_ov025_0209b7a4(pMenu, PHASE_DONE);
        func_ov025_0209b138(0, 0);
        pMenu->nPhase = PHASE_EXIT;
        func_ov025_02084868(0);
    }
    func_ov025_0209b248(pMenu);
    func_ov025_0209b560(pMenu);
}
