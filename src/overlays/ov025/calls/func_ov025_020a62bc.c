/* func_ov025_020a62bc -- Ov008_LayoutMissionTiles: lay out the mission
...
extern const Ov008RankTags data_ov025_020b4598;
...
extern int   func_ov025_0208ded0(int nGroup);                            /* mission count of a group */
...
{
    if (nTotal == 0) {
        func_ov025_020a53f4(nOwner, nTagIdle, nX, nY);
    } else if (i < nBase) {
        func_ov025_020a53f4(nOwner, nTagDone, nX, nY);
    } else if (i < nTotal) {
        func_ov025_020a53f4(nOwner, nTagIdle, nX, nY);
...
void func_ov025_020a62bc(Ov008MissionList *pList)
{
    Ov008RankTags tags;
    ...
    nObj = func_ov025_02084e08();
    nCountA = func_ov025_0208ded0(0);
    nCountB = func_ov025_0208ded0(1);
    nCountC = func_ov025_0208ded0(2);
    pList->nBlinkMask = 0;
    pList->nBlinkPhase = 0;
    pList->nBlinkTick = func_020031d4();
    nBase = func_ov025_0208deec();
    nTotal = nBase;
    ...
    func_ov025_020896fc(nOwner, func_ov025_0208969c(nOwner, 6), 0);
    func_ov025_020896fc(nOwner, func_ov025_0208969c(nOwner, 7), 0);
    func_ov025_020896fc(nOwner, func_ov025_0208969c(nOwner, 8), 0);
    if (nBase < TILE_COUNT) {
        ...
        for (i = 0; i < TILE_COUNT; nX++, i++) {
            ...
            if (i == nMarkA) {
                if (nTotal == 0) {
                    func_ov025_020a53f4(nOwner, 0x27, nX, 4);
                }
                if (nTotal != 0) {
                    func_ov025_020a53f4(nOwner, 0x26, nX, 4);
                }
            }
            if (i == nMarkB) {
                if (nTotal == 0) {
                    func_ov025_020a53f4(nOwner, 0x29, nX, 4);
                }
                if (nTotal != 0) {
                    func_ov025_020a53f4(nOwner, 0x28, nX, 4);
                }
            }
            if (i == nMarkC) {
                if (nTotal == 0) {
                    func_ov025_020a53f4(nOwner, 0x2b, nX, 4);
                }
                if (nTotal != 0) {
                    func_ov025_020a53f4(nOwner, 0x2a, nX, 4);
                }
            }
        }
    }
    if (nBase == TILE_COUNT) {
        func_ov025_020a53f4(nOwner, TAG_FULL, TILE_X_FIRST, 3);
        func_ov025_020a53f4(nOwner, TAG_RANK, 10, 1);
    }
    tags = data_ov025_020b4598;
    nTier = func_ov025_0208df00(pEntry);
    if (nTotal == 0 || nTotal == nBase) {
        nTier = 0;
        pList->nBlinkMask = 0;
    }
    func_ov025_020a53f4(nOwner, tags.aTag[nTier], TAG_RANK, 3);
    if (nBase == TILE_COUNT) {
        return;
    }
    if (nTier == 0) {
        ...
        func_ov025_02089544(nOwner, func_ov025_020894b0(nOwner, 0));
    }
}
