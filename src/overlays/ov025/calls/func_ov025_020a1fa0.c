/* func_ov025_020a1fa0 -- Ov008_ScrollMenuMoveTo: move the scrolling menu
...
extern int   func_ov025_020a1d24(Ov008ScrollMenu *pMenu, int nTop, int bFinal, int nArg); /* Ov008_DrawListWindow */
extern void  func_ov025_020a1e34(Ov008ScrollMenu *pMenu, int nPos);      /* Ov008_LayoutScrollGauge */
...
extern int   func_ov025_020a41f0(int nMode, int nA, u32 nText);          /* cursor mode / text request */
extern void *func_ov025_02089894(void *pRecords, int nIndex);            /* GetVarRecordByIndex */
extern u16   func_ov025_020a0f28(void);                                  /* text db of the page */
extern int   func_020300f8(void *pSurface);                              /* EnqueueObjGfxCommand */

int func_ov025_020a1fa0(Ov008ScrollMenu *pMenu, int nRow, int bDraw, int nArg)
{
    ...
    pRecC = 0;
    {
        ...
        func_ov025_020a1e34(pMenu, nKnob);
        if (nVisible > WINDOW_ROWS) {
            ...
            func_ov025_0208884c(nCtx, func_ov025_0208843c(nCtx, WIDGET_ARROW_UP), bUp);
            if (nKnob < nRange) {
                bDown = 1;
            } else {
                bDown = 0;
            }
            func_ov025_0208884c(nCtx, func_ov025_0208843c(nCtx, WIDGET_ARROW_DOWN), bDown);
        } else {
            func_ov025_0208884c(nCtx, func_ov025_0208843c(nCtx, WIDGET_ARROW_UP), 0);
            func_ov025_0208884c(nCtx, func_ov025_0208843c(nCtx, WIDGET_ARROW_DOWN), 0);
        }
    }
    if (bDraw != 0) {
        ...
        case 5:
            ...
            func_ov025_020a41f0(0, 0, pRecB->nText);
            func_020343cc(&pRecB);
            break;
        case 0:
            ...
            func_ov025_020a41f0(0, 0, pRecB != 0 ? pRecB->nText : pRecA->nText);
            if (pRecB != 0) {
                func_020343cc(&pRecB);
            }
            func_020343cc(&pRecA);
        ...
        case 4:
            nId = pItem->nId;
            if (nId == 0xff) {
                func_ov025_020a41f0(0, 0, (u32)func_ov025_02089894(pMenu->textRecords, 0x84));
            } else if (nId == 0xfe) {
                func_ov025_020a41f0(0, 0, (u32)func_ov025_02089894(pMenu->textRecords, 0x83));
            } else {
                func_020342e8(&pRecC, func_ov025_020a0f28(), nId, DB_SLOT);
                func_ov025_020a41f0(0, 0, pRecC->nText);
                func_020343cc(&pRecC);
            }
            break;
        case 3:
            func_ov025_020a41f0(0, 0, (u32)func_ov025_02089894(pMenu->textRecords, pItem->nId - 0x3b));
            break;
        case 2:
            func_ov025_020a41f0(0, 0, (u32)func_ov025_02089894(pMenu->textRecords, pItem->nId));
            break;
        }
