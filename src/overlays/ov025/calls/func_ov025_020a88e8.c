/* func_ov025_020a88e8 -- Ov008_BlinkMissionListDots: advance the mission
...
void func_ov025_020a88e8(Ov008MissionList *pList)
{
    u64 nNow;
    int nOwner;
    int i;
    ...
    nFirst = func_ov025_0208ded0(0);
    nSecond = func_ov025_0208ded0(1);
    nValue = DOT_TAG_BASE;
    for (i = 0; i < DOT_COUNT; nValue++, i++) {
        if ((pList->nBlinkMask & (1 << i)) != 0) {
            if (i < nFirst) {
                ...
                func_ov025_020a53f4(nOwner, nTag, (short)nValue, 3);
                ...
                func_ov025_020a53f4(nOwner, nTag, (short)nValue, 2);
            } else {
                nTag = 0x25;
                switch (nStep) {
                case 0:
