/* func_ov025_020988c0 -- Ov008_GridMenuConfirm: the grid menu's confirm
...
extern int  func_ov025_02094d74(Ov008MenuContext *pCtx);                  /* drop the lifted node */
...
void func_ov025_020988c0(Ov008MenuContext *pCtx)
{
    ...
    case STATE_LIST:
        ...
        if (func_ov025_02093d0c(pCtx, 1) != 0) {
            ...
            if ((u32)pCtx->menuState <= STATE_GRID) {
                func_ov025_02094988(pCtx, pCtx->nColumn, pCtx->nRowSel, 0);
                pCtx->nBusyWord = 1;
            }
    ...
    case STATE_DRAG:
        ...
        if (func_ov025_020921bc(pCtx, func_02010154(pCtx->pList, (u16)pCtx->nSelectedRow), PICK_SLOT) != 0) {
