/* func_ov025_020a85d8 -- Ov008_MissionListRevealTick: reveal the mission
...
extern void *func_ov025_0208dbdc(int nIndex);                            /* mission list entry */
...
extern void  func_ov025_020a6b10(Ov008MissionList *pList, u32 nRow, int nMode); /* Ov008_MissionListSelectRow */
extern void  func_ov025_020a6750(Ov008MissionList *pList);               /* Ov008_RefillListRows */
extern int   func_ov025_020a85a8(void *pEntry);                          /* Ov008_GetTagIndex */
...
extern void  func_ov025_020a54c8(Ov008MissionList *pList, u16 nRow, void *pEntry, int nCount); /* draw a row */
extern void  func_020300f8(void *pSurface);                              /* EnqueueObjGfxCommand */

void func_ov025_020a85d8(Ov008MissionList *pList)
{
    void *pEntry;
    u64 nNow;
    int nCtx;
    ...
    pEntry = func_ov025_0208dbdc(pList->nRevealRow);
    nNow = func_020031d4();
    if (pEntry == 0) {
        ...
        func_ov025_0208884c(nCtx, func_ov025_0208843c(nCtx, WIDGET_CURSOR), 1);
        pList->nAnimPhase = 0;
        pList->bAnimating = 0;
    ...
    if (pList->bPendingPrompt != 0) {
        do {
            nTag = func_ov025_020a85a8(pEntry);
            if (nTag >= 0) {
            ...
            func_ov025_020a54c8(pList, nRow, pEntry, ROW_COUNT);
    ...
    pList->bAnimating = 0;
    pList->bRevealing = 1;
    func_ov025_020a6b10(pList, pList->nRevealRow, SELECT_REVEAL);
    if (pList->nScrollA == 0) {
        func_ov025_020a6750(pList);
    }
    pList->bAnimating = 1;
