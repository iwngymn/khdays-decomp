/* func_ov025_02097b90 -- Ov008_FinishMenuModeSwitch: complete a grid menu
...
extern const Ov008WidgetList data_ov025_020b3d2c;
...
extern void  func_ov025_020977c0(Ov008MenuContext *pCtx);                 /* Ov008_HideGridMenu */
...
extern void  func_ov025_02095cbc(Ov008MenuContext *pCtx, int nArg);       /* list screen refresh */
...
void func_ov025_02097b90(Ov008MenuContext *pCtx)
{
    ...
    func_ov025_020977c0(pCtx);
    func_ov025_0208896c(nCtx, 0);
    switch (pCtx->menuMode) {
    case MODE_GRID:
        func_ov025_02089544(nTracker, func_ov025_020894b0(nTracker, 2));
        func_ov025_0208884c(nCtx, func_ov025_0208843c(nCtx, 0x28), 1);
        if (pCtx->menuState == STATE_IDLE) {
            func_ov025_0208884c(nCtx, func_ov025_0208843c(nCtx, 3), 1);
        }
        func_ov025_02095544(pCtx, pCtx->nPage);
        for (i = 0x50; i <= 0x5f; i++) {
            func_ov025_020887c0(nCtx, func_ov025_0208843c(nCtx, i), 1);
        }
        for (i = 0; i < WIDGET_COUNT; i++) {
            func_ov025_0208884c(nCtx, func_ov025_0208843c(nCtx, widgets.aId[i]), 1);
        }
        ...
        func_0203034c(pCtx->valueSurface, func_ov025_02084aa4(10), 3, 0xd, 0);
        pCtx->bShown = 1;
        pCtx->nSlideStep = 0x99;
        break;
    case MODE_LIST:
        func_ov025_02089544(nTracker, func_ov025_020894b0(nTracker, 9));
        func_ov025_02095cbc(pCtx, 0);
        data_ov025_020b4d4c.pfnDone = 0;
        data_ov025_020b4d4c.pfnSelect = 0;
        data_ov025_020b4d4c.pfnCancel = 0;
        pCtx->bShown = 0;
        break;
    }
    func_ov025_02084964(10);
