/* func_ov025_020af8c0 -- Ov008_DestroyPageB: tear page B down.  The seven
...
extern void func_ov025_020895b8(int nBlock);                              /* clear the element list */
...
extern void func_ov025_0208488c(int nValue);                              /* Ov008_ApplyControlValue */
extern void func_ov025_020848e0(int nValue);
...
void func_ov025_020af8c0(void)
{
    ...
    func_ov025_02089884(pPage->textCache);
    func_ov025_020896fc(nOwner, func_ov025_0208969c(nOwner, 0x15), 0);
    func_ov025_020896fc(nOwner, func_ov025_0208969c(nOwner, 0x16), 0);
    func_ov025_020896fc(nOwner, func_ov025_0208969c(nOwner, 0x17), 0);
    func_ov025_020895b8(nOwner);
    ...
    if (func_ov025_02084fa8()->aWord[3] == 0) {
        ...
        func_ov025_020848e0(1);
    }
    func_ov025_020849d8(0x18, 0, 0, GRID_W, GRID_H);
    func_ov025_020849d8(0x19, 0, 0, GRID_W, GRID_H);
    func_ov025_020849d8(0x1a, 0, 0, GRID_W, GRID_H);
    func_ov025_020849d8(0x1b, 0, 0, GRID_W, GRID_H);
