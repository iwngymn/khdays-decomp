 ...
 * fetch its transform into obj[6..9] (func_ov117_020cc5c0) and copy it to obj[2..5]. Finally
...
void func_ov117_020ccafc(int self) {
    ...
    if (obj[1] != 0) {
        func_ov117_020cc5c0(obj, obj + 6);
        *(struct vec4 *)(obj + 2) = *(struct vec4 *)(obj + 6);
    }
    func_ov107_020c9264(*obj, 0, 0);
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov117_020ccbcc);
}
