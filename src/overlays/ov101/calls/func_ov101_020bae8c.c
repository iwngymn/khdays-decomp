...
extern struct Ov047Descriptor data_ov101_020bc07c;
extern struct Ov047Descriptor data_ov101_020bc08c;

u8 func_ov101_020bae8c(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov101_020bc07c.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov101_020bc08c.bytes, self->slot09, 1,
