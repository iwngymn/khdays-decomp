...
extern void func_ov101_020baaa8(void);
extern void func_ov101_020babcc(void);
extern void func_ov101_020bae58(void);
extern void func_ov101_020baa28(void);
extern void func_ov101_020baa94(void);
extern void func_ov101_020bad10(void);
extern void func_ov101_020bae8c(void);
extern void func_ov101_020bbbcc(void);
...
void func_ov101_020ba830(struct PanelInitConfig *config)
{
    ...
    *(long long *)object = 0;
    ...
    func_0202b914(*(signed char *)(object + 0x4bc), (void *)data_ov101_020bc068, 1,
                  config->objectType + 7);

    *(void **)(object + 0x664 + 0x00) = (void *)&func_ov101_020baaa8;
    *(void **)(object + 0x664 + 0x04) = (void *)&func_ov101_020babcc;
    *(void **)(object + 0x664 + 0x08) = (void *)&func_ov101_020bae58;
    *(void **)(object + 0x664 + 0x0c) = 0;
    *(void **)(object + 0x664 + 0x10) = 0;
    *(void **)(object + 0x664 + 0x14) = (void *)&func_ov101_020baa28;
    *(void **)(object + 0x664 + 0x18) = (void *)&func_ov101_020baa94;
    *(void **)(object + 0x664 + 0x20) = (void *)&func_ov101_020bad10;
    *(void **)(object + 0x664 + 0x28) = (void *)&func_ov101_020bae8c;
    *(void **)(object + 0x664 + 0x24) = (void *)&func_ov101_020bbbcc;
...
test:
    ...
    *(int *)(object + 0x520) = bone != 0
        ? func_02016f10((void *)bone, &data_ov101_020bc008) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x518) = bone != 0
        ? func_02016f10((void *)bone, &data_ov101_020bbff8) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x51c) = bone != 0
        ? func_02016f10((void *)bone, &data_ov101_020bc018) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x524) = bone != 0
        ? func_02016f10((void *)bone, &data_ov101_020bc028) : -1;
