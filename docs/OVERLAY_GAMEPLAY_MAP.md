...
| ov002 | 100.0% | 0 | Shared gameplay, character/world handling and battle displays. | `ba/tr/%s.z`, `refresh_wnd`, `ba/ch/xo/w_mot.p.z`, `ba/ch/%s/wp.b.z` ([source data](../src/overlays/ov002/data/)) |
| ov003 | 100.0% | 0 | Display/camera setup and character-related display resources. | `ba/ch/ax/def.p.z`, `ba/ch/xo/def.p.z`, `ba/ch/go/def.p.z`, `ba/ch/do/def.p.z` ([source data](../src/overlays/ov003/data/)) |
...
| ov008 | 80.4% | 242 | Large menu collection: camp menu, panels, shop and mission progress. | `Dummy09`, `Dummy01`, `Dummy08`, `Dummy03` ([source data](../src/overlays/ov008/data/)) |
...
| ov015 | 41.4% | 41 | Exact in-game identity not established from this scan. | No identifying text recovered in the scanned string files. |
| ov016 | 53.7% | 38 | Exact in-game identity not established from this scan. | No identifying text recovered in the scanned string files. |
| ov017 | 66.7% | 15 | Exact in-game identity not established from this scan. | No identifying text recovered in the scanned string files. |
...
| ov021 | 51.6% | 15 | Object timer and scale updates observed; exact object unknown. | No identifying text recovered in the scanned string files. |
...
| ov035 | 93.5% | 2 | Sora-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `sora_R`, `so_left_dummy`, `sora_tg`, `so_w_tg00` ([source data](../src/overlays/ov035/data/)) |
...
| ov040 | 75.0% | 8 | Marluxia-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `marluxia_R`, `ma_h_R`, `marluxia_tg`, `ba/ch/ma/li_e2.p.z` ([source data](../src/overlays/ov040/data/)) |
...
| ov042 | 71.4% | 8 | Vexen-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `vexen_R`, `ve_w_tg`, `vexen_tg`, `ba/ch/ve/def.p.z` ([source data](../src/overlays/ov042/data/)) |
| ov043 | 32.6% | 31 | Xemnas-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `xe_h_R`, `xemnas_R`, `xe_h_L`, `xemnas_tg` ([source data](../src/overlays/ov043/data/)) |
...
| ov046 | 80.6% | 7 | Mickey-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `mi_w_tg_R`, `mickey_tg`, `mickey_R`, `ba/ch/mi/def.p.z` ([source data](../src/overlays/ov046/data/)) |
...
| ov054 | 71.0% | 9 | Sora-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `sora_R`, `so_left_dummy`, `sora_tg`, `so_w_tg00` ([source data](../src/overlays/ov054/data/)) |
...
| ov058 | 59.5% | 15 | Luxord-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `luxord_R`, `luxord_tg`, `ba/ch/lu/li_e1.p.z`, `ba/ch/lu/def.p.z` ([source data](../src/overlays/ov058/data/)) |
| ov059 | 75.0% | 8 | Marluxia-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `marluxia_R`, `ma_h_R`, `marluxia_tg`, `ba/ch/ma/li_e2.p.z` ([source data](../src/overlays/ov059/data/)) |
...
| ov061 | 71.4% | 8 | Vexen-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `vexen_R`, `ve_w_tg`, `vexen_tg`, `ba/ch/ve/def.p.z` ([source data](../src/overlays/ov061/data/)) |
| ov062 | 32.6% | 31 | Xemnas-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `xe_h_R`, `xemnas_R`, `xe_h_L`, `xemnas_tg` ([source data](../src/overlays/ov062/data/)) |
...
| ov065 | 80.6% | 7 | Mickey-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `mi_w_tg_R`, `mickey_tg`, `mickey_R`, `ba/ch/mi/def.p.z` ([source data](../src/overlays/ov065/data/)) |
...
| ov074 | 71.0% | 9 | Sora-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `sora_R`, `so_left_dummy`, `sora_tg`, `so_w_tg00` ([source data](../src/overlays/ov074/data/)) |
...
| ov078 | 59.5% | 15 | Luxord-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `luxord_R`, `luxord_tg`, `ba/ch/lu/li_e1.p.z`, `ba/ch/lu/def.p.z` ([source data](../src/overlays/ov078/data/)) |
| ov079 | 75.0% | 8 | Marluxia-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `marluxia_R`, `ma_h_R`, `marluxia_tg`, `ba/ch/ma/li_e2.p.z` ([source data](../src/overlays/ov079/data/)) |
...
| ov081 | 71.4% | 8 | Vexen-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `vexen_R`, `ve_w_tg`, `vexen_tg`, `ba/ch/ve/def.p.z` ([source data](../src/overlays/ov081/data/)) |
...
| ov084 | 80.6% | 7 | Mickey-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `mi_w_tg_R`, `mickey_tg`, `mickey_R`, `ba/ch/mi/def.p.z` ([source data](../src/overlays/ov084/data/)) |
...
| ov091 | 71.0% | 9 | Sora-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `sora_R`, `so_left_dummy`, `sora_tg`, `so_w_tg00` ([source data](../src/overlays/ov091/data/)) |
...
| ov094 | 100.0% | 0 | Lexaeus-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `lexaeus_R`, `le_h_R`, `lexaeus_tg`, `ba/ch/le/li_e3.p.z` ([source data](../src/overlays/ov094/data/)) |
| ov095 | 59.5% | 15 | Luxord-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `luxord_R`, `luxord_tg`, `ba/ch/lu/li_e1.p.z`, `ba/ch/lu/def.p.z` ([source data](../src/overlays/ov095/data/)) |
| ov096 | 75.0% | 8 | Marluxia-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `marluxia_R`, `ma_h_R`, `marluxia_tg`, `ba/ch/ma/li_e2.p.z` ([source data](../src/overlays/ov096/data/)) |
...
| ov098 | 71.4% | 8 | Vexen-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `vexen_R`, `ve_w_tg`, `vexen_tg`, `ba/ch/ve/def.p.z` ([source data](../src/overlays/ov098/data/)) |
...
| ov101 | 80.6% | 7 | Mickey-specific character support: animation/weapon/effect resources; exact use of this copy unconfirmed. | `mi_w_tg_R`, `mickey_tg`, `mickey_R`, `ba/ch/mi/def.p.z` ([source data](../src/overlays/ov101/data/)) |
...
| ov119 | 60.7% | 22 | Exact in-game identity not established from this scan. | No identifying text recovered in the scanned string files. ([source data](../src/overlays/ov119/data/)) |
...
| ov125 | 54.5% | 30 | Exact in-game identity not established from this scan. | `tag_L`, `tag_R` ([source data](../src/overlays/ov125/data/)) |
| ov126 | 54.5% | 30 | Exact in-game identity not established from this scan. | `tag_L`, `tag_R` ([source data](../src/overlays/ov126/data/)) |
...
| ov146 | 62.5% | 33 | Exact in-game identity not established from this scan. | `Broot` ([source data](../src/overlays/ov146/data/)) |
...
| ov151 | 78.6% | 12 | Exact in-game identity not established from this scan. | `root`, `MW_Loudness` ([source data](../src/overlays/ov151/data/)) |
| ov152 | 78.6% | 12 | Exact in-game identity not established from this scan. | `root`, `MW_Loudness` ([source data](../src/overlays/ov152/data/)) |
...
| ov160 | 69.8% | 19 | Exact in-game identity not established from this scan. | `eff_tag`, `037`, `move` ([source data](../src/overlays/ov160/data/)) |
...
| ov163 | 83.9% | 9 | Exact in-game identity not established from this scan. | `move` ([source data](../src/overlays/ov163/data/)) |
| ov164 | 83.9% | 9 | Exact in-game identity not established from this scan. | `move` ([source data](../src/overlays/ov164/data/)) |
| ov165 | 83.9% | 9 | Exact in-game identity not established from this scan. | `move` ([source data](../src/overlays/ov165/data/)) |
| ov166 | 81.8% | 10 | Exact in-game identity not established from this scan. | `body` ([source data](../src/overlays/ov166/data/)) |
| ov167 | 81.8% | 10 | Exact in-game identity not established from this scan. | `body` ([source data](../src/overlays/ov167/data/)) |
| ov168 | 81.8% | 10 | Exact in-game identity not established from this scan. | `body` ([source data](../src/overlays/ov168/data/)) |
...
| ov209 | 80.2% | 16 | Exact in-game identity not established from this scan. | `Rock_move` ([source data](../src/overlays/ov209/data/)) |
...
| ov212 | 78.2% | 26 | Exact in-game identity not established from this scan. | `tag_bero`, `tagE01`, `move` ([source data](../src/overlays/ov212/data/)) |
| ov213 | 44.8% | 64 | Exact in-game identity not established from this scan. | `sword` ([source data](../src/overlays/ov213/data/)) |
...
| ov216 | 86.0% | 7 | Exact in-game identity not established from this scan. | `move` ([source data](../src/overlays/ov216/data/)) |
| ov217 | 86.0% | 7 | Exact in-game identity not established from this scan. | `move` ([source data](../src/overlays/ov217/data/)) |
| ov218 | 53.4% | 34 | Exact in-game identity not established from this scan. | `move` ([source data](../src/overlays/ov218/data/)) |
...
| ov226 | 72.5% | 22 | Exact in-game identity not established from this scan. | `move` ([source data](../src/overlays/ov226/data/)) |
| ov227 | 67.9% | 27 | Exact in-game identity not established from this scan. | `move` ([source data](../src/overlays/ov227/data/)) |
...
| ov235 | 37.1% | 61 | Xion-related object/form; XionShare and B50A resources. Exact fight phase unconfirmed. | `Ms/XionShare.p`, `B50A_01body`, `B_spine01`, `1_1_sword` ([source data](../src/overlays/ov235/data/)) |
| ov236 | 54.9% | 69 | Exact in-game identity not established from this scan. | `B_body`, `B_head02`, `GA_move`, `B_LArm01` ([source data](../src/overlays/ov236/data/)) |
| ov237 | 52.3% | 41 | Exact in-game identity not established from this scan. | `R_yubi`, `L_hand`, `L_yubi`, `R_hand` ([source data](../src/overlays/ov237/data/)) |
| ov238 | 51.4% | 35 | Exact in-game identity not established from this scan. | `move` ([source data](../src/overlays/ov238/data/)) |
...
| ov248 | 76.9% | 18 | Exact in-game identity not established from this scan. | `AI_move` ([source data](../src/overlays/ov248/data/)) |
...
| ov252 | 18.1% | 77 | Exact in-game identity not established from this scan. | `01_B_head01`, `01_B_body02`, `core`, `B3_01body` ([source data](../src/overlays/ov252/data/)) |
| ov253 | 46.1% | 89 | Exact in-game identity not established from this scan. | `tag01`, `tag00`, `tag02`, `tag03` ([source data](../src/overlays/ov253/data/)) |
...
| ov256 | 43.4% | 64 | Exact in-game identity not established from this scan. | `tag00`, `tag01`, `tag02`, `tag03` ([source data](../src/overlays/ov256/data/)) |
| ov257 | 35.8% | 61 | Xion-related object/form; XionShare and B50C resources. Exact fight phase unconfirmed. | `tag02_FL`, `tag02_BR`, `tag02_BL`, `tag02_FR` ([source data](../src/overlays/ov257/data/)) |
| ov258 | 40.7% | 48 | Exact in-game identity not established from this scan. | `tag_buki_L`, `tag_buki_R`, `tagB_L`, `tagB_R` ([source data](../src/overlays/ov258/data/)) |
| ov259 | 39.7% | 73 | Exact in-game identity not established from this scan. | `sa_h_R`, `move`, `tag00_1` ([source data](../src/overlays/ov259/data/)) |
| ov260 | 39.1% | 67 | Exact in-game identity not established from this scan. | `wA`, `B013move` ([source data](../src/overlays/ov260/data/)) |
...
| ov279 | 60.7% | 22 | Exact in-game identity not established from this scan. | No identifying text recovered in the scanned string files. ([source data](../src/overlays/ov279/data/)) |
...
| ov282 | 81.9% | 15 | Multi-part creature/character with movement and attacks; exact identity unknown. | `Sns_move` ([source data](../src/overlays/ov282/data/)) |
| ov283 | 70.4% | 24 | Object with Xigbar-style hand labels; identity/role not confirmed. | `xig_h_L`, `xig_h_R` ([source data](../src/overlays/ov283/data/)) |
| ov284 | 75.8% | 8 | Exact in-game identity not established from this scan. | `tag03` ([source data](../src/overlays/ov284/data/)) |
...
| ov291 | 78.1% | 7 | Exact in-game identity not established from this scan. | `move` ([source data](../src/overlays/ov291/data/)) |
| ov292 | 100.0% | 0 | Exact in-game identity not established from this scan. | `body` ([source data](../src/overlays/ov292/data/)) |
| ov293 | 83.8% | 6 | Exact in-game identity not established from this scan. | `move` ([source data](../src/overlays/ov293/data/)) |
...
| ov297 | 69.2% | 12 | Exact in-game identity not established from this scan. | No identifying text recovered in the scanned string files. ([source data](../src/overlays/ov297/data/)) |
| ov298 | 64.9% | 13 | Exact in-game identity not established from this scan. | No identifying text recovered in the scanned string files. ([source data](../src/overlays/ov298/data/)) |
| ov299 | 77.4% | 7 | Exact in-game identity not established from this scan. | No identifying text recovered in the scanned string files. ([source data](../src/overlays/ov299/data/)) |
